...
# change triggered
netedit.changeDefaultValue(netedit.attrs.enums.waypointLane.create.triggered, "person")
...
# set valid value
netedit.changeDefaultValue(netedit.attrs.enums.waypointLane.create.expected, "personID1 personID2 personID3")
