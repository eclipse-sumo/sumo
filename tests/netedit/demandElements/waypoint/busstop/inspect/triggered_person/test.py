...
# change value
netedit.modifyAttribute(netedit.attrs.Enums.waypoint.inspect.triggered, "person", False)

# change value
netedit.modifyAttribute(netedit.attrs.Enums.waypoint.inspect.expected, "personA personB", False)
