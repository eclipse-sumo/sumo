...
netedit.modifyAttribute(netedit.attrs.Enums.flowJunction.inspectSelection.arrivalLane, "500", False)

# change arrivalLane with a valid value
netedit.modifyAttribute(netedit.attrs.Enums.flowJunction.inspectSelection.arrivalLane, "0", False)
