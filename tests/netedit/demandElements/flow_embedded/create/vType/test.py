...
# set invalid vType
netedit.changeDefaultValue(netedit.attrs.enums.flowEmbedded.create.type, "blue")
...
# set valid vType
netedit.changeDefaultValue(netedit.attrs.enums.flowEmbedded.create.type, "custom_vType")
