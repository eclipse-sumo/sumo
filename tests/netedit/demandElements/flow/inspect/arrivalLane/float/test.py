...
netedit.modifyAttribute(netedit.attrs.flowFromToEdge.inspect.arrivalLane, "500", False)

# change arrivalLane with a valid value
netedit.modifyAttribute(netedit.attrs.flowFromToEdge.inspect.arrivalLane, "0", False)
