...
# set invalid arrival pos
netedit.changeDefaultValue(netedit.attrs.enums.routeflow.create.spacing, "probability")
...
# set valid arrival pos
netedit.changeDefaultValue(netedit.attrs.enums.routeflow.create.spacingOption, "0.6")
