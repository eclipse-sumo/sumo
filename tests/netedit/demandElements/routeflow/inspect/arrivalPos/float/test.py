...
# change arrivalPos with an invalid value
netedit.modifyAttribute(netedit.attrs.Enums.routeflow.inspect.arrivalPos, "-10", True)

# change arrivalPos with a valid value
netedit.modifyAttribute(netedit.attrs.Enums.routeflow.inspect.arrivalPos, "15.5", True)
