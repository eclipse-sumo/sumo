...
netedit.changeDefaultValue(netedit.attrs.Enums.chargingStation.create.length, "dummyLenght")

# try to create chargingStation with invalid length
netedit.leftClick(referencePosition, 500, 250)

# set invalid length (negative)
netedit.changeDefaultValue(netedit.attrs.Enums.chargingStation.create.length, "-20")

# try to create chargingStation with invalid length
netedit.leftClick(referencePosition, 500, 250)

# Change length
netedit.changeDefaultValue(netedit.attrs.Enums.chargingStation.create.length, "5")
