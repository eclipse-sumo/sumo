...
netedit.modifyAttribute(netedit.attrs.Enums.chargingStation.inspect.name, "%%%;:..&&%$%$", True)

# Change parameter name with a non valid value
netedit.modifyAttribute(netedit.attrs.Enums.chargingStation.inspect.name, "charging station name", True)
