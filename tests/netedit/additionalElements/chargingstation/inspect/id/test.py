...
netedit.modifyAttribute(netedit.attrs.enums.chargingStation.inspect.id, "cs_1", True)

# Change parameter id with a non valid value (Invalid ID)
netedit.modifyAttribute(netedit.attrs.enums.chargingStation.inspect.id, "Id with spaces", True)

# Change parameter id with a valid value
netedit.modifyAttribute(netedit.attrs.enums.chargingStation.inspect.id, "correctID", True)
