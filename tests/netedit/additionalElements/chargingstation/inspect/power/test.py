...
netedit.modifyAttribute(netedit.attrs.Enums.chargingStation.inspect.power, "DummyPower", True)

# Change parameter Power with a non valid value (negative)
netedit.modifyAttribute(netedit.attrs.Enums.chargingStation.inspect.power, "-300", True)

# Change parameter Power with a valid value
netedit.modifyAttribute(netedit.attrs.Enums.chargingStation.inspect.power, "500.5", True)
