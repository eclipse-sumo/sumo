...
netedit.modifyAttribute(netedit.attrs.enums.E3.inspect.timeThreshold, "dummyTimeTreshold", False)

# Change parameter TimeTreshold with a non valid value (negative)
netedit.modifyAttribute(netedit.attrs.enums.E3.inspect.timeThreshold, "-5", False)

# Change parameter TimeTreshold with a valid value
netedit.modifyAttribute(netedit.attrs.enums.E3.inspect.timeThreshold, "4.2", False)
