...
netedit.modifyAttribute(netedit.attrs.Enums.E1.inspect.freq, "dummyFrequency", True)

# Change parameter frequency with a non valid value (negative)
netedit.modifyAttribute(netedit.attrs.Enums.E1.inspect.freq, "-100", True)

# Change parameter frequency with a valid value
netedit.modifyAttribute(netedit.attrs.Enums.E1.inspect.freq, "120", True)
