...
netedit.modifyAttribute(netedit.attrs.enums.calibrator.inspect.vTypes, "///;;", False)

# Change parameter id with valid value
netedit.modifyAttribute(netedit.attrs.enums.calibrator.inspect.vTypes, "", False)

# Change parameter id with valid value
netedit.modifyAttribute(netedit.attrs.enums.calibrator.inspect.vTypes, "type1 type2", False)
