...
netedit.modifyAttribute(netedit.attrs.Enums.calibrator.inspect.name, "///", False)

# Change parameter id with valid value
netedit.modifyAttribute(netedit.attrs.Enums.calibrator.inspect.name, "customName", False)
