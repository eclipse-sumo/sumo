...
netedit.modifyAttribute(netedit.attrs.enums.E1Instant.inspect.name, "%%%;:..&&%$%$", True)

# Change parameter name with a duplicated value
netedit.modifyAttribute(netedit.attrs.enums.E1Instant.inspect.name, "customName", True)
