...
netedit.changeDefaultValue(netedit.attrs.enums.containerStop.create.length, "dummyLenght")

# try to create containerstop with invalid length
netedit.leftClick(referencePosition, 500, 250)

# set invalid length (negative)
netedit.changeDefaultValue(netedit.attrs.enums.containerStop.create.length, "-20")

# try to create containerstop with invalid length
netedit.leftClick(referencePosition, 500, 250)

# Change length
netedit.changeDefaultValue(netedit.attrs.enums.containerStop.create.length, "5")
