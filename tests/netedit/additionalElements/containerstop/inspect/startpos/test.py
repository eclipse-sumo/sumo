...
netedit.modifyAttribute(netedit.attrs.Enums.containerStop.inspect.startPos, "", True)

# Change parameter startPos with a valid value (< 0)
netedit.modifyAttribute(netedit.attrs.Enums.containerStop.inspect.startPos, "-5", True)

# Change parameter startPos with a non valid value (> endPos)
netedit.modifyAttribute(netedit.attrs.Enums.containerStop.inspect.startPos, "400", True)

# Change parameter startPos with a valid value
netedit.modifyAttribute(netedit.attrs.Enums.containerStop.inspect.startPos, "20", True)
