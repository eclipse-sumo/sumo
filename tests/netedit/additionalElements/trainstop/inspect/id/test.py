...
# create trainStop 2 in mode "reference center"
...
netedit.modifyAttribute(netedit.attrs.Enums.trainStop.inspect.id, "ts_1", True)

# Change parameter id with a non valid value (Invalid ID)
netedit.modifyAttribute(netedit.attrs.Enums.trainStop.inspect.id, "Id with spaces", True)

# Change parameter id with a valid value
netedit.modifyAttribute(netedit.attrs.Enums.trainStop.inspect.id, "correctID", True)
