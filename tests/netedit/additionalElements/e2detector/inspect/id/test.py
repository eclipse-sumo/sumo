...
netedit.modifyAttribute(netedit.attrs.enums.E2.inspect.id, "e2_1", True)

# Change parameter id with a non valid value (Invalid ID)
netedit.modifyAttribute(netedit.attrs.enums.E2.inspect.id, "Id with spaces", True)

# Change parameter id with a valid value
netedit.modifyAttribute(netedit.attrs.enums.E2.inspect.id, "correctID", True)
