...
netedit.changeDefaultValue(netedit.attrs.enums.E2.create.freq, "dummyFreq")

# try to create a E2 with invalid frequency
netedit.leftClick(referencePosition, 350, 250)

# set invalid frequency (negative)
netedit.changeDefaultValue(netedit.attrs.enums.E2.create.freq, "-30")

# try to create a E2 with invalid frequency
netedit.leftClick(referencePosition, 350, 250)

# set valid frequency
netedit.changeDefaultValue(netedit.attrs.enums.E2.create.freq, "120.5")
