...
netedit.changeDefaultValue(netedit.attrs.enums.E2.create.vTypes, "%%;$$$ %%$$ type.3")

# try to create E2 with invalid vehicle types
netedit.leftClick(referencePosition, 300, 220)

# set valid vehicle types
netedit.changeDefaultValue(netedit.attrs.enums.E2.create.vTypes, "type1 type2 type3")
