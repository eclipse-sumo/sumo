...
netedit.modifyAttribute(7, "dummyGenericParameters", False)

# Change generic parameters with a invalid format
netedit.modifyAttribute(7, "key1|key2|key3", False)

# Change generic parameters with a valid value
netedit.modifyAttribute(7, "key1=value1|key2=value2|key3=value3", False)
...
netedit.modifyAttribute(7, "key1duplicated=value1|key1duplicated=value2|key3=value3", False)

# Change generic parameters with a valid value
netedit.modifyAttribute(7, "key1=valueDuplicated|key2=valueDuplicated|key3=valueDuplicated", False)

# Change generic parameters with an invalid value (invalid key characters)
netedit.modifyAttribute(7, "keyInvalid.;%>%$$=value1|key2=value2|key3=value3", False)

# Change generic parameters with a invalid value (invalid value characters)
netedit.modifyAttribute(7, "key1=valueInvalid%;%$<>$$%|key2=value2|key3=value3", False)

# Change generic parameters with a valid value
netedit.modifyAttribute(7, "keyFinal1=value1|keyFinal2=value2|keyFinal3=value3", False)
