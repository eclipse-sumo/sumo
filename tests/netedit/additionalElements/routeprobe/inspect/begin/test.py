...
netedit.modifyAttribute(netedit.attrs.enums.routeProbe.inspect.begin, "dummy", True)

# Change parameter 5 with a non valid value (negative)
netedit.modifyAttribute(netedit.attrs.enums.routeProbe.inspect.begin, "-5", True)

# Change parameter 5 with a valid value
netedit.modifyAttribute(netedit.attrs.enums.routeProbe.inspect.begin, "20", True)
