...
netedit.modifyAttribute(netedit.attrs.Enums.routeProbe.inspect.name, "%%%;:..&&%$%$", True)

# Change parameter 3 with a duplicated value
netedit.modifyAttribute(netedit.attrs.Enums.routeProbe.inspect.name, "customName", True)
