...
netedit.modifyAttribute(netedit.attrs.Enums.calibrator.inspect.output, "///;;", True)

# Change parameter id with valid value
netedit.modifyAttribute(netedit.attrs.Enums.calibrator.inspect.output, "myOwnFilename", True)
