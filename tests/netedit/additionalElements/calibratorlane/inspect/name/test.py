...
netedit.modifyAttribute(netedit.attrs.enums.calibrator.inspect.name, "///", True)

# Change parameter id with valid value
netedit.modifyAttribute(netedit.attrs.enums.calibrator.inspect.name, "customName", True)
