...
netedit.changeDefaultValue(netedit.attrs.enums.E2Multilane.create.speedThreshold, "-14")

# create E2 with default parameters
netedit.typeEnter()

# set valid speed threshold
netedit.changeDefaultValue(netedit.attrs.enums.E2Multilane.create.speedThreshold, "2.5")
