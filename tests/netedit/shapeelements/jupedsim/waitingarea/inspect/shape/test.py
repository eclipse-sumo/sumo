...
netedit.modifyAttribute(netedit.attrs.jpsWaitingArea.inspect.shape, "dummyShape", False)

# Change parameter 1 with a non valid value (empty)
netedit.modifyAttribute(netedit.attrs.jpsWaitingArea.inspect.shape, "", False)
