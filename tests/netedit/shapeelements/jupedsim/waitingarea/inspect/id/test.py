...
netedit.modifyAttribute(netedit.attrs.jpsWaitingArea.inspect.id, "jps.walkable_area_0", False)

# Change parameter 0 with a non valid value (empty)
netedit.modifyAttribute(netedit.attrs.jpsWaitingArea.inspect.id, "", False)

# Change parameter 0 with a non valid value (invalid)
netedit.modifyAttribute(netedit.attrs.jpsWaitingArea.inspect.id, "ID with spaces", False)

# Change parameter 0 with a valid value
netedit.modifyAttribute(netedit.attrs.jpsWaitingArea.inspect.id, "newID", False)
