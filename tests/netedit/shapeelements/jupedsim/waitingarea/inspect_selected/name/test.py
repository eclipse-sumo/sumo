...
netedit.modifyAttribute(netedit.attrs.waitingArea.inspectSelection.name, "%$$%%%%%", False)

# Change parameter 7 with a non valid value (non exist)
netedit.modifyAttribute(netedit.attrs.waitingArea.inspectSelection.name, "customName", False)
