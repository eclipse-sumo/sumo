...
netedit.modifyAttribute(netedit.attrs.jpsWaitingArea.inspectSelection.name, "%$$%%%%%", False)

# Change parameter 7 with a non valid value (non exist)
netedit.modifyAttribute(netedit.attrs.jpsWaitingArea.inspectSelection.name, "customName", False)
