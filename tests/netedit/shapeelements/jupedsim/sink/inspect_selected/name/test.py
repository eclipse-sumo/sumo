...
netedit.modifyAttribute(netedit.attrs.jpsSink.inspectSelection.name, "%$$%%%%%", False)

# Change parameter 7 with a non valid value (non exist)
netedit.modifyAttribute(netedit.attrs.jpsSink.inspectSelection.name, "customName", False)
