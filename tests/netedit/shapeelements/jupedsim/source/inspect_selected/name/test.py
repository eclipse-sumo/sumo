...
netedit.modifyAttribute(netedit.attrs.jpsSource.inspectSelection.name, "%$$%%%%%", False)

# Change parameter 7 with a non valid value (non exist)
netedit.modifyAttribute(netedit.attrs.jpsSource.inspectSelection.name, "customName", False)
