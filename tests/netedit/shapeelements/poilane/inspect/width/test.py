...
netedit.modifyAttribute(netedit.attrs.POILane.inspect.width, "dummyWidth", True)

# Change parameter Width with a non valid value (negative)
netedit.modifyAttribute(netedit.attrs.POILane.inspect.width, "-2", True)

# Change parameter Width with a valid value
netedit.modifyAttribute(netedit.attrs.POILane.inspect.width, "5.5", True)
