...
netedit.modifyBoolAttribute(netedit.attrs.containerStopEdge.inspect.durationEnable, False)

# change depart with an invalid value
netedit.modifyBoolAttribute(netedit.attrs.containerStopEdge.inspect.durationEnable, False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.containerStopEdge.inspect.duration, "dummy", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.containerStopEdge.inspect.duration, "-7.3", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.containerStopEdge.inspect.duration, "6.7", False)
