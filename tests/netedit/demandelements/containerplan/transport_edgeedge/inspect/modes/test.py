...
netedit.modifyAttribute(netedit.attrs.transportEdgeEdge.inspect.modes, "dummy", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.transportEdgeEdge.inspect.modes, "", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.transportEdgeEdge.inspect.modes, "car", False)
