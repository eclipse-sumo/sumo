...
netedit.modifyAttribute(netedit.attrs.transhipEdgeEdge.inspect.to, "dummy", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.transhipEdgeEdge.inspect.to, "gneE4", False)
