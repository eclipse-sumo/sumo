...
netedit.modifyAttribute(netedit.attrs.transportEdgeBusStop.inspect.modes, "dummy", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.transportEdgeBusStop.inspect.modes, "", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.transportEdgeBusStop.inspect.modes, "car", False)
