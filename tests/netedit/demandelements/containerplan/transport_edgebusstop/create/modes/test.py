...
netedit.changeDefaultValue(netedit.attrs.transportEdgeBusStop.create.modes, "dummy")

# press enter to create route
netedit.typeEnter()

# set invalid container number
netedit.changeDefaultValue(netedit.attrs.transportEdgeBusStop.create.modes, "public")
