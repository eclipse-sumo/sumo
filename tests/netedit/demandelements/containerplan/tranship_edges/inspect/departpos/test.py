...
netedit.modifyAttribute(netedit.attrs.transhipEdges.inspect.departPos, "dummy", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.transhipEdges.inspect.departPos, "", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.transhipEdges.inspect.departPos, "-6", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.transhipEdges.inspect.departPos, "2.5", False)
