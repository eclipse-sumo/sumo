...
# change arrivalPos with an invalid value
netedit.modifyAttribute(netedit.attrs.tripFromToJunction.inspect.arrivalPos, "-10", False)

# change arrivalPos with a valid value
netedit.modifyAttribute(netedit.attrs.tripFromToJunction.inspect.arrivalPos, "15.5", False)
