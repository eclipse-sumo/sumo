...
netedit.modifyAttribute(netedit.attrs.tripFromToTAZ.inspect.type, "", False)

# change vType with an invalid value
netedit.modifyAttribute(netedit.attrs.tripFromToTAZ.inspect.type, ";;;;", False)

# change vType with an invalid value
netedit.modifyAttribute(netedit.attrs.tripFromToTAZ.inspect.type, "dummyVType", False)
