...
netedit.modifyAttribute(netedit.attrs.tripTAZ.inspect.insertionChecks, "custom Line", False)

# change personNumber with an invalid value
netedit.modifyAttribute(netedit.attrs.tripTAZ.inspect.insertionChecks,
