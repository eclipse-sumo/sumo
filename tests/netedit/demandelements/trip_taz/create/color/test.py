...
# set valid color
netedit.changeDefaultValue(netedit.attrs.tripFromToJunction.create.color, "cyan")
...
# set valid color
netedit.changeDefaultValue(netedit.attrs.tripFromToJunction.create.color, "12,13,14")
