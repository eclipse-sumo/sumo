...
# change triggered
netedit.changeDefaultValue(netedit.attrs.waypointParking.create.triggered, "person")
...
# set valid value
netedit.changeDefaultValue(netedit.attrs.waypointParking.create.expected, "personID1 personID2 personID3")
