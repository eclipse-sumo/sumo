...
# change value
netedit.modifyAttribute(netedit.attrs.waypointLane.inspect.triggered, "person", False)

# change value
netedit.modifyAttribute(netedit.attrs.waypointLane.inspect.expected, "personA personB", False)
