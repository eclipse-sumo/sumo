...
# change value
netedit.modifyAttribute(netedit.attrs.waypointLane.inspect.lane, "Edge2_0", False)

# change value
netedit.modifyAttribute(netedit.attrs.waypointLane.inspect.lane, "Edge0_0", False)
