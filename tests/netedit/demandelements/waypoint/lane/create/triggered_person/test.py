...
# change triggered
netedit.changeDefaultValue(netedit.attrs.waypointLane.create.triggered, "person")
...
# set valid value
netedit.changeDefaultValue(netedit.attrs.waypointLane.create.expected, "personID1 personID2 personID3")
