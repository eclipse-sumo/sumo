...
# set invalid value
netedit.changeDefaultValue(netedit.attrs.waypointTrainStop.create.tripID, ";;;;;;;;;;")
...
# set valid value
netedit.changeDefaultValue(netedit.attrs.waypointTrainStop.create.tripID, "customLine")
