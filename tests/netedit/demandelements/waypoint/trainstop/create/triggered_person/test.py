...
# change triggered
netedit.changeDefaultValue(netedit.attrs.waypointTrainStop.create.triggered, "person")
...
# set valid value
netedit.changeDefaultValue(netedit.attrs.waypointTrainStop.create.expected, "personID1 personID2 personID3")
