...
# change triggered
netedit.changeDefaultValue(netedit.attrs.waypointChargingStation.create.triggered, "person")
...
# set valid value
netedit.changeDefaultValue(netedit.attrs.waypointChargingStation.create.expected, "personID1 personID2 personID3")
