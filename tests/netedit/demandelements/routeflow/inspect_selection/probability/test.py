...
# change flow value
netedit.modifyAttribute(netedit.attrs.routeFlow.inspectSelection.spacing, "probability", True)
...
# change flow value
netedit.modifyAttribute(netedit.attrs.routeFlow.inspectSelection.spacingOption, "0.3", True)
