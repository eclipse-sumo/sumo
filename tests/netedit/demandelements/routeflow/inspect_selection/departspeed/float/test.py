...
netedit.modifyAttribute(netedit.attrs.routeFlow.inspectSelection.departSpeed, "500", False)

# change departSpeed with an invalid value
netedit.modifyAttribute(netedit.attrs.routeFlow.inspectSelection.departSpeed, "-10", False)

# change departSpeed with a valid value
netedit.modifyAttribute(netedit.attrs.routeFlow.inspectSelection.departSpeed, "20", False)
