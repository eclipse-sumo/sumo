...
# change flow value
netedit.modifyAttribute(netedit.attrs.flow.inspectSelection.spacing, "period", False)
...
# change flow value
netedit.modifyAttribute(netedit.attrs.flow.inspectSelection.spacingOption, "26", False)
