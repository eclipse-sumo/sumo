...
# change flow value
netedit.modifyAttribute(netedit.attrs.flowFromToEdge.inspectSelection.spacing, "period", False)
...
# change flow value
netedit.modifyAttribute(netedit.attrs.flowFromToEdge.inspectSelection.spacingOption, "26", False)
