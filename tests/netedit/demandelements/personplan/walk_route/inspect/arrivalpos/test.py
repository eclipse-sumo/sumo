...
netedit.modifyAttribute(netedit.attrs.walkRoute.inspect.arrivalPos, "dummy", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.walkRoute.inspect.arrivalPos, "", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.walkRoute.inspect.arrivalPos, "-6", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.walkRoute.inspect.arrivalPos, "2.5", False)
