...
# go to person plan mode
netedit.changePersonPlanMode("ride: edge->busStop")

# create rideEdgeBusStop
...
netedit.modifyAttribute(netedit.attrs.rideEdgeBusStop.inspect.to, "dummy", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.rideEdgeBusStop.inspect.to, "busStopB", False)
