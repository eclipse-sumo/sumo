...
netedit.modifyAttribute(netedit.attrs.personTripEdgeEdge.inspect.to, "dummy", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.personTripEdgeEdge.inspect.to, "gneE4", False)
