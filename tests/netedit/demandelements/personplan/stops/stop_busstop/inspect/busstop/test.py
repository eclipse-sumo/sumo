...
netedit.modifyAttribute(netedit.attrs.personStopBusStop.inspect.to, "dummy", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.personStopBusStop.inspect.to, "busStopB", False)
