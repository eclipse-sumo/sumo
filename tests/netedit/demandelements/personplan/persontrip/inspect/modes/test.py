...
netedit.modifyAttribute(netedit.attrs.personPlan.inspect.modes, "dummy", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.personPlan.inspect.modes, "", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.personPlan.inspect.modes, "car", False)
