...
# change flow value
netedit.modifyAttribute(netedit.attrs.flowJunction.inspectSelection.spacing, "poisson", False)
...
# change flow value
netedit.modifyAttribute(netedit.attrs.flowJunction.inspectSelection.spacingOption, "2.6", False)
