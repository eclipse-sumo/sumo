...
# change triggered
netedit.changeDefaultValue(netedit.attrs.busStop.create.triggered, "person")
...
# set valid value
netedit.changeDefaultValue(netedit.attrs.busStop.create.expected, "personID1 personID2 personID3")
