...
# set invalid value
netedit.changeDefaultValue(netedit.attrs.stopTrainStop.create.permitted, ";;;;;;;;;;")
...
# set valid value
netedit.changeDefaultValue(netedit.attrs.stopTrainStop.create.permitted, "ID1 ID2 ID3")
