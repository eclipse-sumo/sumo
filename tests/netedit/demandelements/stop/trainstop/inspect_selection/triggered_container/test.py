...
# change value
netedit.modifyAttribute(netedit.attrs.stopTrainStop.inspectSelection.triggered, "container", False)

# change value
netedit.modifyAttribute(netedit.attrs.stopTrainStop.inspectSelection.expected, "containerA containerB", False)
