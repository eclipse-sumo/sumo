...
# change value
netedit.modifyAttribute(netedit.attrs.stopLane.inspect.triggered, "person", False)

# change value
netedit.modifyAttribute(netedit.attrs.stopLane.inspect.expected, "personA personB", False)
