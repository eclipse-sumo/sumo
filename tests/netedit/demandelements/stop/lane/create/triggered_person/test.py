...
# change triggered
netedit.changeDefaultValue(netedit.attrs.stopLane.create.triggered, "person")
...
# set valid value
netedit.changeDefaultValue(netedit.attrs.stopLane.create.expected, "personID1 personID2 personID3")
