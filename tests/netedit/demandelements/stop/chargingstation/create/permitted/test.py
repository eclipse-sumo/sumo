...
# set invalid value
netedit.changeDefaultValue(netedit.attrs.stopChargingStation.create.permitted, ";;;;;;;;;;")
...
# set valid value
netedit.changeDefaultValue(netedit.attrs.stopChargingStation.create.permitted, "ID1 ID2 ID3")
