...
# set invalid value
netedit.changeDefaultValue(netedit.attrs.stopContainerStop.create.split, ";;;;;;;;;;")
...
# set valid value
netedit.changeDefaultValue(netedit.attrs.stopContainerStop.create.split, "customSplit")
