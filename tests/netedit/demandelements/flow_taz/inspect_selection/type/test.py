...
netedit.modifyAttribute(netedit.attrs.flowTAZ.inspectSelection.type, "", False)

# change departLane with an invalid value
netedit.modifyAttribute(netedit.attrs.flowTAZ.inspectSelection.type, "dummyType", False)
