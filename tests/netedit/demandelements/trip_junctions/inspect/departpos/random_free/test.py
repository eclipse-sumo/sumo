...
netedit.modifyAttribute(netedit.attrs.tripJunction.inspect.departPos, "", False)

# change departLane with an invalid value
netedit.modifyAttribute(netedit.attrs.tripJunction.inspect.departPos, "dummyPos", False)

# change departLane with an invalid value
netedit.modifyAttribute(netedit.attrs.tripJunction.inspect.departPos, "500", False)

# change departLane with a valid value
netedit.modifyAttribute(netedit.attrs.tripJunction.inspect.departPos, "random_free", False)
