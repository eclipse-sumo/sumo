...
netedit.modifyAttribute(netedit.attrs.tripFromToJunction.inspect.type, "", False)

# change vType with an invalid value
netedit.modifyAttribute(netedit.attrs.tripFromToJunction.inspect.type, ";;;;", False)

# change vType with an invalid value
netedit.modifyAttribute(netedit.attrs.tripFromToJunction.inspect.type, "dummyVType", False)
