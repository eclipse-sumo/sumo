...
# Change parameter SpeedThreshold with a non valid value (dummy)
netedit.modifyAttribute(netedit.attrs.E3.inspect.speedThreshold, "dummySpeedThreshold", False)

# Change parameter SpeedThreshold with a non valid value (negative)
