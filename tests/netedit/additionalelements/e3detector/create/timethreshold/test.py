...
# set invalid timeThreshold
netedit.changeDefaultValue(netedit.attrs.E3.create.timeThreshold, "dummyTimeThreshold")

# try to create E3 with invalid timeThreshold
