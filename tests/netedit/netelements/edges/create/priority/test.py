...
# set attribute
netedit.changeDefaultValue(netedit.attrs.edge.create.priority, "dummy")
...
# set attribute
netedit.changeDefaultValue(netedit.attrs.edge.create.priority, "-50")
...
# set attribute
netedit.changeDefaultValue(netedit.attrs.edge.create.priority, "23.5")
