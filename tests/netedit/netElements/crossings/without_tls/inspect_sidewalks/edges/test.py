...
# set invalid edge
netedit.modifyAttribute(netedit.attrs.Enums.crossing.inspect.edges, "dummy Edges", True)

# Change Edges adding a new edge
netedit.modifyAttribute(netedit.attrs.Enums.crossing.inspect.edges, "3 7 1", True)
...
netedit.modifyAttribute(netedit.attrs.Enums.crossing.inspect.edges, "4 8", True)
...
netedit.modifyAttribute(netedit.attrs.Enums.crossing.inspect.edges, "3", True)
