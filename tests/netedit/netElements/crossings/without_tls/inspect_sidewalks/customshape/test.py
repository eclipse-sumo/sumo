...
netedit.modifyAttribute(netedit.attrs.Enums.crossing.inspect.customShape, "dummyShape", True)

# Change shape with a valid value
netedit.modifyAttribute(netedit.attrs.Enums.crossing.inspect.customShape,
