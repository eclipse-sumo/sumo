...
netedit.modifyAttribute(netedit.attrs.Enums.crossing.inspectTLS.customShape, "dummyShape", True)

# Change shape with a valid value
netedit.modifyAttribute(netedit.attrs.Enums.crossing.inspectTLS.customShape,
