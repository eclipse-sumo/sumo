...
netedit.modifyAttribute(netedit.attrs.Enums.junction.inspect.pos, "dummy position", False)

# change position with a non valid value (another junction in the same position)
netedit.modifyAttribute(netedit.attrs.Enums.junction.inspect.pos, "0.00,50.00", False)

# avoid merging
netedit.typeTwoKeys('n', 'alt')

# change position with a valid value
netedit.modifyAttribute(netedit.attrs.Enums.junction.inspect.pos, "40.00,40.00", False)
