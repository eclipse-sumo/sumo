...
# set dummy shape
netedit.modifyAttribute(netedit.attrs.enums.junction.inspectTLS.shape, "dummy shape", False)

# change shape of junction
netedit.modifyAttribute(netedit.attrs.enums.junction.inspectTLS.shape,
