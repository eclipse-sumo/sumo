...
# set attribute
netedit.modifyAttribute(netedit.attrs.edge.create.width, "dummy")
...
# set attribute
netedit.modifyAttribute(netedit.attrs.edge.create.width, "-50")
...
# set attribute
netedit.modifyAttribute(netedit.attrs.edge.create.width, "23.5")
