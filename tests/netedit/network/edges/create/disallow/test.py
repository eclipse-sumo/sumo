...
# set attribute
netedit.modifyAttribute(netedit.attrs.edge.create.disallow, "dummy")
...
# set attribute
netedit.modifyAttribute(netedit.attrs.edge.create.disallow, "pedestrian bus")
...
# set attribute
netedit.modifyAttribute(netedit.attrs.edge.create.disallow, "all")
