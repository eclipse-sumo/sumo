...
netedit.modifyAttributeOverlapped(netedit.attrs.connection.inspectTLS.changeRight, "DummyAllowed")

# Change parameter 8 with a valid value (empty)
netedit.modifyAttributeOverlapped(netedit.attrs.connection.inspectTLS.changeRight, "")
