...
netedit.modifyAttributeOverlapped(netedit.attrs.connection.inspectSelectionTLS.disallow, "DummyAllowed")

# Change parameter 8 with a valid value (empty)
netedit.modifyAttributeOverlapped(netedit.attrs.connection.inspectSelectionTLS.disallow, "")
