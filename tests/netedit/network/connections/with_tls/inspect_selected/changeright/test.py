...
netedit.modifyAttribute(netedit.attrs.connection.inspectSelection.changeRight, "authority  army, passenger; taxi. tram", True)
...
# Change parameter 8 with a valid value (empty)
netedit.modifyAttribute(netedit.attrs.connection.inspectSelection.changeRight, "authority army vip passenger hov taxi bus coach tram bicycle", True)
