...
netedit.modifyAttributeOverlapped(netedit.attrs.connection.inspect.changeLeft, "DummyAllowed")

# Change parameter 8 with a valid value (empty)
netedit.modifyAttributeOverlapped(netedit.attrs.connection.inspect.changeLeft, "")

# Change parameter 8 with a valid value (different separators)
netedit.modifyAttributeOverlapped(netedit.attrs.connection.inspect.changeLeft, "authority  army, passenger; taxi. tram")
