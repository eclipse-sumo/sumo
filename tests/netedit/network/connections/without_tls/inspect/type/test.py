...
netedit.modifyAttributeOverlapped(netedit.attrs.connection.inspect.type, "%%%;;;;%%")

# Change type with an valid value (empty)
netedit.modifyAttributeOverlapped(netedit.attrs.connection.inspect.type, "")

# Change type with an valid value
netedit.modifyAttributeOverlapped(netedit.attrs.connection.inspect.type, "customType")
