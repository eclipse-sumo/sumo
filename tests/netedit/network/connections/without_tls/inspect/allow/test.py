...
netedit.modifyAttributeOverlapped(netedit.attrs.connection.inspect.allow, "DummyAllowed")

# Change parameter 8 with a valid value (empty)
netedit.modifyAttributeOverlapped(netedit.attrs.connection.inspect.allow, "")

# Change parameter 8 with a valid value (different separators)
netedit.modifyAttributeOverlapped(netedit.attrs.connection.inspect.allow, "authority  army, passenger; taxi. tram")
