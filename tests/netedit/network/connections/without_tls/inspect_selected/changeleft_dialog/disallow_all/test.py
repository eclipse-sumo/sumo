...
netedit.modifyAttributeVClassDialogOverlapped(netedit.attrs.connection.inspectSelection.changeLeftButton,
                                              netedit.attrs.dialog.allowVClass.disallowAll, disallowAll=False)
