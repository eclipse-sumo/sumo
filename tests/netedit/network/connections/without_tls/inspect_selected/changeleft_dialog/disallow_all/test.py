...
netedit.modifyAttributeVClassDialogOverlapped_NoDisallowAll(netedit.attrs.connection.inspectSelection.changeLeftButton,
                                              netedit.attrs.dialog.allowVClass.disallowAll)
