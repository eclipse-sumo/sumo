...
netedit.modifyAttributeVClassDialogOverlapped(netedit.attrs.connection.inspectSelection.allowButton,
                                              netedit.attrs.dialog.allowVClass.pedestrian, reset=True)
