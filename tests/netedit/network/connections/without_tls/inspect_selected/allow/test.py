...
netedit.modifyAttributeOverlapped(netedit.attrs.connection.inspectSelection.allow, "DummyAllowed")

# Change parameter 8 with a valid value (empty)
netedit.modifyAttributeOverlapped(netedit.attrs.connection.inspectSelection.allow, "")
