...
netedit.modifyAttributeVClassDialogOverlapped_DisallowAll(
    netedit.attrs.connection.inspectSelection.changeRightButton, netedit.attrs.dialog.allowVClass.rail_electric)
