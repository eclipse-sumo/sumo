...
# set invalid value
netedit.modifyAttribute(netedit.attrs.junction.inspectSelectionTLS.tlLayout, "dummyTLS")

# change type of junction
netedit.modifyAttribute(netedit.attrs.junction.inspectSelectionTLS.tlLayout, "incoming")
