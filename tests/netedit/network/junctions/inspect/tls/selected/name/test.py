...
# set invalid radius
netedit.modifyAttribute(netedit.attrs.junction.inspectSelectionTLS.name, "%%%;;;;")

# set invalid radius
netedit.modifyAttribute(netedit.attrs.junction.inspectSelectionTLS.name, "customName")
