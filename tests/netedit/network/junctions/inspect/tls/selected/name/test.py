...
# set invalid radius
netedit.modifyAttribute(netedit.attrs.junction.inspectSelectionTLS.name, "%%%;;;;", False)

# set invalid radius
netedit.modifyAttribute(netedit.attrs.junction.inspectSelectionTLS.name, "customName", False)
