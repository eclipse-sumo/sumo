...
netedit.modifyAttribute(netedit.attrs.lane.inspect.changeRight, "DummyAllowed")
...
netedit.modifyAttribute(netedit.attrs.lane.inspect.changeRight, "authority  army, passenger; taxi. tram")
