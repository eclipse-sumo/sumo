...
netedit.modifyAttribute(netedit.attrs.lane.inspect.disallow, "DummyDisallowed")
...
netedit.modifyAttribute(netedit.attrs.lane.inspect.disallow, "authority  army, passenger; taxi. tram", False)
