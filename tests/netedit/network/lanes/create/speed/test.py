...
# set attribute
netedit.modifyAttribute(netedit.attrs.lane.create.speed, "dummy")
...
# set attribute
netedit.modifyAttribute(netedit.attrs.lane.create.speed, "-50")
...
# set attribute
netedit.modifyAttribute(netedit.attrs.lane.create.speed, "23.5")
