...
# set attribute
netedit.modifyAttribute(netedit.attrs.lane.create.width, "dummy")
...
# set attribute
netedit.modifyAttribute(netedit.attrs.lane.create.width, "-50")
...
# set attribute
netedit.modifyAttribute(netedit.attrs.lane.create.width, "23.5")
