...
# set attribute
netedit.modifyAttribute(netedit.attrs.lane.create.disallow, "dummy")
...
# set attribute
netedit.modifyAttribute(netedit.attrs.lane.create.disallow, "pedestrian bus")
...
# set attribute
netedit.modifyAttribute(netedit.attrs.lane.create.disallow, "all")
