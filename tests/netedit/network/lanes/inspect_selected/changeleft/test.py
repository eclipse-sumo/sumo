...
netedit.modifyAttribute(netedit.attrs.lane.inspectSelection.changeLeft, "DummyAllowed")
...
netedit.modifyAttribute(netedit.attrs.lane.inspectSelection.changeLeft, "authority  army, passenger; taxi. tram")
