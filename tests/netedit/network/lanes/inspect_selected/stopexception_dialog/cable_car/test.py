...
netedit.modifyAttributeVClassDialog_DisallowAll(netedit.attrs.lane.inspectSelection.stopOffsetExceptionButton,
                                    netedit.attrs.dialog.allowVClass.cable_car)
