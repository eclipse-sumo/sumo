...
netedit.modifyAttribute(netedit.attrs.enums.POI.inspect.pos, "dummyPosition", False)

# Change parameter 1 with a valid value
netedit.modifyAttribute(netedit.attrs.enums.POI.inspect.pos, "20.40,7.50", False)
