...
netedit.modifyAttribute(4, "dummyColor", False)

# Change parameter 4 with a non valid value (invalid format)
netedit.modifyAttribute(4, "255,255,500", False)

# Change parameter 4 with a valid value (valid format)
netedit.modifyAttribute(4, "blue", False)

# Change parameter 4 with a valid value (valid format)
netedit.modifyAttribute(4, "125,60,200", False)
