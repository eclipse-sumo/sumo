...
netedit.modifyAttribute(netedit.attrs.enums.POILane.inspect.posLat, "dummyLatPosition", True)

# Change parameter LatPosition with a valid value (negative)
netedit.modifyAttribute(netedit.attrs.enums.POILane.inspect.posLat, "-20", True)

# Change parameter LatPosition with a valid value
netedit.modifyAttribute(netedit.attrs.enums.POILane.inspect.posLat, "15", True)
