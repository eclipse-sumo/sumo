...
netedit.modifyAttribute(netedit.attrs.enums.POILane.inspect.imgFile, "%$$%%%%%", True)

# Change parameter file with a non valid value (no exist)
netedit.modifyAttribute(netedit.attrs.enums.POILane.inspect.imgFile, "paris.ico", True)

# Change parameter file with a valid value (valid)
netedit.modifyAttribute(netedit.attrs.enums.POILane.inspect.imgFile, "berlin_icon.ico", True)
