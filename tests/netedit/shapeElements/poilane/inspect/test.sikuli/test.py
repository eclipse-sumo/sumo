...
netedit.modifyAttribute(8, "dummyWidth")
...
netedit.modifyAttribute(10, "paris.ico")

# Change parameter 9 with a valid value (valid)
netedit.modifyAttribute(10, "berlin_icon.ico")
