...
netedit.modifyAttribute(netedit.attrs.Enums.POILane.inspectSelection.name, "%$$%%%%%", True)

# Change parameter file with a non valid value (no exist)
netedit.modifyAttribute(netedit.attrs.Enums.POILane.inspectSelection.name, "customName", True)
