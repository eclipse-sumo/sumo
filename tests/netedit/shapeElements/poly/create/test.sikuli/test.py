...
# reset angle
netedit.modifyShapeDefaultValue(9, "0")
...
# create polygon
netedit.createSquaredPoly(match, 600, 150, 100, True)

# reset block shape
netedit.modifyShapeDefaultBoolValue(12)

# create open polygon
netedit.createSquaredPoly(match, 100, 350, 100, False)
...
netedit.createSquaredPoly(match, 300, 350, 100, True)

# create polygon clicking in the same points
netedit.createSquaredPoly(match, 400, 350, 0, True)

# create rectangled polygon with area 0
netedit.createRectangledPoly(match, 500, 350, 100, 0, True)

# create open line polygon
netedit.createLinePoly(match, 600, 350, 100, 100, True)
