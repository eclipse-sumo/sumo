...
netedit.modifyAttribute(netedit.attrs.enums.Poly.inspect.shape, "dummyShape", False)

# Change parameter 1 with a non valid value (empty)
netedit.modifyAttribute(netedit.attrs.enums.Poly.inspect.shape, "", False)

# Change parameter 1 with a valid value (single point)
netedit.modifyAttribute(netedit.attrs.enums.Poly.inspect.shape, "12.00,8.00", False)

# Change parameter 1 with a valid value
netedit.modifyAttribute(netedit.attrs.enums.Poly.inspect.shape, "12.00,8.00 9.00,13.00 12.00,18.00 7.00,15.00 2.00,18.00 " +
