...
netedit.modifyAttribute(netedit.attrs.Enums.Poly.inspect.angle, "dummyAngle", False)

# Change parameter 11 with a valid value (negative)
netedit.modifyAttribute(netedit.attrs.Enums.Poly.inspect.angle, "-5", False)

# Change parameter 11 with a valid value (> 360)
netedit.modifyAttribute(netedit.attrs.Enums.Poly.inspect.angle, "365", False)

# Change parameter 11 with a valid value
netedit.modifyAttribute(netedit.attrs.Enums.Poly.inspect.angle, "10", False)
