...
netedit.modifyAttribute(netedit.attrs.enums.Poly.inspect.id, "poly_1", False)

# Change parameter 0 with a non valid value (empty)
netedit.modifyAttribute(netedit.attrs.enums.Poly.inspect.id, "", False)

# Change parameter 0 with a non valid value (invalid)
netedit.modifyAttribute(netedit.attrs.enums.Poly.inspect.id, "ID with spaces", False)

# Change parameter 0 with a valid value
netedit.modifyAttribute(netedit.attrs.enums.Poly.inspect.id, "newID", False)
