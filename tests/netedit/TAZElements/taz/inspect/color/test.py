...
netedit.modifyAttribute(5, "dummyColor", False)

# Change parameter 2 with a non valid value (invalid format)
netedit.modifyAttribute(5, "255,255,500", False)

# Change parameter 2 with a valid value (valid format)
netedit.modifyAttribute(5, "blue", False)

# Change parameter 2 with a valid value (valid format)
netedit.modifyAttribute(5, "125,60,200", False)
