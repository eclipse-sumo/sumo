...
netedit.modifyAttributeOverlapped(netedit.attrs.chargingStation.inspect.id, "cs_1")

# Change parameter id with a non valid value (Invalid ID)
netedit.modifyAttributeOverlapped(netedit.attrs.chargingStation.inspect.id, "Id with spaces")

# Change parameter id with a valid value
netedit.modifyAttributeOverlapped(netedit.attrs.chargingStation.inspect.id, "correctID")
