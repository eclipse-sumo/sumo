...
netedit.modifyAttributeOverlapped(netedit.attrs.calibrator.inspectSelection.output, "///;;")

# Change parameter id with valid value
netedit.modifyAttributeOverlapped(netedit.attrs.calibrator.inspectSelection.output, "myOwnFilename")
