...
netedit.modifyAttributeOverlapped(netedit.attrs.calibrator.inspectSelection.period, "dummyFreq")

# Change parameter id with a non valid value (negative)
netedit.modifyAttributeOverlapped(netedit.attrs.calibrator.inspectSelection.period, "-12")

# Change parameter id with a valid value
netedit.modifyAttributeOverlapped(netedit.attrs.calibrator.inspectSelection.period, "12.5")
