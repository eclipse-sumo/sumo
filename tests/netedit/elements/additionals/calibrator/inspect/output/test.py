...
netedit.modifyAttributeOverlapped(netedit.attrs.calibrator.inspect.output, "///;;")

# Change parameter id with valid value
netedit.modifyAttributeOverlapped(netedit.attrs.calibrator.inspect.output, "myOwnFilename")
