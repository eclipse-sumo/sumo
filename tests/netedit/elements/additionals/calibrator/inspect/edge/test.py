...
netedit.modifyAttribute(netedit.attrs.calibrator.inspect.edge, "dummyEdge", False)

# Change parameter id with a valid value
netedit.modifyAttribute(netedit.attrs.calibrator.inspect.edge, "Edge2", False)
