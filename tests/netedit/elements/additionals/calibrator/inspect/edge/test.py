...
netedit.modifyAttributeOverlapped(netedit.attrs.calibrator.inspect.edge, "dummyEdge")

# Change parameter id with a valid value
netedit.modifyAttributeOverlapped(netedit.attrs.calibrator.inspect.edge, "Edge2")
