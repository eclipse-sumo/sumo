...
netedit.modifyAttribute(netedit.attrs.calibrator.inspectSelection.output, "///;;")

# Change parameter id with valid value
netedit.modifyAttribute(netedit.attrs.calibrator.inspectSelection.output, "myOwnFilename")
