...
netedit.modifyAttribute(netedit.attrs.calibrator.inspectSelection.name, "///", False)

# Change parameter id with valid value
netedit.modifyAttribute(netedit.attrs.calibrator.inspectSelection.name, "customName", False)
