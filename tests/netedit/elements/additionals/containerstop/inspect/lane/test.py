...
netedit.modifyAttributeOverlapped(netedit.attrs.containerStop.inspect.lane, "dummy lane")

# Change parameter lane with a valid value (different edge)
netedit.modifyAttributeOverlapped(netedit.attrs.containerStop.inspect.lane, "EdgeCenter0_0")

# Change parameter lane with a valid value (original edge, same lane)
netedit.modifyAttributeOverlapped(netedit.attrs.containerStop.inspect.lane, "EdgeCenter1_1")

# Change parameter lane with a valid value (original edge, different lane)
netedit.modifyAttributeOverlapped(netedit.attrs.containerStop.inspect.lane, "EdgeCenter1_0")
