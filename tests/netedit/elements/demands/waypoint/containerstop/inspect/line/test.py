...
# change value
netedit.modifyAttribute(netedit.attrs.waypointContainerStop.inspect.line, ";;;")

# change value
netedit.modifyAttribute(netedit.attrs.waypointContainerStop.inspect.line, "")

# change value
netedit.modifyAttribute(netedit.attrs.waypointContainerStop.inspect.line, "customLine")
