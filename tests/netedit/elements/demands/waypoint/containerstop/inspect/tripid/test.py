...
# change value
netedit.modifyAttribute(netedit.attrs.waypointContainerStop.inspect.tripID, ";;;;;;")

# change value
netedit.modifyAttribute(netedit.attrs.waypointContainerStop.inspect.tripID, "")

# change value
netedit.modifyAttribute(netedit.attrs.waypointContainerStop.inspect.tripID, "customType")
