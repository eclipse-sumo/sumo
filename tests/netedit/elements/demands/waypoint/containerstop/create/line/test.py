...
# set invalid value
netedit.modifyAttribute(netedit.attrs.waypointContainerStop.create.line, ";;;;;;;;;;")
...
# set valid value
netedit.modifyAttribute(netedit.attrs.waypointContainerStop.create.line, "customLine")
