...
# set invalid value
netedit.modifyAttribute(netedit.attrs.waypointContainerStop.create.tripID, ";;;;;;;;;;")
...
# set valid value
netedit.modifyAttribute(netedit.attrs.waypointContainerStop.create.tripID, "tripID")
