...
# set invalid value
netedit.modifyAttribute(netedit.attrs.waypointParking.create.permitted, ";;;;;;;;;;")
...
# set valid value
netedit.modifyAttribute(netedit.attrs.waypointParking.create.permitted, "ID1 ID2 ID3")
