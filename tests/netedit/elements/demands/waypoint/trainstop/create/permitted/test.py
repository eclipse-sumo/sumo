...
# set invalid value
netedit.modifyAttribute(netedit.attrs.waypointTrainStop.create.permitted, ";;;;;;;;;;")
...
# set valid value
netedit.modifyAttribute(netedit.attrs.waypointTrainStop.create.permitted, "ID1 ID2 ID3")
