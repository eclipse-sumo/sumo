...
# set invalid value
netedit.modifyAttribute(netedit.attrs.waypointTrainStop.create.speed, ";;;;;;;;;;")
...
# set valid value
netedit.modifyAttribute(netedit.attrs.waypointTrainStop.create.speed, "-10")

# create waypoint
netedit.leftClickControl(referencePosition, netedit.positions.elements.demands.trainStop)

# set valid value
netedit.modifyAttribute(netedit.attrs.waypointTrainStop.create.speed, "19.41")
