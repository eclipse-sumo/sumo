...
# change value
netedit.modifyAttributeOverlapped(netedit.attrs.waypointLane.inspect.line, ";;;;")

# change value
netedit.modifyAttributeOverlapped(netedit.attrs.waypointLane.inspect.line, "")

# change value
netedit.modifyAttributeOverlapped(netedit.attrs.waypointLane.inspect.line, "customLine")
