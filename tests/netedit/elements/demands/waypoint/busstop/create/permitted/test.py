...
# set invalid value
netedit.modifyAttribute(netedit.attrs.waypointBusStop.create.permitted, ";;;;;;;;;;")
...
# set valid value
netedit.modifyAttribute(netedit.attrs.waypointBusStop.create.permitted, "ID1 ID2 ID3")
