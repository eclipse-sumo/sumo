...
# change value
netedit.modifyAttribute(netedit.attrs.waypointChargingStation.inspect.tripID, ";;;;")

# change value
netedit.modifyAttribute(netedit.attrs.waypointChargingStation.inspect.tripID, "")

# change value
netedit.modifyAttribute(netedit.attrs.waypointChargingStation.inspect.tripID, "customID")
