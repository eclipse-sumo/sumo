...
# set invalid value
netedit.modifyAttribute(netedit.attrs.waypointChargingStation.create.tripID, ";;;;;;;;;;")
...
# set valid value
netedit.modifyAttribute(netedit.attrs.waypointChargingStation.create.tripID, "tripID")
