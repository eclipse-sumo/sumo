...
# set invalid value
netedit.modifyAttribute(netedit.attrs.waypointChargingStation.create.line, ";;;;;;;;;;")
...
# set valid value
netedit.modifyAttribute(netedit.attrs.waypointChargingStation.create.line, "customLine")
