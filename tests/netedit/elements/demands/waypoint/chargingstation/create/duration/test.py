...
# set invalid value
netedit.modifyAttribute(netedit.attrs.waypointChargingStation.create.duration, "dummyValue")

# try to create waypoint
netedit.leftClickControl(referencePosition, netedit.positions.elements.demands.chargingStation)

# set invalid value
netedit.modifyAttribute(netedit.attrs.waypointChargingStation.create.duration, "-20")

# try to create waypoint
netedit.leftClickControl(referencePosition, netedit.positions.elements.demands.chargingStation)

# set valid value
netedit.modifyAttribute(netedit.attrs.waypointChargingStation.create.duration, "0")

# try to create waypoint
netedit.leftClickControl(referencePosition, netedit.positions.elements.demands.chargingStation)

# set valid value
netedit.modifyAttribute(netedit.attrs.waypointChargingStation.create.duration, "22.33")
