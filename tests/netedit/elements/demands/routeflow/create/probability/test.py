...
# set invalid arrival pos
netedit.modifyAttribute(netedit.attrs.routeFlow.create.spacing, "probability")
...
# set valid arrival pos
netedit.modifyAttribute(netedit.attrs.routeFlow.create.spacingOption, "20.5")

# try to create vehicle
netedit.leftClick(referencePosition, netedit.positions.elements.edge0)

# set valid arrival pos
netedit.modifyAttribute(netedit.attrs.routeFlow.create.spacingOption, "0.6")
