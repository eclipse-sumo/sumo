...
# change flow value
netedit.modifyAttributeOverlapped(netedit.attrs.routeFlow.inspect.spacing, "poisson")
...
# change flow value
netedit.modifyAttributeOverlapped(netedit.attrs.routeFlow.inspect.spacingOption, "2.6")
