...
# change flow value
netedit.modifyAttributeOverlapped(netedit.attrs.routeFlow.inspect.terminate, "end")
...
# change flow value
netedit.modifyAttributeOverlapped(netedit.attrs.routeFlow.inspect.terminateOption, "23")
