...
# change departLane with an invalid value
netedit.modifyAttribute(netedit.attrs.trip.inspect.departLane, "500")

# change departLane with an invalid value
netedit.modifyAttribute(netedit.attrs.trip.inspect.departLane, "-10")

# change departLane with a valid value
netedit.modifyAttribute(netedit.attrs.trip.inspect.departLane, "0")
