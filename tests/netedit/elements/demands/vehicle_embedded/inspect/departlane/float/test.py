...
netedit.modifyAttribute(netedit.attrs.vehicleEmbedded.inspect.departLane, "", False)

# change departLane with an invalid value
netedit.modifyAttribute(netedit.attrs.vehicleEmbedded.inspect.departLane, "dummyDepart", False)

# change departLane with an invalid value
netedit.modifyAttribute(netedit.attrs.vehicleEmbedded.inspect.departLane, "500", False)

# change departLane with an invalid value
netedit.modifyAttribute(netedit.attrs.vehicleEmbedded.inspect.departLane, "-10", False)

# change departLane with a valid value
netedit.modifyAttribute(netedit.attrs.vehicleEmbedded.inspect.departLane, "0", False)
