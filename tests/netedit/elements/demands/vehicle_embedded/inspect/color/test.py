...
netedit.modifyColorAttribute(netedit.attrs.vehicleEmbedded.inspect.colorButton)
...
netedit.modifyAttribute(netedit.attrs.vehicleEmbedded.inspect.color, "12,13,14")
