...
netedit.modifyAttribute(netedit.attrs.vehicleEmbedded.create.departSpeed, "dummySpeed")
...
# set valid depart speed
netedit.modifyAttribute(netedit.attrs.vehicleEmbedded.create.departSpeed, "20")
