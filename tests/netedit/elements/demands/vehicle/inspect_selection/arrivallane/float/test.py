...
netedit.modifyAttributeOverlapped(netedit.attrs.vehicle.inspectSelection.arrivalLane, "500")

# change arrivalLane with a valid value
netedit.modifyAttributeOverlapped(netedit.attrs.vehicle.inspectSelection.arrivalLane, "0")
