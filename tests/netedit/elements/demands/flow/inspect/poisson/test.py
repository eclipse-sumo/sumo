...
netedit.modifyAttribute(netedit.attrs.flow.inspect.terminateOption, "22")
...
# change flow value
netedit.modifyAttribute(netedit.attrs.flow.inspect.spacing, "poisson")
...
# change flow value
netedit.modifyAttribute(netedit.attrs.flow.inspect.spacingOption, "2.6")
