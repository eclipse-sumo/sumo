...
netedit.modifyColorAttribute(netedit.attrs.flow.inspectSelection.colorButton, 5)

# change color with an invalid value
netedit.modifyAttribute(netedit.attrs.flow.inspectSelection.color, "")

# change color with an invalid value
netedit.modifyAttribute(netedit.attrs.flow.inspectSelection.color, "dummyColor")
