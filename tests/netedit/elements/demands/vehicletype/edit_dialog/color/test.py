...
# modify attribute
netedit.modifyVTypeDialogAttribute("open", netedit.attrs.type.editDialog.color, "dummy")
...
# modify attribute
netedit.modifyVTypeDialogAttribute("close", netedit.attrs.type.editDialog.color, "12,13,14")
