...
netedit.modifyAttribute(netedit.attrs.tranship.busStop.edge.create.arrivalPos, "dummy")

# press enter to create route
netedit.typeKey("enter")

# set invalid container number
netedit.modifyAttribute(netedit.attrs.tranship.busStop.edge.create.arrivalPos, "12.5")
