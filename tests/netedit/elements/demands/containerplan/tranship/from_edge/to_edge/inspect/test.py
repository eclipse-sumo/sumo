...
netedit.modifyAttribute(netedit.attrs.tranship.edge.edge.inspect.arrivalPos, "dummy")

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.tranship.edge.edge.inspect.arrivalPos, "")

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.tranship.edge.edge.inspect.arrivalPos, "-6")

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.tranship.edge.edge.inspect.arrivalPos, "2.5")
