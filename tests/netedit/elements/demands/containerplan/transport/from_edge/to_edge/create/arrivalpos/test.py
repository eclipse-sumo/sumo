...
netedit.modifyAttribute(netedit.attrs.transport.edge.edge.create.arrivalPos, "dummy")

# press enter to create route
netedit.typeKey("enter")

# set invalid container number
netedit.modifyAttribute(netedit.attrs.transport.edge.edge.create.arrivalPos, "12.5")
