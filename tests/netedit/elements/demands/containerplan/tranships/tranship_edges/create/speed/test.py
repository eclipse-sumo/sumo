...
netedit.changeDefaultValue(netedit.attrs.transhipEdges.create.speed, "dummySpeed")

# set invalid container number
netedit.changeDefaultValue(netedit.attrs.transhipEdges.create.speed, "12.45")
