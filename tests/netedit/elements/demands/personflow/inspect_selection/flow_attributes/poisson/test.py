...
# change flow value
netedit.modifyAttribute(netedit.attrs.personFlow.inspectSelection.spacing, "poisson")
...
# change flow value
netedit.modifyAttribute(netedit.attrs.personFlow.inspectSelection.spacingOption, "2.6")
