...
netedit.modifyColorAttribute(netedit.attrs.tripTAZ.inspect.colorButton, 5)

# change color with an invalid value
netedit.modifyAttribute(netedit.attrs.tripTAZ.inspect.color, "")

# change color with an invalid value
netedit.modifyAttribute(netedit.attrs.tripTAZ.inspect.color, "dummyColor")

# change color with an valid value
netedit.modifyAttribute(netedit.attrs.tripTAZ.inspect.color, "cyan")

# change color with a valid value
netedit.modifyAttribute(netedit.attrs.tripTAZ.inspect.color, "12,13,14")
