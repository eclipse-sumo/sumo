...
netedit.modifyAttribute(netedit.attrs.tripTAZ.inspect.departLane, "")

# change departLane with an invalid value
netedit.modifyAttribute(netedit.attrs.tripTAZ.inspect.departLane, "dummyDepart")

# change departLane with a valid value
netedit.modifyAttribute(netedit.attrs.tripTAZ.inspect.departLane, "first")
