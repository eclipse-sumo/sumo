...
netedit.modifyAttribute(netedit.attrs.flowTAZ.inspect.arrivalPosLat, "")

# change arrivalPosLat with an invalid value
netedit.modifyAttribute(netedit.attrs.flowTAZ.inspect.arrivalPosLat, "dummyPosLat")

# change arrivalPosLat with an invalid valid value
netedit.modifyAttribute(netedit.attrs.flowTAZ.inspect.arrivalPosLat, "-12")

# change arrivalPosLat with an valid value
netedit.modifyAttribute(netedit.attrs.flowTAZ.inspect.arrivalPosLat, "4.2")
