...
# change departPosLat with an invalid value
netedit.modifyAttribute(netedit.attrs.flowTAZ.inspect.departPosLat, "-5", False)

# change departPosLat with an invalid value
netedit.modifyAttribute(netedit.attrs.flowTAZ.inspect.departPosLat, "5.6", False)
