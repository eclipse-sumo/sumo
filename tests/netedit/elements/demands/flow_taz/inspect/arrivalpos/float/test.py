...
netedit.modifyAttribute(netedit.attrs.flowTAZ.inspect.arrivalPos, "")

# change arrivalPos with an invalid value
netedit.modifyAttribute(netedit.attrs.flowTAZ.inspect.arrivalPos, "dummyPos")

# change departColor with a valid value
netedit.modifyAttribute(netedit.attrs.flowTAZ.inspect.arrivalPos, "500")

# change arrivalPos with an invalid value
netedit.modifyAttribute(netedit.attrs.flowTAZ.inspect.arrivalPos, "-10")

# change arrivalPos with a valid value
netedit.modifyAttribute(netedit.attrs.flowTAZ.inspect.arrivalPos, "15.5")
