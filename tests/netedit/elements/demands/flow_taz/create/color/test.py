...
# set invalid color
netedit.modifyAttribute(netedit.attrs.flowTAZ.create.color, "dummyColor")
...
# set valid color
netedit.modifyAttribute(netedit.attrs.flowTAZ.create.color, "cyan")

# press enter to create trip
netedit.typeKey("enter")

# set valid color
netedit.modifyAttribute(netedit.attrs.flowTAZ.create.color, "12,13,14")
