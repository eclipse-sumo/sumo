...
# set invalid depart
netedit.modifyAttribute(netedit.attrs.flowTAZ.create.begin, "-12")
...
netedit.modifyAttribute(netedit.attrs.flowTAZ.create.terminateOption, "42")

# press enter to create trip
netedit.typeKey("enter")

# set valid depart
netedit.modifyAttribute(netedit.attrs.flowTAZ.create.begin, "30")
...
netedit.modifyAttribute(netedit.attrs.flowTAZ.create.begin, "20.5")
