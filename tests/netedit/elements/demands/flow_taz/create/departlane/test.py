...
netedit.modifyAttribute(netedit.attrs.flowTAZ.create.departLane, "dummyLane")
...
# set invalid depart lane
netedit.modifyAttribute(netedit.attrs.flowTAZ.create.departLane, "-12")

# press enter to create trip
netedit.typeKey("enter")

# set valid depart lane
netedit.modifyAttribute(netedit.attrs.flowTAZ.create.departLane, "random")

# press enter to create trip
netedit.typeKey("enter")

# set valid depart lane
netedit.modifyAttribute(netedit.attrs.flowTAZ.create.departLane, "20")
