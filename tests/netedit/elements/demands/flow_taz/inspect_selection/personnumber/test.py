...
# change personNumber with an invalid value
netedit.modifyAttribute(netedit.attrs.flowTAZ.inspectSelection.personNumber, "dummyNumber", False)

# change personNumber with an invalid value
netedit.modifyAttribute(netedit.attrs.flowTAZ.inspectSelection.personNumber, "-5", False)

# change personNumber with an invalid value
netedit.modifyAttribute(netedit.attrs.flowTAZ.inspectSelection.personNumber, "2.5", False)
