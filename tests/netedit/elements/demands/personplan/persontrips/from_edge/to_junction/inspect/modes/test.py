...
netedit.modifyAttribute(netedit.attrs.personTrip.edge.junction.inspect.modes, "dummy", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.personTrip.edge.junction.inspect.modes, "", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.personTrip.edge.junction.inspect.modes, "car", False)
