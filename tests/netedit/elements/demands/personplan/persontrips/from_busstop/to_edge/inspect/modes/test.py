...
netedit.modifyAttribute(netedit.attrs.personTrip.busStop.edge.inspect.modes, "dummy", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.personTrip.busStop.edge.inspect.modes, "", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.personTrip.busStop.edge.inspect.modes, "car", False)
