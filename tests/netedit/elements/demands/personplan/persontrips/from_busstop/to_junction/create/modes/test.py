...
netedit.changeDefaultValue(netedit.attrs.personTrip.busStop.junction.create.modes, "dummy")

# press enter to create route
netedit.typeEnter()

# set invalid person number
netedit.changeDefaultValue(netedit.attrs.personTrip.busStop.junction.create.modes, "public")
