...
netedit.modifyAttribute(netedit.attrs.personTrip.busStop.junction.inspect.modes, "dummy", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.personTrip.busStop.junction.inspect.modes, "", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.personTrip.busStop.junction.inspect.modes, "car", False)
