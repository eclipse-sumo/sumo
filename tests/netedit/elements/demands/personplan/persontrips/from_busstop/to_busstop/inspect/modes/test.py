...
netedit.modifyAttribute(netedit.attrs.personTrip.busStop.busStop.inspect.modes, "dummy", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.personTrip.busStop.busStop.inspect.modes, "", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.personTrip.busStop.busStop.inspect.modes, "car", False)
