...
netedit.modifyAttribute(netedit.attrs.personTrip.junction.busStop.inspect.modes, "dummy", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.personTrip.junction.busStop.inspect.modes, "", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.personTrip.junction.busStop.inspect.modes, "car", False)
