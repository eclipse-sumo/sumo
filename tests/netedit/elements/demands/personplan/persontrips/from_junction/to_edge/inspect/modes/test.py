...
netedit.modifyAttribute(netedit.attrs.personTrip.junction.edge.inspect.modes, "dummy", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.personTrip.junction.edge.inspect.modes, "", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.personTrip.junction.edge.inspect.modes, "car", False)
