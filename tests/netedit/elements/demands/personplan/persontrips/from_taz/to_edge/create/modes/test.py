...
netedit.changeDefaultValue(netedit.attrs.personTrip.junction.edge.create.modes, "dummy")

# press enter to create route
netedit.typeEnter()

# set invalid person number
netedit.changeDefaultValue(netedit.attrs.personTrip.junction.edge.create.modes, "public")
