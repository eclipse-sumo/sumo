...
netedit.modifyAttribute(netedit.attrs.personTrip.junction.junction.inspect.modes, "dummy", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.personTrip.junction.junction.inspect.modes, "", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.personTrip.junction.junction.inspect.modes, "car", False)
