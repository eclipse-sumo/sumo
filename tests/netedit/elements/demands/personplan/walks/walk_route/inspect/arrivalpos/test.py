...
# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.walkRoute.inspect.arrivalPos, "", True)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.walkRoute.inspect.arrivalPos, "-6", True)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.walkRoute.inspect.arrivalPos, "2.5", True)
