...
netedit.modifyAttribute(netedit.attrs.ride.busStop.edge.inspect.arrivalPos, "dummy")

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.ride.busStop.edge.inspect.arrivalPos, "")

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.ride.busStop.edge.inspect.arrivalPos, "-6")

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.ride.busStop.edge.inspect.arrivalPos, "2.5")
