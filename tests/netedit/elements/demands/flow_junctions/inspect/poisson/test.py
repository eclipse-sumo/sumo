...
netedit.modifyAttribute(netedit.attrs.flowJunction.inspect.terminateOption, "36")

# change flow value
netedit.modifyAttribute(netedit.attrs.flowJunction.inspect.spacing, "dummyTerminate")

# change flow value
netedit.modifyAttribute(netedit.attrs.flowJunction.inspect.spacing, "poisson")
...
# change flow value
netedit.modifyAttribute(netedit.attrs.flowJunction.inspect.spacingOption, "2.6")
