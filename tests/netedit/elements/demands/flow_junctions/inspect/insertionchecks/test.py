...
netedit.modifyAttribute(netedit.attrs.flowJunction.inspect.insertionChecks, "dummy", False)

# change personNumber with an invalid value
netedit.modifyAttribute(netedit.attrs.flowJunction.inspect.insertionChecks, "leaderGap junction speedLimit pedestrian", False)
