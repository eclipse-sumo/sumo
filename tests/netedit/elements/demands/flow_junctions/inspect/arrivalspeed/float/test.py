...
netedit.modifyAttribute(netedit.attrs.flowJunction.inspect.arrivalPosLat, "-12")

# change arrivalPosLat with an valid value
netedit.modifyAttribute(netedit.attrs.flowJunction.inspect.arrivalPosLat, "4.2")
