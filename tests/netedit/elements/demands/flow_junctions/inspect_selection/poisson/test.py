...
# change flow value
netedit.modifyAttribute(netedit.attrs.flowJunction.inspectSelection.spacing, "poisson")
...
# change flow value
netedit.modifyAttribute(netedit.attrs.flowJunction.inspectSelection.spacingOption, "2.6")
