...
# change value
netedit.modifyAttribute(netedit.attrs.stopTrainStop.inspect.triggered, "container")

# change value
netedit.modifyAttribute(netedit.attrs.stopTrainStop.inspect.expected, "containerA containerB")
