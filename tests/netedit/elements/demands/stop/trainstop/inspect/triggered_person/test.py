...
# change value
netedit.modifyAttribute(netedit.attrs.stopTrainStop.inspect.triggered, "person", False)

# change value
netedit.modifyAttribute(netedit.attrs.stopTrainStop.inspect.expected, "personA personB", False)
