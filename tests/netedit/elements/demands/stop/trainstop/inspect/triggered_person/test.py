...
# change value
netedit.modifyAttribute(netedit.attrs.stopTrainStop.inspect.triggered, "person")

# change value
netedit.modifyAttribute(netedit.attrs.stopTrainStop.inspect.expected, "personA personB")
