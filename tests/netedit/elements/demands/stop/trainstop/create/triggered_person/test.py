...
# change triggered
netedit.modifyAttribute(netedit.attrs.stopTrainStop.create.triggered, "person")
...
# set valid value
netedit.modifyAttribute(netedit.attrs.stopTrainStop.create.expected, "personID1 personID2 personID3")
