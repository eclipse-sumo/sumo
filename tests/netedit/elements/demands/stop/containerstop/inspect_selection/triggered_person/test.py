...
# change value
netedit.modifyAttribute(netedit.attrs.stopContainerStop.inspectSelection.triggered, "person")

# change value
netedit.modifyAttribute(netedit.attrs.stopContainerStop.inspectSelection.expected, "personA personB")
