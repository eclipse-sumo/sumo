...
# set invalid value
netedit.modifyAttribute(netedit.attrs.stopContainerStop.create.permitted, ";;;;;;;;;;")
...
# set valid value
netedit.modifyAttribute(netedit.attrs.stopContainerStop.create.permitted, "ID1 ID2 ID3")
