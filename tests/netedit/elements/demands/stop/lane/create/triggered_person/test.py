...
# change triggered
netedit.modifyAttribute(netedit.attrs.stopLane.create.triggered, "person")
...
# set valid value
netedit.modifyAttribute(netedit.attrs.stopLane.create.expected, "personID1 personID2 personID3")
