...
# change value
netedit.modifyAttribute(netedit.attrs.stopLane.inspect.triggered, "person", True)

# change value
netedit.modifyAttribute(netedit.attrs.stopLane.inspect.expected, "personA personB", True)
