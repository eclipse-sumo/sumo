...
# change triggered
netedit.modifyAttribute(netedit.attrs.stopBusStop.create.triggered, "container")
...
# set valid value
netedit.modifyAttribute(netedit.attrs.stopBusStop.create.expected, "containerID1 containerID2 containerID3")
