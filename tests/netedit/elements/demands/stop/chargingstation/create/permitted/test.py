...
# set invalid value
netedit.modifyAttribute(netedit.attrs.stopChargingStation.create.permitted, ";;;;;;;;;;")
...
# set valid value
netedit.modifyAttribute(netedit.attrs.stopChargingStation.create.permitted, "ID1 ID2 ID3")
