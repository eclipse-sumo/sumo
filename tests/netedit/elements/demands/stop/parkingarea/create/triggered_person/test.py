...
# change triggered
netedit.modifyAttribute(netedit.attrs.stopParkingArea.create.triggered, "person")
...
# set valid value
netedit.modifyAttribute(netedit.attrs.stopParkingArea.create.expected, "personID1 personID2 personID3")
