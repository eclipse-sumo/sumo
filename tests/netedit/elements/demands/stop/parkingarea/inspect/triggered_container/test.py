...
# change value
netedit.modifyAttribute(netedit.attrs.stopParkingArea.inspect.triggered, "container")

# change value
netedit.modifyAttribute(netedit.attrs.stopParkingArea.inspect.expected, "containerA containerB")
