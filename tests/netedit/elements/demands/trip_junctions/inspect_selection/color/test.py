...
netedit.modifyColorAttribute(netedit.attrs.tripJunction.inspectSelection.colorButton)
...
netedit.modifyAttribute(netedit.attrs.tripJunction.inspectSelection.color, "12,13,14")
