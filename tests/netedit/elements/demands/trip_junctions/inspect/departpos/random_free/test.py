...
# change departLane with an invalid value
netedit.modifyAttribute(netedit.attrs.tripJunction.inspect.departPos, "500")

# change departLane with a valid value
netedit.modifyAttribute(netedit.attrs.tripJunction.inspect.departPos, "random_free")
