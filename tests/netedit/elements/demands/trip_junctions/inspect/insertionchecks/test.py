...
netedit.modifyAttribute(netedit.attrs.tripJunction.inspect.insertionChecks, "custom Line", False)

# change personNumber with an invalid value
netedit.modifyAttribute(netedit.attrs.tripJunction.inspect.insertionChecks, "leaderGap junction speedLimit pedestrian", False)
