...
netedit.modifyAttribute(netedit.attrs.tripJunction.inspect.arrivalPosLat, "", False)

# change arrivalPosLat with an invalid value
netedit.modifyAttribute(netedit.attrs.tripJunction.inspect.arrivalPosLat, "dummyPosLat", False)

# change arrivalPosLat with an invalid valid value
netedit.modifyAttribute(netedit.attrs.tripJunction.inspect.arrivalPosLat, "-12", False)

# change arrivalPosLat with an valid value
netedit.modifyAttribute(netedit.attrs.tripJunction.inspect.arrivalPosLat, "4.2", False)
