...
netedit.modifyAttribute(netedit.attrs.flowEmbedded.inspect.arrivalPos, "", False)

# change arrivalPos with an invalid value
netedit.modifyAttribute(netedit.attrs.flowEmbedded.inspect.arrivalPos, "dummyPos", False)

# change departColor with a valid value
netedit.modifyAttribute(netedit.attrs.flowEmbedded.inspect.arrivalPos, "500", False)

# change arrivalPos with an invalid value
netedit.modifyAttribute(netedit.attrs.flowEmbedded.inspect.arrivalPos, "-10", False)

# change arrivalPos with a valid value
netedit.modifyAttribute(netedit.attrs.flowEmbedded.inspect.arrivalPos, "15.5", False)
