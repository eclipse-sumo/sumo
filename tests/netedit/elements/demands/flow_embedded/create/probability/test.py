...
# set invalid arrival pos
netedit.modifyAttribute(netedit.attrs.flowEmbedded.create.spacing, "probability")
...
# set valid arrival pos
netedit.modifyAttribute(netedit.attrs.flowEmbedded.create.spacingOption, "0.6")
