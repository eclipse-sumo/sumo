...
# change flow value
netedit.modifyAttribute(netedit.attrs.containerFlow.inspect.spacing, "poisson", False)
...
# change flow value
netedit.modifyAttribute(netedit.attrs.containerFlow.inspect.spacingOption, "2.6", False)
