...
# change flow value
netedit.modifyAttribute(netedit.attrs.containerFlow.inspect.terminate, "number")
...
# change flow value
netedit.modifyAttribute(netedit.attrs.containerFlow.inspect.terminateOption, "26")
