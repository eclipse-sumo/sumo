...
netedit.modifyAttribute(netedit.attrs.containerFlow.inspect.departPos, "")

# change departLane with an invalid value
netedit.modifyAttribute(netedit.attrs.containerFlow.inspect.departPos, "dummyPos")

# change departLane with an invalid value
netedit.modifyAttribute(netedit.attrs.containerFlow.inspect.departPos, "500")

# change departLane with a valid value
netedit.modifyAttribute(netedit.attrs.containerFlow.inspect.departPos, "20")
