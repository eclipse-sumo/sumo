...
netedit.leftClick(referencePosition, netedit.positions.elements.demands.planTopRide.x, netedit.positions.elements.demands.planTopRide.y)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.rideEdgeEdge.inspect.arrivalPos, "dummy", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.rideEdgeEdge.inspect.arrivalPos, "", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.rideEdgeEdge.inspect.arrivalPos, "-6", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.rideEdgeEdge.inspect.arrivalPos, "2.5", False)
