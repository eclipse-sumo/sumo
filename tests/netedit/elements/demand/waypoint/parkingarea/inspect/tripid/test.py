...
# change value
netedit.modifyAttribute(netedit.attrs.waypointParking.inspect.tripID, ";;;;", False)

# change value
netedit.modifyAttribute(netedit.attrs.waypointParking.inspect.tripID, "", False)

# change value
netedit.modifyAttribute(netedit.attrs.waypointParking.inspect.tripID, "customTripID", False)
