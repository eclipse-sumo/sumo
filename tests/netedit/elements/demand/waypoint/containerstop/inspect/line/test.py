...
# change value
netedit.modifyAttribute(netedit.attrs.waypointContainerStop.inspect.line, ";;;", False)

# change value
netedit.modifyAttribute(netedit.attrs.waypointContainerStop.inspect.line, "", False)

# change value
netedit.modifyAttribute(netedit.attrs.waypointContainerStop.inspect.line, "customLine", False)
