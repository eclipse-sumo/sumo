...
# change value
netedit.modifyAttribute(netedit.attrs.stopTrainStop.inspect.split, ";;;;", False)

# change value
netedit.modifyAttribute(netedit.attrs.stopTrainStop.inspect.split, "", False)

# change value
netedit.modifyAttribute(netedit.attrs.stopTrainStop.inspect.split, "customSplit", False)
