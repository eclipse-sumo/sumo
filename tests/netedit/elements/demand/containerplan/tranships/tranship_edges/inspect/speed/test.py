...
netedit.modifyAttribute(netedit.attrs.transhipEdges.inspect.speed, "dummySpeed", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.transhipEdges.inspect.speed, "-7", False)

# change depart with an invalid value
netedit.modifyAttribute(netedit.attrs.transhipEdges.inspect.speed, "12.34", False)
