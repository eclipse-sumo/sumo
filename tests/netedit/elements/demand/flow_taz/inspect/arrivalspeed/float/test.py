...
# change arrivalPosLat with an invalid value
netedit.modifyAttribute(netedit.attrs.flowTAZ.inspect.arrivalPosLat, "dummyPosLat", False)

# change arrivalPosLat with an invalid valid value
netedit.modifyAttribute(netedit.attrs.flowTAZ.inspect.arrivalPosLat, "-12", False)
