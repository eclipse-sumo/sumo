...
# change flow value
netedit.modifyAttribute(netedit.attrs.flowTAZ.inspect.terminate, "number", False)
...
# change flow value
netedit.modifyAttribute(netedit.attrs.flowTAZ.inspect.terminateOption, "26", False)
