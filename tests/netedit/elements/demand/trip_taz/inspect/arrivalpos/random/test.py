...
netedit.modifyAttribute(netedit.attrs.tripTAZ.inspect.arrivalPos, "500", False)

# change arrivalPos with a valid value
netedit.modifyAttribute(netedit.attrs.tripTAZ.inspect.arrivalPos, "random", False)
