...
# change flow value
netedit.modifyAttribute(netedit.attrs.flowJunction.inspect.spacing, "poisson", False)
...
# change flow value
netedit.modifyAttribute(netedit.attrs.flowJunction.inspect.spacingOption, "2.6", False)
