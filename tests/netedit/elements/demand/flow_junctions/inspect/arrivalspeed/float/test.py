...
netedit.modifyAttribute(netedit.attrs.flowJunction.inspect.arrivalPosLat, "", False)

# change arrivalPosLat with an invalid value
netedit.modifyAttribute(netedit.attrs.flowJunction.inspect.arrivalPosLat, "dummyPosLat", False)

# change arrivalPosLat with an invalid valid value
netedit.modifyAttribute(netedit.attrs.flowJunction.inspect.arrivalPosLat, "-12", False)

# change arrivalPosLat with an valid value
netedit.modifyAttribute(netedit.attrs.flowJunction.inspect.arrivalPosLat, "4.2", False)
