...
# set invalid arrival pos
netedit.changeDefaultValue(netedit.attrs.flowJunction.create.spacing, "poisson")
...
# set valid arrival pos
netedit.changeDefaultValue(netedit.attrs.flowJunction.create.spacingOption, "2.5")
