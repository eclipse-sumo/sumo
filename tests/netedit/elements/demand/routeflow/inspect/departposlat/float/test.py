...
# change departPosLat with an invalid value
netedit.modifyAttribute(netedit.attrs.routeFlow.inspect.departPosLat, "-5", True)

# change departPosLat with an invalid value
netedit.modifyAttribute(netedit.attrs.routeFlow.inspect.departPosLat, "5.6", True)
