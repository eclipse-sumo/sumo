...
# change flow value
netedit.modifyAttribute(netedit.attrs.routeFlow.inspectSelection.spacing, "poisson", True)
...
# change flow value
netedit.modifyAttribute(netedit.attrs.routeFlow.inspectSelection.spacingOption, "2.6", True)
