...
netedit.modifyAttribute(netedit.attrs.jpsObstacle.inspect.id, "jps.obstacle_0")

# Change parameter 0 with a non valid value (empty)
netedit.modifyAttribute(netedit.attrs.jpsObstacle.inspect.id, "")

# Change parameter 0 with a non valid value (invalid)
netedit.modifyAttribute(netedit.attrs.jpsObstacle.inspect.id, "ID with spaces")

# Change parameter 0 with a valid value
netedit.modifyAttribute(netedit.attrs.jpsObstacle.inspect.id, "newID")
