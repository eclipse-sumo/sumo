...
netedit.modifyAttribute(netedit.attrs.jpsObstacle.inspectSelection.name, "%$$%%%%%")

# Change parameter 7 with a non valid value (non exist)
netedit.modifyAttribute(netedit.attrs.jpsObstacle.inspectSelection.name, "customName")
