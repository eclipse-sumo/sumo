...
netedit.modifyAttributeOverlapped(netedit.attrs.poiLane.inspect.width, "dummyWidth")

# Change parameter Width with a non valid value (negative)
netedit.modifyAttributeOverlapped(netedit.attrs.poiLane.inspect.width, "-2")

# Change parameter Width with a valid value
netedit.modifyAttributeOverlapped(netedit.attrs.poiLane.inspect.width, "5.5")
