...
print("calibrator: %s, period: %s - %s, setFlow: %s" %("cali_SN", traci.calibrator.getBegin("cali_SN"), traci.calibrator.getEnd("cali_SN"), traci.calibrator.getVehsPerHour("cali_SN")))
