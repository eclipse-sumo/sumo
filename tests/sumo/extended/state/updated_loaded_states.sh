...
cp save2/state2.sumo load_late_insertion/input_state.xml
cp save2/state2.sumo.meso load_late_insertion/input_meso_state.xml

cp save2/state2.sumo load_and_save/input_state.xml
cp save2/state2.sumo.meso load_and_save/input_meso_state.xml

cp save2/state2.sumo load_and_save_including_actionStepLength/input_state.xml
cp save2/state2.sumo.meso load_and_save_including_actionStepLength/input_meso_state.xml

cp save2/state2.sumo load_and_save_including_actionStepLength2/input_state.xml
cp save2/state2.sumo.meso load_and_save_including_actionStepLength2/input_meso_state.xml
