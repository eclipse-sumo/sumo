...
def parse_args():
    ...
    optParser.add_argument("tripinfos", category="input", type=ArgumentParser.file, help="Trip Info file")
    optParser.add_option("--length", action="store_true", required=False, type=float,
