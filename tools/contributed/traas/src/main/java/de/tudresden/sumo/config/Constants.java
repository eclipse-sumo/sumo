...
/// @date    2022-03-10 17:14:48.710468
///
...
public class Constants {
    ...
    public static final int CMD_SUBSCRIBE_FRICTIONCOEFFICIENT_CONTEXT = 0x0c;
    // response: subscribe FRICTIONCOEFFICIENT context
    public static final int RESPONSE_SUBSCRIBE_FRICTIONCOEFFICIENT_CONTEXT = 0x1c;
    // command: get FRICTIONCOEFFICIENT variable
    public static final int CMD_GET_FRICTIONCOEFFICIENT_VARIABLE = 0x2c;
    // response: get FRICTIONCOEFFICIENT variable
    public static final int RESPONSE_GET_FRICTIONCOEFFICIENT_VARIABLE = 0x3c;
    // command: set FRICTIONCOEFFICIENT variable
    public static final int CMD_SET_FRICTIONCOEFFICIENT_VARIABLE = 0x4c;
    // command: subscribe FRICTIONCOEFFICIENT variable
    public static final int CMD_SUBSCRIBE_FRICTIONCOEFFICIENT_VARIABLE = 0x5c;
    // response: subscribe FRICTIONCOEFFICIENT variable
    public static final int RESPONSE_SUBSCRIBE_FRICTIONCOEFFICIENT_VARIABLE = 0x6c;
    ...
    public static final int VAR_FRICTION = 0x38;
