...
def edgedijkstra_forward(id_edge_start, cost_limit,
                         ids_edge_target=None, weights= None, fstar = None
                         ):
    """
    Calculates minimum cost tree and minimum route costs from 
    id_edge_start forward to all edges of the network or to 
    target edges given in set ids_edge_target.
    
    """
    ids_target = set(ids_edge_target.copy())
    #print 'edgedijkstra'
    # dictionary of final distances
    D = {}
...
class MaRouter(CmlMixin,Process):
    def __init__(self, scenario, 
        ...
        self.add_option('assignmentmethod', kwargs.get('assignmentmethod','incremental'),
                        ...
                        choices = {'Incremental all or nothing':'incremental','User equilibrium (not yet implemented)':'UE','Stochastic Use equilibrium': 'SUE'},
