...
class NetConvertMixin(CmlMixin,Process):
    ...
    def init_options_edgetype(self, **kwargs):
        ...
        modesset_pt_rail = set(["rail_urban","rail","rail_electric","rail_fast","subway"]) 
        ...
        roadtypes_to_disallowed_vtypes = {"roads for individual transport" : ','.join(modesset.difference(["passenger",])),
                            ...
                            "rails only": ','.join(modesset.difference(modesset_pt_rail)) ,
                            "rails only v1.12": 'army,pedestrian,tram,vip,evehicle,authority,passenger,ignoring,bus,moped,ship,emergency,taxi,private,delivery,bicycle,custom1,coach,truck,custom2,motorcycle',
        ...
        print ('  roadtypes_to_disallowed_vtypes=',roadtypes_to_disallowed_vtypes)
...
class TlSignalGenerator(NetConvertMixin):
    ...
    def do(self):
        ...
        filepath_edges,filepath_nodes,filepath_connections,filepath_tlss = net.export_painxml(filepath = filepath, is_export_tlss = False)
