...
class WxGui(ModuleGui):
    ...
    def init_widgets(self, mainframe):
        ...
        if self._scenario is None:
            ...
            rootname =  'myscenario'
            dirpath = scenario.DIRPATH_SCENARIO #None# this means no directory will be created os.path.join(os.path.expanduser("~"),'hybridPY','myscenario')
    ...
    def make_toolbar(self):     
        tsize = self._mainframe.get_size_toolbaricons()
        if 1:
            ...
            self._mainframe.add_tool('new',self.on_create,new_bmp,name = 'Create new scenario',info = 'Create new scenario ...') 
            self._mainframe.add_tool('open',self.on_open,open_bmp,name = 'Open scenario',info = 'Open scenario ...') 
            self._mainframe.add_tool('save',self.on_save,save_bmp,name = 'Save scenario',info = 'Save scenario.')
            self._mainframe.add_tool('save_as',self.on_save_as,saveas_bmp,name = 'Save scenario as',info = 'Save scenario as ...')
            self._mainframe.toolbar.AddSeparator()
    ...
    def make_menu(self):
        ...
        self._mainframe.Bind(wx.EVT_CLOSE, self.on_close)
        ...
        menubar.append_item( 'Scenario/save',
        ...
        menubar.append_item( 'Scenario/save as...',
            self.on_save_as, 
        ...
        menubar.append_item('Scenario/quit...',
            self.on_close,\
            info='Quit hybridPY',shortkey='Ctrl+Q',
