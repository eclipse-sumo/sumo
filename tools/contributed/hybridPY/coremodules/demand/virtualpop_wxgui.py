...
# import bitjoin activity based demand generation module
from . import bitjoin_wxgui

from agilepy.lib_wx.processdialog import ProcessDialog, ProcessDialogInteractive
                                    
class VirtualpopWxGuiMixin(bitjoin_wxgui.BitjoinWxGuiMixin):
    """Contains Virtualpopulation specific functions that communicate between the widgets of the main wx gui
    ...
    def add_menu_virtualpop(self, menubar):
        rootmenu = 'demand/virtual population'
        menubar.append_menu( rootmenu,
                            bitmap = self.get_icon("icon_virtualpopulation.jpg")
                            )  
                            
        # insert menus of activity based demand generator
        self.add_menu_bitjoin(menubar,rootmenu)
        
        menubar.append_menu( rootmenu + '/configure population',
            )
                            
        menubar.append_item( rootmenu + '/configure population/generate...',
            self.on_generate, 
            )
            
        menubar.append_item( rootmenu + '/configure population/create from zone-to-zone flows...',
            self.on_create_pop_from_odflows, 
            )
            
        menubar.append_item( rootmenu + '/configure population/complete daily activities...',
            self.on_complete_daily_activities, 
            ) 
            
        menubar.append_item( rootmenu + '/configure population/scale population...',
            self.on_scale_population, 
            )
        
        menubar.append_menu( rootmenu + '/configure vehicles',
                            #bitmap = self.get_icon("icon_virtualpopulation.jpg")
                            )
                            
        menubar.append_item( rootmenu + '/configure vehicles/provide vehicles...',
            self.on_provide_vehicles, 
            )
        
        menubar.append_item( rootmenu + '/configure vehicles/clear individual vehicles',
            self.on_clear_ivehicles, 
            bitmap = wx.ArtProvider.GetBitmap(wx.ART_DELETE,wx.ART_MENU),
            )
              
                  
        menubar.append_menu( rootmenu + '/plans',
                            #bitmap = self.get_icon("icon_virtualpopulation.jpg")
                            )
        
        
        menubar.append_item( rootmenu + '/plans/generate...',
        ...
        menubar.append_item( rootmenu + '/plans/select current plans...',
        ...
        menubar.append_item( rootmenu + '/plans/reroute current plans...',
            self.on_dua_reroute, 
            bitmap = self.get_icon("route3_24px.png"),
            ) 
        
        
        menubar.append_item( rootmenu + '/plans/import plans from route file...',
            self.on_import_plans, 
            bitmap = self.get_agileicon("Document_Import_24px.png"),
            )
                         
        menubar.append_item( rootmenu + '/plans/clear plans',
            self.on_clear_plans, 
            bitmap = wx.ArtProvider.GetBitmap(wx.ART_DELETE,wx.ART_MENU),
            )
        ...
        #menubar.append_item( rootmenu + '/plans/export plans to SUMO xml...',
        ...
        menubar.append_item( rootmenu + '/clear polulation, plans, vehicles and activities',
            self.on_clear_pop, 
            bitmap = wx.ArtProvider.GetBitmap(wx.ART_DELETE,wx.ART_MENU),
            )
        
        menubar.append_menu( rootmenu + '/analysis',
        ...
        if is_mpl:
            ...
            menubar.append_item( rootmenu + '/analysis/plot activities...',
                self.on_plot_activities, 
                bitmap = results_mpl.get_mplicon(),#,
                )
            
            menubar.append_item( rootmenu + '/analysis/plot strategy data...',
                self.on_plot_strategies, 
                bitmap = results_mpl.get_mplicon(),#,
                )
            
            menubar.append_item( rootmenu + '/analysis/load iteration results...',
                self.on_open_iterationresults, 
                bitmap = self.get_agileicon("Document_Import_24px.png"),
                )
                
            menubar.append_item( rootmenu + '/analysis/plot iteration results...',
    ...
    def on_scale_population(self, event=None):
        """Scale number of persons in population.
        """
        obj = virtualpop.PopulationScaler(    self._demand.virtualpop, 
