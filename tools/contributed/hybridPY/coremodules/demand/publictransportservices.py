            ...
            if len(ids_stop) >= 2:
                ...
                if ids_edge is not None:
                    if len(ids_edge)>0:
                        ...
                        print ('  check line',id_line,'stop',ids_stop[0],'stopedge',id_stopedge,net.edges.ids_sumo[id_stopedge],'in',id_stopedge not in ids_edge)
                        ...
                        print ('  check line',id_line,'stop',ids_stop[-1],'stopedge',id_stopedge,net.edges.ids_sumo[id_stopedge],'in',id_stopedge not in ids_edge)
                        if id_stopedge not in ids_edge:
...
class PtLinefilter(Process):
    ...
    def do(self):
        ...
        for id_line, linename, ids_stop ,period  in zip(    ids_line, 
            ...
            print('  filter id_line',id_line,linename,'len(ids_stop)',len(ids_stop),'period',period,self.period_max,'too long?',period > self.period_max,'n_remove',len(ids_remove))
