...
"""
hybridPY_traci is a script to open and run a hybridPY scenario with traci API

Usage: python hybridPY_traci.py scenario.obj
...
microsim = sumo.SumoTraci(myscenario,
                          ...
                          #
                          is_edgedata=True,
                          is_result_evolution=False,
                          time_interval_evolution=900,
                          is_tripdata=True,
                          is_edgenoise=False,
                          is_edgesemissions=False,
