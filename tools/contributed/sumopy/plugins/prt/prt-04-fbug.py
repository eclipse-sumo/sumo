...
class PrtStops(am.ArrayObjman):
                ...
                if np.all(berths.states[ids_berth_alight] == BERTHSTATES['free']):
                    ...
                    for id_veh in self.ids_vehs_toallocate[id_prtstop]:
                        ...
                        if id_berth < 0:
                            ...
                            # ,berths.stoppositions[id_berth]
                            print '     send waiting vehicle id_veh %d to id_berth_alight %d' % (id_veh, id_berth)
    ...
    def enter(self, id_stop, id_veh):
        ...
        if id_berth < 0:
            ...
            # command vehicle to go to berth for alighting
            # ,self.get_berths().stoppositions[id_berth]
            print '     send entering vehicle id_veh %d to id_berth_alight %d' % (id_veh, id_berth)
