...
class PrtStops(am.ArrayObjman):
    ...
    def get_waitpositions(self, ids, is_alight=False, offset=-0.5):
        """
    ...
    def process_step(self, process):
        ...
        for id_prtstop, id_edge_sumo, ids_veh_sumo_prev in\
            ...
            for id_berth_board, id_veh in zip(
                ...
                if id_veh >= 0:  # is there a waiting vehicle
                    if vehicles.is_completed_boarding(id_veh):
                        ...
                        berths.states[id_berth_board] = BERTHSTATES['waiting']
            ...
            # foreward if all berth are waiting with occupied vehicles
            if np.all(berths.states[ids_berth_board] == BERTHSTATES['waiting']):
                # print '    foreward all occupied id_prtstop,ids_berth_board',id_prtstop,ids_berth_board
                self.foreward_boardzone(ids_berth_board)
    ...
    def foreward_boardzone(self, ids_berth_board):
        print 'foreward_boardzone', ids_berth_board
