...
class PrtStops(am.ArrayObjman):
    ...
    def prepare_sim(self, process):
        ...
        # vehicle management
        self.numbers_veh_arr = np.zeros(np.max(ids)+1, dtype=np.int32)
        ...
        for id_stop, id_edge_sumo, ids_veh_sumo_prev, ids_person_sumo_prev in\
            ...
            if ids_person_sumo_prev != ids_person_sumo:
                ...
                for id_person_sumo in ids_person_sumo_entered:
                    if self.id_person_to_ids_edge_sumo_dests.has_key(id_person_sumo):
                        id_edge_sumo_dests = self.id_person_to_ids_edge_sumo_dests[id_person_sumo]
                        ...
                        if len(id_edge_sumo_dests) > 0:
                            ...
                            if id_edge_sumo_dests[0][0] == id_edge_sumo:
    ...
    def schedule_trip_occupied(self, id_stop, id_berth, id_veh, simtime):
        ...
        if id_person_sumo_inveh is not None:
            ...
            id_edge_sumo_from, id_edge_sumo_to = self.id_person_to_ids_edge_sumo_dests[id_person_sumo_inveh].pop(0)
    ...
    def plan_emptytrip(self, id_stop):
        ...
        costs = (self.numbers_person_wait[ids_stop]-self.numbers_veh[ids_stop] -
