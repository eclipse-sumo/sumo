...
# @file    mapmatching-13-prespeedchange.py
...
class Edgesresults(am.ArrayObjman):
    ...
    def _init_attributes(self):
        ...
        self.add_col(am.ListArrayConf('pointsspeeds',
                                      ...
                                      name='Point speeds',
                                      unit='m/s',
                                      info='List of velocities associated with each GPS point on this edge.',
                                      ))
        ...
        self.add_col(am.ListArrayConf('pointspositions',
                                      ...
                                      unit='m',
                                      info='List of point positions associated with each GPS point on this edge.',
                                      ))
        self.add_col(am.ArrayConf('times_wait', default=0.0,
                                  ...
                                  name='wait time',
                                  unit='s',
                                  info='Wait times or times of low speed on this edge.',
                                  ))
        ...
        self.add_col(am.ArrayConf('times_wait_junc', default=0.0,
                                  ...
                                  unit='s',
                                  info='Wait times or times of low speed at junction at the end of this edge.',
                                  ))
        ...
        self.add_col(am.ArrayConf('times_wait_tls', default=0.0,
                                  ...
                                  unit='s',
                                  info='Wait times or times of low speed at traffic light systems on this edge.',
                                  ))
...
class Routesanalyzer(Process):
    ...
    def do(self):
            ...
            if n_matched > 1:
                ...
                for id_point, time, coord, location, dist, deltatime, speed in zip(ids_points, times, coords, loctions, dists, deltatimes, speeds):
                    ...
                    if is_begin:
                        ...
                        edgesresults.pointspositions[id_edgeres_current].append(pos)
                        edgesresults.pointsspeeds[id_edgeres_current].append(speed)
                        ...
                        if speed < self.waitspeed:
                            ...
                            if pos < self.junctionrange:
                                # halt is at initial part of an edge
                                ...
                                # halt is at the end of current edge
                    ...
                    while is_cont:
                        ...
                        print '        id_point =%d, id_startpoint%d ind_matched=%d,n_matched=%d' % (id_point, ids_points_ee[ind_matched], ind_matched, n_matched), is_cont
                        if is_cont:
                            ...
                            if ind_matched < n_matched:
                                ...
                                edgesresults.pointspositions[id_edgeres_current] = []
                                edgesresults.pointsspeeds[id_edgeres_current] = []
                                ind_matched += 1
                                ...
                                # update spped average for last visited edge
                                v_av = (location - location_speedaverage)/(time - time_speedaverage)
                                edgesresults.speeds_average[id_edgeres_current] += v_av
                                v_inmotion = np.clip((location - location_speedaverage) /
                                                     (time - time_speedaverage-time_wait), 0, self.edgespeed_max)
        ...
        print '  edgesresults.pointspositions', edgesresults.pointspositions[ids_valid]
        print '  edgesresults.pointsspeeds', edgesresults.pointsspeeds[ids_valid]
