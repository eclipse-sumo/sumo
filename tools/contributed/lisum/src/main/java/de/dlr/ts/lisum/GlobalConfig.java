...
public final class GlobalConfig
{
    ...
    private void updateLisaServerParameters()
    {
        ...
        try
        {
            ...
            //DLRLogger.config(this, "Setting Lisa Server: Address=" + lisaServerAddress + " | Port=" + lisaServerPort);
        }
    ...
    private void setPersistenceFile()
    {
        ...
        //persistenceFile = new File(PERSISTENCE_FILE);
    }
     ...
     * @return 
     */
    public String getLisaRestFulServerDir()
    {
