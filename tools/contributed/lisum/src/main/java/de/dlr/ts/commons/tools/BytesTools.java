...
public class BytesTools
{
    ...
    {
        /*
        short culo = bytesToShort(new byte[]{1, 0});        
        System.out.println(culo);
        System.out.println(swapEndianness(culo));
        
        int culo2 = bytesToInt(new byte[]{0, 0, 1, 0});
        System.out.println(culo2);
        System.out.println(swapEndianness(culo2));
        */
        
        //long culo3 = bytesToInt(new byte[]{0, 0, 0, 0, 0, 0, 0, 1});
        int culo3 = 1;
        System.out.println(Arrays.toString(getBytes(culo3)));
        System.out.println(culo3);
        
        int changeEndianness = BytesTools.swapEndianness(culo3);
        System.out.println(changeEndianness);
        
        byte[] bytes = getBytes(changeEndianness);
