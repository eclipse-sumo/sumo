...
{
    private static int lisaServerPort = GlobalConfig.getInstance().getLisaServerPort();
    private static String lisaServerAddress = GlobalConfig.getInstance().getLisaServerAddress();
    ...
    LisaCommands()
    {
        String a = System.getProperties().getProperty("lisa.serverPort");
        if(a != null)
            lisaServerPort = Integer.valueOf(a);
        
        String b = System.getProperties().getProperty("lisa.serverAddress");
        if(b != null)
            lisaServerAddress = b;
    }
