...
/**
    ...
    private void lisaTab()
    {
        ...
        lisaServerFileChooser.getTextField().setText(GlobalConfig.getInstance().getLisaRestFulServerDir());
        ...
        {
            String lisaRestFulServerDir = GlobalConfig.getInstance().getLisaRestFulServerDir();
