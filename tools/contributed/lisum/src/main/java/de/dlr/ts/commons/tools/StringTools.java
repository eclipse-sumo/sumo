...
public class StringTools
{
    ...
    {
        //System.out.println("-" + centerText("1234", 20) + "-");
        
        System.out.println(centerAndFillWithChar("text", '#', 20));
        System.out.println(alignLeftAndFillWithChar("Cacho", '!', 50));
        System.out.println(alignRightAndFillWithChar("Cacho", 'g', 50));
        
        System.out.println(alignLeft("Text", 20, "#"));
        
        System.out.println(centerText("text", 20, "w"));
    }
