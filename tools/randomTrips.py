...
def get_options(args=None):
    ...
    op.add_argument("--edge-param",
        category="processing",
        dest="edgeParam",
        help="use the given edge parameter as factor for edge")
    op.add_argument("--speed-exponent",
        category="processing",
        type=float,
        dest="speed_exponent",
        metavar="FLOAT",
    ...
    op.add_argument("--fringe-speed-exponent",
        category="processing",
        type=float,
    ...
    op.add_argument("--allow-fringe.min-length",
        category="processing",
        type=float,
    ...
    op.add_argument("--min-distance.fringe",
        category="processing",
        type=float,
        dest="min_dist_fringe",
        metavar="FLOAT",
        help="require start and end edges for each fringe to fringe trip to be at least 'FLOAT' m apart")
    op.add_argument("--max-distance",
        category="processing",
        type=float,
        dest="max_distance",
        metavar="FLOAT",
        help="require start and end edges for each trip to be at most 'FLOAT' m apart (default 0 which disables any checks)")
    op.add_argument("-i", "--intermediate",
        category="processing",
        type=int,
        default=0,
        help="generates the given number of intermediate way points")
    op.add_argument("--flows",
        category="processing",
        type=int,
        default=0,
    ...
    op.add_argument("--vclass", "--edge-permission",
        category="processing",
        default="passenger",
    ...
    op.add_argument("--via-edge-types",
        category="processing",
        dest="viaEdgeTypes",
    ...
    group.add_argument("--insertion-rate",
        dest="insertionRate",
        type=str,
        nargs="+",
        metavar="FLOAT",
    ...
    group.add_argument("--insertion-density",
