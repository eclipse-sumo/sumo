...
optParser.add_argument("--wikidata", category="processing", help="give the wikidata file name", default="osm.wikidata.xml", metavar="FILE")
...
optParser.add_argument("--duration", category="processing", type=float, default=2, help="Set evacuation duration in hour")
optParser.add_argument("--evacuate-areas", category="processing", help="the names of the evacuated areas, separated by comma," +
...
optParser.add_argument("--dest-areas", category="processing", help="the names of the destination areas, separated by comma," +
...
optParser.add_argument("--debug", category="processing", action="store_true", default=False, help="print out information for debugging")
optParser.add_argument("--verbose", category="processing", action="store_true", default=False, help="print out more information")
