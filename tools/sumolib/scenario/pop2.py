...
RWS = [
    [ 1, 0.5104, 0.5828, 0.5772, 0.6332, 0.748,  2.8719, 1.7177],  # noqa
    [ 2, 0.3432, 0.3078, 0.3675, 0.336,  0.4566, 1.9838, 1.0125],  # noqa
    [ 3, 0.2107, 0.2523, 0.2086, 0.2895, 0.2517, 1.3241, 0.8154],  # noqa
    [ 4, 0.3703, 0.1997, 0.3053, 0.2064, 0.3579, 0.9965, 0.4875],  # noqa
    [ 5, 0.9379, 0.4054, 0.5936, 0.457,  0.6685, 0.6633, 0.6375],  # noqa
    [ 6, 2.5954, 1.3955, 1.9009, 1.5343, 2.2885, 0.9947, 1.2423],  # noqa
    [ 7, 6.6675, 2.9516, 4.9363, 3.5946, 5.1519, 1.0119, 1.5891],  # noqa
    [ 8, 8.9356, 5.3546, 7.2095, 4.5774, 7.6271, 1.4289, 2.7169],  # noqa
    [ 9, 8.1931, 6.0357, 6.9139, 5.2376, 6.8091, 2.4236, 3.8612],  # noqa
