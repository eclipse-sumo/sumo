...
CMD_SUBSCRIBE_FRICTIONCOEFFICIENT_CONTEXT = 0x0c
#  response: subscribe FRICTIONCOEFFICIENT context
RESPONSE_SUBSCRIBE_FRICTIONCOEFFICIENT_CONTEXT = 0x1c
#  command: get FRICTIONCOEFFICIENT variable
CMD_GET_FRICTIONCOEFFICIENT_VARIABLE = 0x2c
#  response: get FRICTIONCOEFFICIENT variable
RESPONSE_GET_FRICTIONCOEFFICIENT_VARIABLE = 0x3c
#  command: set FRICTIONCOEFFICIENT variable
CMD_SET_FRICTIONCOEFFICIENT_VARIABLE = 0x4c
#  command: subscribe FRICTIONCOEFFICIENT variable
CMD_SUBSCRIBE_FRICTIONCOEFFICIENT_VARIABLE = 0x5c
#  response: subscribe FRICTIONCOEFFICIENT variable
RESPONSE_SUBSCRIBE_FRICTIONCOEFFICIENT_VARIABLE = 0x6c
