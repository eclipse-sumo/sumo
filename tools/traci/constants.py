...
# @date    2018-08-08 13:16:59.117000
# @version $Id$
...
# @brief The vehicle does not have enough space to complete a continuous lane and change before
# the next turning movement
LCA_INSUFFICIENT_SPACE = 1 << 14
# @brief used by the sublane model
LCA_SUBLANE = 1 << 15
# @brief Vehicle is too slow to guarantee success of lane change (used for continuous lane changing
# in case that maxSpeedLatStanding==0)
