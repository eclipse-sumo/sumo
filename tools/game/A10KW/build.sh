...
export COMMON_OPTS="-n osm.net.xml --seed 42 -e 3600 --fringe-factor 1000 --fringe-threshold 0 --min-distance 300 --validate"
export TRIPATTRS='speedDev="0.1" departLane="best" departSpeed="max" departPos="last" sigma="0.8"'
export TRIPATTRS_MW='speedDev="0.1" departLane="random" departSpeed="max" departPos="last" sigma="0.8"'
...
export M="_mw"
$CMD $COMMON_OPTS -p  0.5 -L --speed-exponent 100  -r osm.passenger$M.rou.xml -o osm.passenger$M.trips.xml --vehicle-class passenger --vclass passenger --prefix veh$M   --trip-attributes "$TRIPATTRS_MW" --weights-output-prefix weights_mw
$CMD $COMMON_OPTS -p 3 -L --speed-exponent 100  -r osm.truck$M.rou.xml     -o osm.truck$M.trips.xml     --vehicle-class truck     --vclass truck     --prefix truck$M --trip-attributes "$TRIPATTRS_MW"
