...
$SUMO_HOME/tools/game/DRT/randomRides.py -n osm.net.xml -a drtstops.xml -o rides_demo.xml --poi-output drt.pois.xml --prefix d -b 0 -e 20000 -p 200  --poi-offset 32 --initial-duration 3
