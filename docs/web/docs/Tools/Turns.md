...
!!! caution
    Turning ratios must be combined with some other counting data to define to absolute level of traffic. This can be any of the other counting data formats or by setting option **--total-count**.
