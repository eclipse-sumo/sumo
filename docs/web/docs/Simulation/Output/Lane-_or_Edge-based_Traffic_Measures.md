...
| speedThresholdRelative | float                  | The maximum relative speed (vehSpeed / speedLimit) to consider a vehicle halting; *default 0*. <br>**Note:** When this is set, waitingTime may be larger than timeLoss |
