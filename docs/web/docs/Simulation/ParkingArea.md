...
| departPos        | float |              | undefined | When set to a value between [0, laneLength], the vehicle will exit the parkingArea at that location instead of the location where it stopped |
