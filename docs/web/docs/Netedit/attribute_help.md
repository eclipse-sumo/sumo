...
|speed|positive float|The maximum speed allowed on the edge in m/s *default:* **13.89**|
|priority|integer|The priority of the edge *default:* **-1**|
|numLanes|positive integer|The number of lanes of the edge *default:* **1**|
|type|string|The name of a type within the SUMO edge type file|
|allow|list of vclasses VClasses|Explicitly allows the given vehicle classes (not given will be not allowed) *default:* **all**|
|disallow|list of vclasses VClasses|Explicitly disallows the given vehicle classes (not given will be allowed)|
...
|length|positive float|The length of the edge in meter|
...
|width|positive float|Lane width for all lanes of this edge in meters (used for visualization) *default:* **-1**|
|endOffset|positive float|Move the stop line back from the intersection by the given amount *default:* **0.00**|
...
|stopOffset|positive float|The stop offset as positive value in meters *default:* **0.00**|
|stopOException|list of discrete vclasses VClasses|Specifies, for which vehicle classes the stopOffset does NOT apply.|
...
|speed|positive float|Speed in meters per second *default:* **13.89**|
|allow|list of vclasses VClasses|Explicitly allows the given vehicle classes (not given will be not allowed) *default:* **all**|
|disallow|list of vclasses VClasses|Explicitly disallows the given vehicle classes (not given will be allowed)|
|width|positive float|Width in meters (used for visualization) *default:* **-1**|
|endOffset|positive float|Move the stop line back from the intersection by the given amount *default:* **0.00**|
...
|changeLeft|list of discrete vclasses VClasses|Permit changing left only for to the given vehicle classes *default:* **all**|
|changeRight|list of discrete vclasses VClasses|Permit changing right only for to the given vehicle classes *default:* **all**|
...
|lineWidth|positive float|The default line width for drawing an unfilled polygon *default:* **1**|
...
|width|positive float|Width of rendered image in meters *default:* **1.00**|
|height|positive float|Height of rendered image in meters *default:* **1.00**|
...
|lon|unique float|The longitud position of the parking vehicle on the view|
|lat|unique float|The latitud position of the parking vehicle on the view|
...
|personCapacity|positive integer|Larger numbers of persons trying to enter will create an upstream jam on the sidewalk *default:* **6**|
...
|length|positive float|The walking length of the access in meters *default:* **-1.00**|
|friendlyPos|boolean|If set, no error will be reported if element is placed behind the lane. Instead, it will be placed 0.1 meters from the lanes end or at position 0.1, if the position was negative and larger than the lanes length after multiplication with - 1 *default:* **0**|
...
|containerCapacity|positive integer|Larger numbers of container trying to enter will create an upstream jam on the sidewalk *default:* **6**|
|parkingLength|float|Optional space definition for vehicles that park at this stop *default:* **0.00**|
...
|friendlyPos|boolean|If set, no error will be reported if element is placed behind the lane. Instead, it will be placed 0.1 meters from the lanes end or at position 0.1, if the position was negative and larger than the lanes length after multiplication with - 1 *default:* **0**|
|power|positive float|Charging power in W *default:* **22000.00**|
...
|roadsideCapacity|positive integer| The number of parking spaces for road-side parking *default:* **0**|
|onRoad|boolean|If set, vehicles will park on the road lane and thereby reducing capacity *default:* **0**|
|friendlyPos|boolean|If set, no error will be reported if element is placed behind the lane. Instead, it will be placed 0.1 meters from the lanes end or at position 0.1, if the position was negative and larger than the lanes length after multiplication with - 1 *default:* **0**|
|width|positive float|The width of the road-side parking spaces *default:* **3.20**|
|length|positive float|The length of the road-side parking spaces. By default (endPos - startPos) / roadsideCapacity *default:* **0.00**|
...
|length|positive float|The length of the detector in meters *default:* **10.00**|
|period|SUMOTime|The aggregation period the values the detector collects shall be summed up *default:* **300.00**|
...
|speedThreshold|positive float|The speed-based threshold that describes how slow a vehicle has to be to be recognized as halting) in m/s *default:* **1.39**|
|jamThreshold|positive float|The minimum distance to the next standing vehicle in order to make this vehicle count as a participant to the jam) in m *default:* **10.00**|
|friendlyPos|boolean|If set, no error will be reported if element is placed behind the lane. Instead, it will be placed 0.1 meters from the lanes end or at position 0.1, if the position was negative and larger than the lanes length after multiplication with - 1 *default:* **0**|
...
|maxTraveltime|SUMOTime|The maximum traveltime in seconds to write if only very small movements occur *default:* **100000**|
...
|pos|positive float|The position of the calibrator on the specified lane *default:* **0.00**|
...
|jamThreshold|positive float|A threshold value to detect and clear unexpected jamming *default:* **0.50**|
...
|-----------|------|-------------|
|edge|unique string|Edge ID|
|allow|list of vclasses VClasses|allowed vehicles|
...
|pos|unique position|X-Y position of detector in editor (Only used in netedit) *default:* **0,0**|
|voltage|positive float|Voltage of at connection point for the overhead wire *default:* **600**|
|currentLimit|positive float|Current limit of the feeder line *default:* **400**|
...
|from|unique string|The name of the edge the trip starts at|
|to|unique string|The name of the edge the trip ends at|
...
|personNumber|positive integer|The number of occupied seats when the vehicle is inserted *default:* **0**|
|containerNumber|positive integer|The number of occupied container places when the vehicle is inserted *default:* **0**|
...
| Attribute | Type | Description |
|-----------|------|-------------|
|id|unique string|The id of vehicle|
...
|length|positive float|The vehicle's netto-length (length) [m]|
|minGap|positive float|Empty space after leader [m]|
|maxSpeed|positive float|The vehicle's maximum velocity [m/s]|
|speedFactor|string|The vehicles expected multiplicator for lane speed limits (or a distribution specifier)|
|desiredMaxSpeed|positive float|The vehicles desired maximum velocity (interacts with speedFactor). Applicable when no speed Limit applies (bicycles, some motorways) [m/s]|
|emissionClass|discrete string|An abstract emission class|
|guiShape|discrete string|How this vehicle is rendered|
|width|positive float|The vehicle's width [m] (only used for drawing) *default:* **1.8**|
|height|positive float|The vehicle's height [m] (only used for drawing) *default:* **1.5**|
...
|personCapacity|positive integer|The number of persons (excluding an autonomous driver) the vehicle can transport|
|containerCapacity|positive integer|The number of containers the vehicle can transport|
...
|minGapLat|positive float|The minimum lateral gap at a speed difference of 50km/h when using the sublane-model *default:* **0.12**|
|maxSpeedLat|positive float|The maximum lateral speed when using the sublane-model *default:* **1.00**|
|actionStepLength|positive float|The interval length for which vehicle performs its decision logic (acceleration and lane-changing) *default:* **0.00**|
|probability|positive float|The probability when being added to a distribution without an explicit probability *default:* **1.00**|
|osgFile|string|3D model file for this class|
|carriageLength|positive float|Carriage lengths|
|locomotiveLength|positive float|Locomotive lengths|
|carriageGap|positive float|GAP between carriages *default:* **1**|
|accel|positive float|The acceleration ability of vehicles of this type [m/s^2] *default:* **2.60**|
|decel|positive float|The deceleration ability of vehicles of this type [m/s^2] *default:* **4.50**|
|apparentDecel|positive float|The apparent deceleration of the vehicle as used by the standard model [m/s^2] *default:* **4.50**|
|emergencyDecel|positive float|The maximal physically possible deceleration for the vehicle [m/s^2] *default:* **4.50**|
|sigma|float|Car-following model parameter *default:* **0.50**|
|tau|positive float|Car-following model parameter *default:* **1.00**|
...
|tpreview|positive float|EIDM Look ahead / preview parameter [s] *default:* **4.00**|
|treaction|positive float|EIDM AP Reaction Time parameter [s] *default:* **0.50**|
|tPersDrive|positive float|EIDM Wiener Process parameter for the Driving Error [s] *default:* **3.00**|
|tPersEstimate|positive float|EIDM Wiener Process parameter for the Estimation Error [s] *default:* **10.00**|
|ccoolness|float|EIDM Coolness parameter of the Enhanced IDM [-] *default:* **0.99**|
|sigmaleader|positive float|EIDM leader speed estimation error parameter [-] *default:* **0.02**|
|sigmagap|positive float|EIDM gap estimation error parameter [-] *default:* **0.10**|
|sigmaerror|positive float|EIDM driving error parameter [-] *default:* **0.04**|
|jerkmax|positive float|EIDM maximal jerk parameter [m/s^3] *default:* **3.00**|
|epsilonacc|positive float|EIDM maximal negative acceleration between two Action Points (threshold) [m/s^2] *default:* **1.00**|
|taccmax|positive float|EIDM Time parameter until vehicle reaches amax after startup/driveoff [s] *default:* **1.20**|
|Mflatness|positive float|EIDM Flatness parameter of startup/driveoff curve [-] *default:* **2.00**|
|Mbegin|positive float|EIDM Shift parameter of startup/driveoff curve [-] *default:* **0.70**|
...
|maxvehpreview|positive integer|EIDM parameter how many vehicles are taken into the preview calculation of the driver (at least always 1!) [-] *default:* **0**|
|tauLast|positive float|Peter Wagner 2009 parameter *default:* **0**|
|apProb|positive float|Peter Wagner 2009 parameter *default:* **0**|
|adaptFactor|positive float|IDMM parameter *default:* **0**|
|adaptTime|positive float|IDMM parameter *default:* **0**|
|cc1|positive float|W99 parameter *default:* **1.3**|
|cc2|positive float|W99 parameter *default:* **8.0**|
|cc3|positive float|W99 parameter *default:* **-12.0**|
|cc4|positive float|W99 parameter *default:* **-0.25**|
|cc5|positive float|W99 parameter *default:* **0.35**|
|cc6|positive float|W99 parameter *default:* **6.0**|
|cc7|positive float|W99 parameter *default:* **0.25**|
|cc8|positive float|W99 parameter *default:* **2.0**|
|cc9|positive float|W99 parameter *default:* **1.5**|
...
|jmCrossingGap|positive float|Minimum distance to pedestrians that are walking towards the conflict point with the ego vehicle. *default:* **10**|
...
|jmDriveAfterYellowTime|positive float|This value causes vehicles to violate a yellow light if the duration of the yellow phase is lower than the given threshold. *default:* **-1**|
...
|jmIgnoreFoeProb|positive float|This value causes vehicles to ignore foe vehicles that have right-of-way with the given probability. *default:* **0.0**|
|jmIgnoreFoeSpeed|positive float|This value is used in conjunction with jmIgnoreFoeProb. Only vehicles with a speed below or equal to the given value may be ignored. *default:* **0.0**|
|jmSigmaMinor|string|This value configures driving imperfection (dawdling) while passing a minor link. *default:* **0.0**|
|jmTimegapMinor|positive float|This value defines the minimum time gap when passing ahead of a prioritized vehicle.  *default:* **1**|
|impatience|positive float|Willingess of drivers to impede vehicles with higher priority *default:* **0.0**|
|lcStrategic|positive float|The eagerness for performing strategic lane changing. Higher values result in earlier lane-changing. *default:* **1.0**|
|lcCooperative|positive float|The willingness for performing cooperative lane changing. Lower values result in reduced cooperation. *default:* **1.0**|
|lcSpeedGain|positive float|The eagerness for performing lane changing to gain speed. Higher values result in more lane-changing. *default:* **1.0**|
|lcKeepRight|positive float|The eagerness for following the obligation to keep right. Higher values result in earlier lane-changing. *default:* **1.0**|
|lcSublane|positive float|The eagerness for using the configured lateral alignment within the lane. Higher values result in increased willingness to sacrifice speed for alignment. *default:* **1.0**|
|lcOpposite|positive float|The eagerness for overtaking through the opposite-direction lane. Higher values result in more lane-changing. *default:* **1.0**|
|lcPushy|positive float|Willingness to encroach laterally on other drivers. *default:* **0.00**|
|lcPushyGap|positive float|Minimum lateral gap when encroaching laterally on other drives (alternative way to define lcPushy) *default:* **0.00**|
|lcAssertive|positive float|Willingness to accept lower front and rear gaps on the target lane. *default:* **1.0**|
|lcImpatience|positive float|Dynamic factor for modifying lcAssertive and lcPushy. *default:* **0.00**|
...
|lcAccelLat|positive float|Maximum lateral acceleration per second. *default:* **1.0**|
|lcLookaheadLeft|positive float|Factor for configuring the strategic lookahead distance when a change to the left is necessary (relative to right lookahead). *default:* **2.0**|
|lcSpeedGainRight|positive float|Factor for configuring the threshold asymmetry when changing to the left or to the right for speed gain. *default:* **0.1**|
|lcMaxSpeedLatStanding|string|Upper bound on lateral speed when standing. *default:* **0.00**|
|lcMaxSpeedLatFactor|positive float|Upper bound on lateral speed while moving computed as lcMaxSpeedLatStanding + lcMaxSpeedLatFactor * getSpeed() *default:* **1.00**|
|lcTurnAlignmentDistance|positive float|Distance to an upcoming turn on the vehicles route, below which the alignment should be dynamically adapted to match the turn direction. *default:* **0.00**|
|lcOvertakeRight|positive float|The probability for violating rules gainst overtaking on the right. *default:* **0.00**|
...
|repeat|positive integer|The number of times that the edges of this route shall be repeated *default:* **0**|
...
|vehsPerHour|string|Number of vehicless per hour, equally spaced *default:* **1800**|
|speed|string|Vehicle's speed *default:* **15.0**|
|id|unique string|The ID of the flow|
|from|unique string|The name of the edge the flow starts at|
|to|unique string|The name of the edge the flow ends at|
|via|list of unique strings|List of intermediate edge ids which shall be part of the flow|
|number|positive integer|probability for emitting a flow each second (not together with vehsPerHour or period) *default:* **1800**|
...
| Attribute | Type | Description |
|-----------|------|-------------|
|from|unique string|The name of the edge the edgeRel starts at|
...
|duration|positive SUMOTime|Minimum duration for stopping *default:* **60**|
|until|positive SUMOTime|The time step at which the route continues *default:* **0.00**|
...
|speed|positive float|Speed to be kept while driving between startPos and endPos *default:* **0.00**|
|edge|unique string|The name of the edge the stop shall be located at|

## connection
| Attribute | Type | Description |
|-----------|------|-------------|
|from|unique string|The name of the edge the vehicles leave|
|to|unique string|The name of the edge the vehicles may reach when leaving 'from'|
...
|contPos|positive float|If set to a more than 0 value, an internal junction will be built at this position (in m)/n from the start of the internal lane for this connection *default:* **-1.00**|
...
|visibility|positive float|Vision distance between vehicles *default:* **-1.00**|
...
|allow|list of vclasses VClasses|Explicitly allows the given vehicle classes (not given will be not allowed) *default:* **all**|
|disallow|list of vclasses VClasses|Explicitly disallows the given vehicle classes (not given will be allowed)|
|speed|positive float|sets custom speed limit for the connection *default:* **-1.00**|
|length|positive float|sets custom length for the connection *default:* **-1.00**|
...
| Attribute | Type | Description |
|-----------|------|-------------|
|speed|positive float|The maximum speed allowed on the lane in m/s *default:* **13.89**|
|allow|list of vclasses VClasses|Explicitly allows the given vehicle classes (not given will be not allowed) *default:* **all**|
|disallow|list of vclasses VClasses|Explicitly disallows the given vehicle classes (not given will be allowed)|
|width|positive float|Lane width for all lanes of this lane in meters (used for visualization) *default:* **-1**|
...
|width|positive float|The width of the crossings *default:* **4.00**|
...
|customShape|list of unique positions|Overrids default shape of pedestrian crossing|

## walkingArea
| Attribute | Type | Description |
|-----------|------|-------------|
|id|unique string|Walking Area ID|
|width|positive float|The width of the WalkingArea *default:* **2.00**|
|length|positive float|The length of the WalkingArea in meter|
|shape|list of unique positions|Overrids default shape of pedestrian sidewalk|
...
| Attribute | Type | Description |
|-----------|------|-------------|
|from|unique string|The name of the edge the person trip starts at|
|to|unique string|The name of the edge the person trip ends at|
...
| Attribute | Type | Description |
|-----------|------|-------------|
|from|unique string|The name of the edge the ride starts at|
|to|unique string|The name of the edge the ride ends at|
|arrivalPos|float|arrival position on the destination edge *default:* **-1**|
...
| Attribute | Type | Description |
|-----------|------|-------------|
|from|unique string|The name of the edge the walk starts at|
|to|unique string|The name of the edge the walk ends at|
|arrivalPos|float|arrival position on the destination edge *default:* **-1**|
|toBusStop|unique string|Id of the destination bus stop|
...
| Attribute | Type | Description |
|-----------|------|-------------|
|from|unique string|The name of the edge the transport starts at|
|to|unique string|The name of the edge the transport ends at|
|arrivalPos|float|arrival position on the destination edge *default:* **-1**|
...
| Attribute | Type | Description |
|-----------|------|-------------|
|from|unique string|The name of the edge the tranship starts at|
|to|unique string|The name of the edge the tranship ends at|
|departPos|positive float|The position at which the tranship shall enter the net *default:* **0**|
|arrivalPos|float|arrival position on the destination edge *default:* **-1**|
|speed|positive float|speed of the container for this tranship in m/s *default:* **1.39**|
|toContainerStop|unique string|Id of the destination container stop|
|edges|list of unique strings|id of the edges to walk|
