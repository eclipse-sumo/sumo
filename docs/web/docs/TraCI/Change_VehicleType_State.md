...
| scale (0x8e) | double | Sets the traffic scaling factor for vehicles of this type | [setScale](https://sumo.dlr.de/pydoc/traci._vehicle.html#VehicleDomain-setScale)         |
