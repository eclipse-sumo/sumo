...
| fuel consumption (id 0x65)           | double     | Sum of fuel consumption on this lane in mg/s during this time step.                                                                         | [getFuelConsumption](https://sumo.dlr.de/pydoc/traci._lane.html#LaneDomain-getFuelConsumption)               |
