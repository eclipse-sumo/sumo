...
| boarding duration (0x2f)        | double   | Sets the boarding duration for passengers entering this vehicle.                                                                                                   | [setBoardingDuraiton](https://sumo.dlr.de/pydoc/traci._vehicle.html#VehicleDomain-setBoardingDuration)        |
