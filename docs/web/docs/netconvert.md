...
- [Shape definitions](Simulation/Shapes.md) to be embedded in network output that supports this ([OpenDRIVE](Networks/Further_Outputs.html#embedding_road_objects))
...
- [OpenDrive road objects](Networks/Further_Outputs.html#opendrive_road_objects)
