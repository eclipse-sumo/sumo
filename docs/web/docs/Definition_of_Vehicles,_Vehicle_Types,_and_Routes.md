...
| lcCooperativeHelpTime   | Time threshold for yielding for any downstream vehicles that are blocked from strategic lane changing for too long. *default: 60s, | LC2013, SL2015 |
