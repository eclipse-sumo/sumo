...
| startupDelay                 | [vClass-specific](Vehicle_Type_Parameter_Defaults.md) | >=0  | The extra delay time before starting to drive after having had to stop      | all models except "Daniel1" and "EIDM" |
...
| ----------------------- | ----------------------------- | -------------- |
| lcStrategic             | The eagerness for performing strategic lane changing. Higher values result in earlier lane-changing. *default: 1.0, range \[0-inf), -1*  A value of 0 sets the lookahead-distance to 0 (vehicles can still change at the end of their lane) whereas -1 disables changing completely.                                                                                                                   | LC2013, SL2015 |
