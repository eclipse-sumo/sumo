...
long MFXTextFieldIcon::onUpdate(FXObject* sender,FXSelector sel,void* ptr){
...
long MFXTextFieldIcon::onSelectionGained(FXObject* sender,FXSelector sel,void* ptr){
...
long MFXTextFieldIcon::onSelectionLost(FXObject* sender,FXSelector sel,void* ptr){
...
long MFXTextFieldIcon::onSelectionRequest(FXObject* sender,FXSelector sel,void* ptr){
...
long MFXTextFieldIcon::onClipboardGained(FXObject* sender,FXSelector sel,void* ptr){
...
long MFXTextFieldIcon::onClipboardLost(FXObject* sender,FXSelector sel,void* ptr){
...
long MFXTextFieldIcon::onClipboardRequest(FXObject* sender,FXSelector sel,void* ptr){
  FXEvent *event=(FXEvent*)ptr;
  FXString string;
...
// Blink the cursor
long MFXTextFieldIcon::onBlink(FXObject*,FXSelector,void*){
...
// Gained focus
long MFXTextFieldIcon::onFocusIn(FXObject* sender,FXSelector sel,void* ptr){
...
// Lost focus
long MFXTextFieldIcon::onFocusOut(FXObject* sender,FXSelector sel,void* ptr){
...
long MFXTextFieldIcon::onFocusSelf(FXObject* sender,FXSelector sel,void* ptr){
...
bool MFXTextFieldIcon::canFocus() const { return true; }
...
long MFXTextFieldIcon::onCmdSetHelp(FXObject*,FXSelector,void* ptr){
...
long MFXTextFieldIcon::onCmdGetHelp(FXObject*,FXSelector,void* ptr){
...
long MFXTextFieldIcon::onCmdSetTip(FXObject*,FXSelector,void* ptr){
...
long MFXTextFieldIcon::onCmdGetTip(FXObject*,FXSelector,void* ptr){
...
long MFXTextFieldIcon::onQueryTip(FXObject* sender,FXSelector sel,void* ptr){
...
long MFXTextFieldIcon::onQueryHelp(FXObject* sender,FXSelector sel,void* ptr){
...
long MFXTextFieldIcon::onCmdSetValue(FXObject*,FXSelector,void* ptr){
...
// Update value from a message
long MFXTextFieldIcon::onCmdSetIntValue(FXObject*,FXSelector,void* ptr){
...
// Update value from a message
long MFXTextFieldIcon::onCmdSetRealValue(FXObject*,FXSelector,void* ptr){
...
// Update value from a message
long MFXTextFieldIcon::onCmdSetStringValue(FXObject*,FXSelector,void* ptr){
...
long MFXTextFieldIcon::onCmdGetIntValue(FXObject*,FXSelector,void* ptr){
...
// Obtain value from text field
long MFXTextFieldIcon::onCmdGetRealValue(FXObject*,FXSelector,void* ptr){
...
// Obtain value from text field
long MFXTextFieldIcon::onCmdGetStringValue(FXObject*,FXSelector,void* ptr){
...
// Pressed left button
long MFXTextFieldIcon::onLeftBtnPress(FXObject*,FXSelector,void* ptr){
...
long MFXTextFieldIcon::onLeftBtnRelease(FXObject*,FXSelector,void* ptr){
  if(isEnabled()){
    ungrab();
    flags&=~FLAG_PRESSED;
...
long MFXTextFieldIcon::onMiddleBtnPress(FXObject*,FXSelector,void* ptr){
  FXEvent* ev=(FXEvent*)ptr;
  flags&=~FLAG_TIP;
  handle(this,FXSEL(SEL_FOCUS_SELF,0),ptr);
  if(isEnabled()){
...
long MFXTextFieldIcon::onMiddleBtnRelease(FXObject*,FXSelector,void* ptr){
  if(isEnabled()){
    ungrab();
...
// Moved
long MFXTextFieldIcon::onMotion(FXObject*,FXSelector,void* ptr){
  FXEvent* event=(FXEvent*)ptr;
  FXint t;
...
// Automatic scroll
long MFXTextFieldIcon::onAutoScroll(FXObject*,FXSelector,void* ptr){
...
// Overstrike toggle
long MFXTextFieldIcon::onCmdToggleOverstrike(FXObject*,FXSelector,void*){
...
long MFXTextFieldIcon::onUpdToggleOverstrike(FXObject* sender,FXSelector,void*){
...
// Editable toggle
long MFXTextFieldIcon::onCmdToggleEditable(FXObject*,FXSelector,void*){
...
long MFXTextFieldIcon::onUpdToggleEditable(FXObject* sender,FXSelector,void*){
...
long MFXTextFieldIcon::onUpdHaveSelection(FXObject* sender,FXSelector,void* ptr){
...
// Update somebody who works on the selection
long MFXTextFieldIcon::onUpdSelectAll(FXObject* sender,FXSelector,void* ptr){
...
// Draw text fragment
void MFXTextFieldIcon::drawTextFragment(FXDCWindow& dc,FXint x,FXint y,FXint fm,FXint to){
...
void MFXTextFieldIcon::drawPWDTextFragment(FXDCWindow& dc,FXint x,FXint y,FXint fm,FXint to){
...
// Handle repaint
long MFXTextFieldIcon::onPaint(FXObject*,FXSelector,void* ptr){
  FXEvent *ev=(FXEvent*)ptr;
...
long MFXTextFieldIcon::onCmdCursorHome(FXObject*,FXSelector,void*){
  setCursorPos(0);
...
long MFXTextFieldIcon::onCmdCursorEnd(FXObject*,FXSelector,void*){
  setCursorPos(contents.length());
  makePositionVisible(cursor);
  return 1;
  }
...
// Move cursor right
long MFXTextFieldIcon::onCmdCursorRight(FXObject*,FXSelector,void*){
...
// Move cursor left
long MFXTextFieldIcon::onCmdCursorLeft(FXObject*,FXSelector,void*){
...
long MFXTextFieldIcon::onCmdCursorWordRight(FXObject*,FXSelector,void*){
...
long MFXTextFieldIcon::onCmdCursorWordLeft(FXObject*,FXSelector,void*){
...
long MFXTextFieldIcon::onCmdCursorWordStart(FXObject*,FXSelector,void*){
...
long MFXTextFieldIcon::onCmdCursorWordEnd(FXObject*,FXSelector,void*){
...
// Mark
long MFXTextFieldIcon::onCmdMark(FXObject*,FXSelector,void*){
  setAnchorPos(cursor);
  return 1;
  }
...
// Extend
long MFXTextFieldIcon::onCmdExtend(FXObject*,FXSelector,void*){
  extendSelection(cursor);
  return 1;
  }
...
// Select All
long MFXTextFieldIcon::onCmdSelectAll(FXObject*,FXSelector,void*){
  selectAll();
  makePositionVisible(cursor);
  return 1;
  }
...
// Deselect All
long MFXTextFieldIcon::onCmdDeselectAll(FXObject*,FXSelector,void*){
  killSelection();
  return 1;
  }
...
// Cut
long MFXTextFieldIcon::onCmdCutSel(FXObject*,FXSelector,void*){
  if(isEditable()){
    if(hasSelection()){
      FXDragType types[4];
      types[0]=stringType;
...
// Copy onto cliboard
long MFXTextFieldIcon::onCmdCopySel(FXObject*,FXSelector,void*){
  if(hasSelection()){
    FXDragType types[4];
    types[0]=stringType;
    types[1]=textType;
...
long MFXTextFieldIcon::onCmdPasteSel(FXObject*,FXSelector,void*){
  if(isEditable()){
    FXString string;
...
long MFXTextFieldIcon::onCmdPasteMiddle(FXObject*,FXSelector,void*){
  if(isEditable()){
    FXString string;
...
// Delete selection
long MFXTextFieldIcon::onCmdDeleteSel(FXObject*,FXSelector,void*){
  if(isEditable()){
...
// Delete all text
long MFXTextFieldIcon::onCmdDeleteAll(FXObject*,FXSelector,void*){
  if(isEditable()){
    setCursorPos(0);
    setAnchorPos(0);
    contents.clear();
...
// Overstrike string
long MFXTextFieldIcon::onCmdOverstString(FXObject*,FXSelector,void* ptr){
  if(isEditable()){
...
// Insert a string
long MFXTextFieldIcon::onCmdInsertString(FXObject*,FXSelector,void* ptr){
  if(isEditable()){
    FXString tentative=contents;
    FXint len=strlen((FXchar*)ptr);
    FXint reppos=cursor;
...
// Backspace character
long MFXTextFieldIcon::onCmdBackspace(FXObject*,FXSelector,void*){
...
// Delete character
long MFXTextFieldIcon::onCmdDelete(FXObject*,FXSelector,void*){
...
long MFXTextFieldIcon::onVerify(FXObject*,FXSelector,void* ptr){
...
// Pressed a key
long MFXTextFieldIcon::onKeyPress(FXObject*,FXSelector,void* ptr){
  FXEvent* event=(FXEvent*)ptr;
  flags&=~FLAG_TIP;
  if(isEnabled()){
...
// Key Release
long MFXTextFieldIcon::onKeyRelease(FXObject*,FXSelector,void* ptr){
  FXEvent* event=(FXEvent*)ptr;
  if(isEnabled()){
...
// Set selection
FXbool MFXTextFieldIcon::setSelection(FXint pos,FXint len){
  setAnchorPos(pos);
...
void MFXTextFieldIcon::setText(const FXString& text,FXbool notify){
  killSelection();
  if(contents!=text){
    contents=text;
...
void MFXTextFieldIcon::setNumColumns(FXint ncols){
  if(ncols<0) ncols=0;
  if(columns!=ncols){
    shift=0;
    columns=ncols;
...
// Set editable mode
void MFXTextFieldIcon::setEditable(FXbool edit){
...
// Set overstrike mode
void MFXTextFieldIcon::setOverstrike(FXbool over){
...
void MFXTextFieldIcon::setJustify(FXuint style){
