...
enum {
    ...
    /// @brief call tool edgeDataFromFlow
    MID_GNE_TOOLBARTOOLS_DETECTOR_EDGEDATAFROMFLOW,

    /// @brief call tool mapDetectors
    MID_GNE_TOOLBARTOOLS_DETECTOR_MAPDETECTORS,

    /// @brief call tool stationDistricts
    MID_GNE_TOOLBARTOOLS_DISTRICT_STATIONDISTRICTS,

    /// @brief call tool drtOrtools
    MID_GNE_TOOLBARTOOLS_DRT_DRTORTOOLS,

    /// @brief call tool citybrain_flow
    MID_GNE_TOOLBARTOOLS_IMPORT_CITYBRAIN_FLOW,

    /// @brief call tool citybrain_infostep
    MID_GNE_TOOLBARTOOLS_IMPORT_CITYBRAIN_INFOSTEP,

    /// @brief call tool citybrain_road
    MID_GNE_TOOLBARTOOLS_IMPORT_CITYBRAIN_ROAD,

    /// @brief call tool gtfs2fcd
    ...
    /// @brief call tool net2geojson
    MID_GNE_TOOLBARTOOLS_NET_NET2GEOJSON,

    /// @brief call tool net2jpsgeometry
    MID_GNE_TOOLBARTOOLS_NET_NET2JPSGEOMETRY,

    /// @brief call tool net2kml
    MID_GNE_TOOLBARTOOLS_NET_NET2KML,

    /// @brief call tool net2poly
    MID_GNE_TOOLBARTOOLS_NET_NET2POLY,

    /// @brief call tool netdiff
    MID_GNE_TOOLBARTOOLS_NET_NETDIFF,

    /// @brief call tool network_statistics
    MID_GNE_TOOLBARTOOLS_NET_NETWORK_STATISTICS,

    /// @brief call tool reduceLanes
    MID_GNE_TOOLBARTOOLS_NET_REDUCELANES,

    /// @brief call tool split_at_stops
    MID_GNE_TOOLBARTOOLS_NET_SPLITATSTOPS,

    /// @brief call tool addStopDelay
    MID_GNE_TOOLBARTOOLS_ROUTE_ADDSTOPDELAY,

    /// @brief call tool addStops2Routes
    MID_GNE_TOOLBARTOOLS_ROUTE_ADDSTOP2ROUTES,

    /// @brief call tool addTAZ
    MID_GNE_TOOLBARTOOLS_ROUTE_ADDTAZ,

    /// @brief call tool checkStopOrder
    MID_GNE_TOOLBARTOOLS_ROUTE_CHECKSTOPORDER,

    /// @brief call tool implausibleRoutes
    MID_GNE_TOOLBARTOOLS_ROUTE_IMPLAUSIBLEROUTES,

    /// @brief call tool route2OD
    MID_GNE_TOOLBARTOOLS_ROUTE_ROUTE2OD,

    /// @brief call tool routeStats
    MID_GNE_TOOLBARTOOLS_ROUTE_ROUTESTATS,

    /// @brief call tool scaleTimeLine
    MID_GNE_TOOLBARTOOLS_ROUTE_SCALETIMELINE,

    /// @brief call tool tracemapper
    MID_GNE_TOOLBARTOOLS_ROUTE_TRACEMAPPER,

    /// @brief call tool analyze_teleports
    MID_GNE_TOOLBARTOOLS_OUTPUT_ANALYZETELEPORTS,

    /// @brief call tool attributeDiff
    MID_GNE_TOOLBARTOOLS_OUTPUT_ATTRIBUTEDIFF,

    /// @brief call tool attributeStats
    MID_GNE_TOOLBARTOOLS_OUTPUT_ATTRIBUTESTATS,

    /// @brief call tool computeCoordination
    MID_GNE_TOOLBARTOOLS_OUTPUT_COMPUTECOORDINATION,

    /// @brief call tool computePassengerCounts
    MID_GNE_TOOLBARTOOLS_OUTPUT_COMPUTEPASSENGERCOUNTS,

    /// @brief call tool computeStoppingPlaceUsage
    MID_GNE_TOOLBARTOOLS_OUTPUT_COMPUTESTOPPINGPLACEUSAGE,

    /// @brief call tool countLaneChanges
    MID_GNE_TOOLBARTOOLS_OUTPUT_COUNTLANECHANGES,

    /// @brief call tool edgeDataDiff
    MID_GNE_TOOLBARTOOLS_OUTPUT_EDGEDATADIFF,

    /// @brief call tool fcdDiff
    MID_GNE_TOOLBARTOOLS_OUTPUT_FCDDIFF,

    /// @brief call tool generateTLSE2Detectors
    MID_GNE_TOOLBARTOOLS_OUTPUT_GENERATETLSE2DETECTORS,

    /// @brief call tool parkingSearchTraffic
    MID_GNE_TOOLBARTOOLS_OUTPUT_PARKINGSEARCHTRAFFIC,

    /// @brief call tool scheduleStats
    MID_GNE_TOOLBARTOOLS_OUTPUT_SCHEDULESTATS,

    /// @brief call tool stopOrder
    MID_GNE_TOOLBARTOOLS_OUTPUT_STOPORDER,

    /// @brief call tool tripinfoByType
    MID_GNE_TOOLBARTOOLS_OUTPUT_TRIPINFOBYTYPE,

    /// @brief call tool vehLanes
    MID_GNE_TOOLBARTOOLS_OUTPUT_VEHLANES,

    /// @brief call tool vehrouteCountValidation
    MID_GNE_TOOLBARTOOLS_OUTPUT_VEHROUTECOUNTVALIDATION,

    /// @brief call tool vehrouteDiff
    MID_GNE_TOOLBARTOOLS_OUTPUT_VEHROUTEDIFF,

    /// @brief call tool walkFactor
    MID_GNE_TOOLBARTOOLS_OUTPUT_WALKFACTOR,

    /// @brief call tool plotXMLAttributes
    MID_GNE_TOOLBARTOOLS_VISUALIZATION_PLOTXMLATTRIBUTES,

    /// @brief call tool countEdgeUsage
    MID_GNE_TOOLBARTOOLS_COUNTEDGEUSAGE,

    /// @brief call tool edgesInDistricts
    MID_GNE_TOOLBARTOOLS_EDGESINDISTRICTS,

    /// @brief call tool evacuateAreas
    MID_GNE_TOOLBARTOOLS_EVACUATEAREAS,

    /// @brief call tool extractTest
    MID_GNE_TOOLBARTOOLS_EXTRACTTEST,

    /// @brief call tool fcdReplay
    MID_GNE_TOOLBARTOOLS_FCDREPLAY,

    /// @brief call tool findAllRoutes
    MID_GNE_TOOLBARTOOLS_FINDALLROUTES,

    /// @brief call tool generateBidiDistricts
    MID_GNE_TOOLBARTOOLS_GENERATEBIDIDISTRICTS,

    /// @brief call tool generateParkingAreaRerouters
    MID_GNE_TOOLBARTOOLS_GENERATEPARKINGAREAREROUTERS,

    /// @brief call tool generateParkingAreas
    MID_GNE_TOOLBARTOOLS_GENERATEPARKINGAREAS,

    /// @brief call tool generateRailSignalConstraints
    MID_GNE_TOOLBARTOOLS_GENERATERAILSIGNALCONSTRAINTS,

    /// @brief call tool generateRerouters
    MID_GNE_TOOLBARTOOLS_GENERATEREROUTERS,

    /// @brief call tool osmBuild
    MID_GNE_TOOLBARTOOLS_OSMBUILD,

    /// @brief call tool osmGet
    MID_GNE_TOOLBARTOOLS_OSMGET,

    /// @brief call tool osmWebWizard
    MID_GNE_TOOLBARTOOLS_OSMWEBWIZARD,

    /// @brief call tool plot_trajectories
    MID_GNE_TOOLBARTOOLS_PLOTTRAJECTORIES,

    /// @brief call tool randomTrips
    MID_GNE_TOOLBARTOOLS_RANDOMTRIPS,

    /// @brief call tool routeSampler
    MID_GNE_TOOLBARTOOLS_ROUTESAMPLER,

    /// @brief call tool runSeeds
    MID_GNE_TOOLBARTOOLS_RUNSEEDS,

    /// @brief call tool stateReplay
    MID_GNE_TOOLBARTOOLS_STATEREPLAY,

    /// @brief call tool tileGet
    MID_GNE_TOOLBARTOOLS_TILEGET,

    /// @brief call tool tlsCoordinator
    MID_GNE_TOOLBARTOOLS_TLSCOORDINATOR,

    /// @brief call tool tlsCycleAdaptation
    MID_GNE_TOOLBARTOOLS_TLSCYCLEADAPTATION,
