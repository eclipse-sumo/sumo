...
StringBijection<GUIGlObjectType>::Entry GUIGlObject::GUIGlObjectTypeNamesInitializer[] = {
    ...
    {"ride",                    GLO_RIDE},
    {"walk",                    GLO_WALK},
    {"walkFromTo",              GLO_WALK_FROMTO},
    {"walkBusStop",             GLO_WALK_BUSSTOP},
    {"walkRoute",               GLO_WALK_ROUTE},
    {"rideFromTo",              GLO_RIDE_FROMTO},
    {"rideBusStop",             GLO_RIDE_BUSSTOP},
    {"personStopBusStop",       GLO_PERSONSTOP_BUSSTOP},
    {"personStopContainerStop", GLO_PERSONSTOP_CONTAINERSTOP},
    {"personStopLane",          GLO_PERSONSTOP_LANE},
