...
#include "inspect_lane_cursor_mask.xbm"
...
GUICursorSubSys::GUICursorSubSys(FXApp* a) {
    ...
    myCursors[GUICursor::SUMOCURSOR_INSPECT_LANE] = new FXCursor(a, inspect_lane_cursor_bits, inspect_lane_cursor_mask_bits, inspect_lane_cursor_width, inspect_lane_cursor_height, inspect_lane_cursor_x_hot, inspect_lane_cursor_y_hot);
