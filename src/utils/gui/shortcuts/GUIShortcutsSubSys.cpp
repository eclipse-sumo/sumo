...
GUIShortcutsSubSys::buildAccelerators(FXAccelTable* accelTable, FXObject* target) {
    ...
    accelTable->addAccel(parseKey(KEY_h, KEYMODIFIER_CONTROL), target, FXSEL(SEL_COMMAND, MID_HOTKEY_CTRL_H_OPENEDGETYPES));
    accelTable->addAccel(parseKey(KEY_H, KEYMODIFIER_CONTROL), target, FXSEL(SEL_COMMAND, MID_HOTKEY_CTRL_H_OPENEDGETYPES));
    ...
    accelTable->addAccel(parseKey(KEY_w, KEYMODIFIER_CONTROL, KEYMODIFIER_SHIFT), target, FXSEL(SEL_COMMAND, MID_HOTKEY_CTRL_SHIFT_W_FORCESAVENETEWORK));
    accelTable->addAccel(parseKey(KEY_W, KEYMODIFIER_CONTROL, KEYMODIFIER_SHIFT), target, FXSEL(SEL_COMMAND, MID_HOTKEY_CTRL_SHIFT_W_FORCESAVENETEWORK));

    accelTable->addAccel(parseKey(KEY_x, KEYMODIFIER_CONTROL, KEYMODIFIER_SHIFT), target, FXSEL(SEL_COMMAND, MID_HOTKEY_CTRL_SHIFT_X_FORCESAVEADDITIONALS));
    accelTable->addAccel(parseKey(KEY_X, KEYMODIFIER_CONTROL, KEYMODIFIER_SHIFT), target, FXSEL(SEL_COMMAND, MID_HOTKEY_CTRL_SHIFT_X_FORCESAVEADDITIONALS));

    accelTable->addAccel(parseKey(KEY_y, KEYMODIFIER_CONTROL, KEYMODIFIER_SHIFT), target, FXSEL(SEL_COMMAND, MID_HOTKEY_CTRL_SHIFT_Y_FORCESAVEDEMANDELEMENTS));
    accelTable->addAccel(parseKey(KEY_Y, KEYMODIFIER_CONTROL, KEYMODIFIER_SHIFT), target, FXSEL(SEL_COMMAND, MID_HOTKEY_CTRL_SHIFT_Y_FORCESAVEDEMANDELEMENTS));

    accelTable->addAccel(parseKey(KEY_z, KEYMODIFIER_CONTROL, KEYMODIFIER_SHIFT), target, FXSEL(SEL_COMMAND, MID_HOTKEY_CTRL_SHIFT_Z_FORCESAVEDATAELEMENTS));
    accelTable->addAccel(parseKey(KEY_Z, KEYMODIFIER_CONTROL, KEYMODIFIER_SHIFT), target, FXSEL(SEL_COMMAND, MID_HOTKEY_CTRL_SHIFT_Z_FORCESAVEDATAELEMENTS));
