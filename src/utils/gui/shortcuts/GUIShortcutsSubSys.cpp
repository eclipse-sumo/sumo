...
GUIShortcutsSubSys::buildNETEDITAccelerators(GNEApplicationWindow* GNEApp) {
    ...
    GNEApp->getAccelTable()->addAccel(parseKey(KEY_F1, KEYMODIFIER_CONTROL), GNEApp, FXSEL(SEL_COMMAND, MID_HOTKEY_CTRL_F1_FORCESAVENETEWORK));

    GNEApp->getAccelTable()->addAccel(parseKey(KEY_F2, KEYMODIFIER_CONTROL), GNEApp, FXSEL(SEL_COMMAND, MID_HOTKEY_CTRL_F2_FORCESAVEADDITIONALS));

    GNEApp->getAccelTable()->addAccel(parseKey(KEY_F3, KEYMODIFIER_CONTROL), GNEApp, FXSEL(SEL_COMMAND, MID_HOTKEY_CTRL_F3_FORCESAVEDEMANDELEMENTS));

    GNEApp->getAccelTable()->addAccel(parseKey(KEY_F4, KEYMODIFIER_CONTROL), GNEApp, FXSEL(SEL_COMMAND, MID_HOTKEY_CTRL_F4_FORCESAVEDATAELEMENTS));
