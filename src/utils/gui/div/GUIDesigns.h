...
/// @brief button only with icon, special case for ticked arrows
#define GUIDesignButtonIconTickedArrow          (LAYOUT_FIX_WIDTH | LAYOUT_FIX_HEIGHT), 0, 0, GUIDesignHeight, GUIDesignHeight, 0, 0, 0, 0
