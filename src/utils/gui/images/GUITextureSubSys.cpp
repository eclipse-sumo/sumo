...
#include "GNETexture_PersonStopLane.cpp"
#include "GNETexture_PersonStopLaneSelected.cpp"
#include "GNETexture_PersonStopBusStop.cpp"
#include "GNETexture_PersonStopBusStopSelected.cpp"
...
GUITextureSubSys::GUITextureSubSys(FXApp* a) :
    ...
    myTextures[GUITexture::PERSONSTOP_LANE] = 0;
    myTextures[GUITexture::PERSONSTOP_LANE_SELECTED] = 0;
    myTextures[GUITexture::PERSONSTOP_BUSSTOP] = 0;
    myTextures[GUITexture::PERSONSTOP_BUSSTOP_SELECTED] = 0;
}
    ...
    if (myInstance->myTextures.at(which) == 0) {
        switch (which) {
            ...
            case GUITexture::STOP_SELECTED:
                ...
                break;
            case GUITexture::PERSONSTOP_LANE:
                myInstance->myTextures[which] = GUITexturesHelper::add(new FXGIFImage(myInstance->myApp, GNETexture_PersonStopLane, IMAGE_KEEP | IMAGE_SHMI | IMAGE_SHMP));
                break;
            case GUITexture::PERSONSTOP_LANE_SELECTED:
                myInstance->myTextures[which] = GUITexturesHelper::add(new FXGIFImage(myInstance->myApp, GNETexture_PersonStopLaneSelected, IMAGE_KEEP | IMAGE_SHMI | IMAGE_SHMP));
                break;
            case GUITexture::PERSONSTOP_BUSSTOP:
                myInstance->myTextures[which] = GUITexturesHelper::add(new FXGIFImage(myInstance->myApp, GNETexture_PersonStopBusStop, IMAGE_KEEP | IMAGE_SHMI | IMAGE_SHMP));
                break;
            case GUITexture::PERSONSTOP_BUSSTOP_SELECTED:
                myInstance->myTextures[which] = GUITexturesHelper::add(new FXGIFImage(myInstance->myApp, GNETexture_PersonStopBusStopSelected, IMAGE_KEEP | IMAGE_SHMI | IMAGE_SHMP));
                break;
            default:
