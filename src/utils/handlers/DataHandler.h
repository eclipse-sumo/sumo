...
public:
     ...
     * @param[in] sumoBaseObject sumo base object used for build
     * @param[in] busStop GNEData of this Access belongs
    ...
    /**@brief Builds a VariableSpeedSign (lane speed data)
     * @param[in] sumoBaseObject sumo base object used for build
     * @param[in] id The id of the lane speed data
     * @param[in] destLanes List of lanes affected by this speed data
    ...
    /**@brief Builds a vaporizer (lane speed data)
     * @param[in] sumoBaseObject sumo base object used for build
