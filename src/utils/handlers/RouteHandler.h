...
public:
     ...
     * @param[in] sumoBaseObject sumo base object used for build
     * @param[in] busStop GNERoute of this Access belongs
    ...
    /**@brief Builds a VariableSpeedSign (lane speed route element)
     * @param[in] sumoBaseObject sumo base object used for build
     * @param[in] id The id of the lane speed route element
     * @param[in] destLanes List of lanes affected by this speed route element
    ...
    /**@brief Builds a vaporizer (lane speed route element)
     * @param[in] sumoBaseObject sumo base object used for build
     ...
     * @param[in] allowUndoRedo enable or disable remove created route element with ctrl + Z / ctrl + Y
