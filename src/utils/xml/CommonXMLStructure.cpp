...
CommonXMLStructure::PlanParameters::getWalkTag() const {
    if (isSingleEdgePlan()) {
        ...
        if (!toEdge.empty()) {
            return GNE_TAG_WALK_EDGE_EDGE;
            /* the next walks are unsupported
            } else if (!toTAZ.empty()) {
...
CommonXMLStructure::PlanParameters::getPersonTripTag() const {
    if (isSingleEdgePlan()) {
        ...
        if (!toEdge.empty()) {
            return GNE_TAG_PERSONTRIP_EDGE_EDGE;
            /* the next personTrips are unsupported
            } else if (!toTAZ.empty()) {
...
CommonXMLStructure::PlanParameters::getRideTag() const {
    if (isSingleEdgePlan()) {
        ...
        if (!toEdge.empty()) {
            return GNE_TAG_RIDE_EDGE_EDGE;
            /* the next rides are unsupported
            } else if (!toTAZ.empty()) {
...
CommonXMLStructure::PlanParameters::getTransportTag() const {
    if (isSingleEdgePlan()) {
        ...
        if (!toEdge.empty()) {
            return GNE_TAG_TRANSPORT_EDGE_EDGE;
            /* the next transports are unsupported
            } else if (!toTAZ.empty()) {
...
CommonXMLStructure::PlanParameters::getTranshipTag() const {
    if (isSingleEdgePlan()) {
        ...
        if (!toEdge.empty()) {
            return GNE_TAG_TRANSHIP_EDGE_EDGE;
            /* the next tranships are unsupported
            } else if (!toTAZ.empty()) {
