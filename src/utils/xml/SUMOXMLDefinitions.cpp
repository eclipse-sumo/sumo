...
StringBijection<int>::Entry SUMOXMLDefinitions::tags[] = {
    ...
    { "personTrip: TAZs",               GNE_TAG_PERSONTRIP_TAZS },
    // GNE Walks
...
StringBijection<int>::Entry SUMOXMLDefinitions::attrs[] = {
    ...
    { "planGeometryPrevious",               GNE_ATTR_PLAN_GEOMETRY_PREVIOUS },
    { "planGeometryNext",                   GNE_ATTR_PLAN_GEOMETRY_NEXT },
