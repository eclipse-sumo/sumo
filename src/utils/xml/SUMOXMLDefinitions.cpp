...
StringBijection<int>::Entry SUMOXMLDefinitions::tags[] = {
    ...
    // GNE Person trips
    { "personTrip: edge->edge",             GNE_TAG_WALK_EDGE_EDGE },
    { "personTrip: edge->taz",              GNE_TAG_WALK_EDGE_TAZ },
    { "personTrip: edge->junction",         GNE_TAG_WALK_EDGE_JUNCTION },
    { "personTrip: edge->busstop",          GNE_TAG_WALK_EDGE_BUSSTOP },
    { "personTrip: edge->trainstop",        GNE_TAG_WALK_EDGE_TRAINSTOP },
    { "personTrip: taz->edge",              GNE_TAG_WALK_TAZ_EDGE },
    { "personTrip: taz->taz",               GNE_TAG_WALK_TAZ_TAZ },
    { "personTrip: taz->junction",          GNE_TAG_WALK_TAZ_JUNCTION },
    { "personTrip: taz->busstop",           GNE_TAG_WALK_TAZ_BUSSTOP },
    { "personTrip: taz->trainstop",         GNE_TAG_WALK_TAZ_TRAINSTOP },
    { "personTrip: junction->edge",         GNE_TAG_WALK_JUNCTION_EDGE },
    { "personTrip: junction->taz",          GNE_TAG_WALK_JUNCTION_TAZ },
    { "personTrip: junction->junction",     GNE_TAG_WALK_JUNCTION_JUNCTION },
    { "personTrip: junction->busstop",      GNE_TAG_WALK_JUNCTION_BUSSTOP },
    { "personTrip: junction->trainstop",    GNE_TAG_WALK_JUNCTION_TRAINSTOP },
    { "personTrip: busstop->edge",          GNE_TAG_WALK_BUSSTOP_EDGE },
    { "personTrip: busstop->taz",           GNE_TAG_WALK_BUSSTOP_TAZ },
    { "personTrip: busstop->junction",      GNE_TAG_WALK_BUSSTOP_JUNCTION },
    { "personTrip: busstop->busstop",       GNE_TAG_WALK_BUSSTOP_BUSSTOP },
    { "personTrip: busstop->trainstop",     GNE_TAG_WALK_BUSSTOP_TRAINSTOP },
    { "personTrip: trainstop->edge",        GNE_TAG_WALK_TRAINSTOP_EDGE },
    { "personTrip: trainstop->taz",         GNE_TAG_WALK_TRAINSTOP_TAZ },
    { "personTrip: trainstop->junction",    GNE_TAG_WALK_TRAINSTOP_JUNCTION },
    { "personTrip: trainstop->busstop",     GNE_TAG_WALK_TRAINSTOP_BUSSTOP },
    { "personTrip: trainstop->trainstop",   GNE_TAG_WALK_TRAINSTOP_TRAINSTOP },
    // GNE Walks
...
StringBijection<int>::Entry SUMOXMLDefinitions::attrs[] = {
    ...
    { "toTrainStop",                        GNE_ATTR_TO_TRAINSTOP },
