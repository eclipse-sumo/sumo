...
const int VEHPARS_NUMBER_SET = 2 << 4;
const int VEHPARS_PERIOD_SET = 2 << 5;
const int VEHPARS_VPH_SET = 2 << 6;
...
const int VEHPARS_FROM_TAZ_SET = 2 << 12;
const int VEHPARS_TO_TAZ_SET = 2 << 13;
const int VEHPARS_FORCE_REROUTE = 2 << 14;
const int VEHPARS_PERSON_CAPACITY_SET = 2 << 15;
const int VEHPARS_PERSON_NUMBER_SET = 2 << 16;
const int VEHPARS_CONTAINER_NUMBER_SET = 2 << 17;
const int VEHPARS_DEPARTPOSLAT_SET = 2 << 18;
const int VEHPARS_ARRIVALPOSLAT_SET = 2 << 19;
const int VEHPARS_VIA_SET = 2 << 20;
