...
void
GNEDetectorExit::moveGeometry(const Position& oldPos, const Position& offset) {
...
void
GNEDetectorExit::commitGeometryMoving(const Position& oldPos, GNEUndoList* undoList) {
