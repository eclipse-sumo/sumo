...
GNECalibratorVehicleType::GNECalibratorVehicleType(GNENet* net, const std::string& id) :
    ...
    myAccel(parse<double>(getDefaultValue(SUMO_TAG_VTYPE, SUMO_ATTR_ACCEL))),
    myDecel(parse<double>(getDefaultValue(SUMO_TAG_VTYPE, SUMO_ATTR_DECEL))),
    mySigma(parse<double>(getDefaultValue(SUMO_TAG_VTYPE, SUMO_ATTR_SIGMA))),
    myTau(parse<double>(getDefaultValue(SUMO_TAG_VTYPE, SUMO_ATTR_TAU))),
    myLength(parse<double>(getDefaultValue(SUMO_TAG_VTYPE, SUMO_ATTR_LENGTH))),
    myMinGap(parse<double>(getDefaultValue(SUMO_TAG_VTYPE, SUMO_ATTR_MINGAP))),
    myMaxSpeed(parse<double>(getDefaultValue(SUMO_TAG_VTYPE, SUMO_ATTR_MAXSPEED))),
    mySpeedFactor(parse<double>(getDefaultValue(SUMO_TAG_VTYPE, SUMO_ATTR_SPEEDFACTOR))),
    mySpeedDev(parse<double>(getDefaultValue(SUMO_TAG_VTYPE, SUMO_ATTR_SPEEDDEV))),
    myColor(parse<RGBColor>(getDefaultValue(SUMO_TAG_VTYPE, SUMO_ATTR_COLOR))),
    myVClass(parse<SUMOVehicleClass>(getDefaultValue(SUMO_TAG_VTYPE, SUMO_ATTR_VCLASS))),
    myEmissionClass(getDefaultValue(SUMO_TAG_VTYPE, SUMO_ATTR_EMISSIONCLASS)),
    myShape(parse<SUMOVehicleShape>(getDefaultValue(SUMO_TAG_VTYPE, SUMO_ATTR_GUISHAPE))),
    myWidth(parse<double>(getDefaultValue(SUMO_TAG_VTYPE, SUMO_ATTR_WIDTH))),
    myFilename(getDefaultValue(SUMO_TAG_VTYPE, SUMO_ATTR_IMGFILE)),
    myImpatience(parse<double>(getDefaultValue(SUMO_TAG_VTYPE, SUMO_ATTR_IMPATIENCE))),
    myLaneChangeModel(getDefaultValue(SUMO_TAG_VTYPE, SUMO_ATTR_LANE_CHANGE_MODEL)),
    myCarFollowModel(getDefaultValue(SUMO_TAG_VTYPE, SUMO_ATTR_CAR_FOLLOW_MODEL)),
    myPersonCapacity(parse<int>(getDefaultValue(SUMO_TAG_VTYPE, SUMO_ATTR_PERSON_CAPACITY))),
    myContainerCapacity(parse<int>(getDefaultValue(SUMO_TAG_VTYPE, SUMO_ATTR_CONTAINER_CAPACITY))),
    myBoardingDuration(parse<double>(getDefaultValue(SUMO_TAG_VTYPE, SUMO_ATTR_BOARDING_DURATION))),
    myLoadingDuration(parse<double>(getDefaultValue(SUMO_TAG_VTYPE, SUMO_ATTR_LOADING_DURATION))),
    myLatAlignment(getDefaultValue(SUMO_TAG_VTYPE, SUMO_ATTR_LATALIGNMENT)),
    myMinGapLat(parse<double>(getDefaultValue(SUMO_TAG_VTYPE, SUMO_ATTR_MINGAP_LAT))),
    myMaxSpeedLat(parse<double>(getDefaultValue(SUMO_TAG_VTYPE, SUMO_ATTR_MAXSPEED_LAT))) {
}
