...
GNECalibratorFlow::GNECalibratorFlow(GNECalibratorDialog* calibratorDialog, GNENet* net) :
    ...
    myVehsPerHour(getDefaultValue(SUMO_TAG_FLOW, SUMO_ATTR_VEHSPERHOUR)),
    mySpeed(getDefaultValue(SUMO_TAG_FLOW, SUMO_ATTR_SPEED)),
    myColor(parse<RGBColor>(getDefaultValue(SUMO_TAG_FLOW, SUMO_ATTR_COLOR))),
    myDepartLane(getDefaultValue(SUMO_TAG_FLOW, SUMO_ATTR_DEPARTLANE)),
    myDepartPos(getDefaultValue(SUMO_TAG_FLOW, SUMO_ATTR_DEPARTPOS)),
    myDepartSpeed(getDefaultValue(SUMO_TAG_FLOW, SUMO_ATTR_DEPARTSPEED)),
    myArrivalLane(getDefaultValue(SUMO_TAG_FLOW, SUMO_ATTR_ARRIVALLANE)),
    myArrivalPos(getDefaultValue(SUMO_TAG_FLOW, SUMO_ATTR_ARRIVALPOS)),
    myArrivalSpeed(getDefaultValue(SUMO_TAG_FLOW, SUMO_ATTR_ARRIVALSPEED)),
    myLine(getDefaultValue(SUMO_TAG_FLOW, SUMO_ATTR_LINE)),
    myPersonNumber(parse<int>(getDefaultValue(SUMO_TAG_FLOW, SUMO_ATTR_PERSON_NUMBER))),
    myContainerNumber(parse<int>(getDefaultValue(SUMO_TAG_FLOW, SUMO_ATTR_CONTAINER_NUMBER))),
    myReroute(parse<bool>(getDefaultValue(SUMO_TAG_FLOW, SUMO_ATTR_CONTAINER_NUMBER))),
    myDepartPosLat(getDefaultValue(SUMO_TAG_FLOW, SUMO_ATTR_DEPARTPOS_LAT)),
    myArrivalPosLat(getDefaultValue(SUMO_TAG_FLOW, SUMO_ATTR_ARRIVALPOS_LAT)),
    myBegin(parse<double>(getDefaultValue(SUMO_TAG_FLOW, SUMO_ATTR_BEGIN))),
    myEnd(parse<double>(getDefaultValue(SUMO_TAG_FLOW, SUMO_ATTR_END))) {}
