...
FXDEFMAP(GNEApplicationWindow) GNEApplicationWindowMap[] = {
    ...
    FXMAPFUNC(SEL_COMMAND,  MID_HOTKEY_CTRL_SHIFT_J_SAVEMEANDATAS,  GNEApplicationWindow::onCmdSaveMeanDatas),
    FXMAPFUNC(SEL_UPDATE,   MID_HOTKEY_CTRL_SHIFT_J_SAVEMEANDATAS,  GNEApplicationWindow::onUpdSaveMeanDatas),
