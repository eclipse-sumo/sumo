        ...
        switch (tag) {
            case SUMO_TAG_EDGE:
                ...
                myAllowedAttributes[tag][SUMO_ATTR_PRIORITY] = AttributeValues(
                    ...
                    "1");
                myAllowedAttributes[tag][SUMO_ATTR_NUMLANES] = AttributeValues(
                    ACPROPERTY_INT | ACPROPERTY_POSITIVE, 
                ...
                myAllowedAttributes[tag][SUMO_ATTR_ALLOW] = AttributeValues(
                    ...
                    "all");
                myAllowedAttributes[tag][SUMO_ATTR_DISALLOW] = AttributeValues(
                    ACPROPERTY_STRING | ACPROPERTY_SVCPERMISSION, 
                ...
                myAllowedAttributes[tag][SUMO_ATTR_LENGTH] = AttributeValues(
                    ...
                    NODEFAULTVALUE);
                myAllowedAttributes[tag][SUMO_ATTR_SPREADTYPE] = AttributeValues(
                    ACPROPERTY_STRING, 
                ...
                myAllowedAttributes[tag][SUMO_ATTR_NAME] = AttributeValues(
                    ...
                    "");
                myAllowedAttributes[tag][SUMO_ATTR_WIDTH] = AttributeValues(
                    ACPROPERTY_FLOAT | ACPROPERTY_POSITIVE, 
                    "Lane width for all lanes of this edge in meters (used for visualization)", 
                    "default");
                myAllowedAttributes[tag][SUMO_ATTR_ENDOFFSET] = AttributeValues(
                    ACPROPERTY_FLOAT | ACPROPERTY_POSITIVE, 
                    "Move the stop line back from the intersection by the given amount", 
                    "0");
                myAllowedAttributes[tag][GNE_ATTR_SHAPE_START] = AttributeValues(
                    ACPROPERTY_POSITION, // virtual attribute used to define an endPoint
                    "Custom position in which shape start (by default position of junction from)", 
                    "");
                myAllowedAttributes[tag][GNE_ATTR_SHAPE_END] = AttributeValues(
                    ACPROPERTY_POSITION, // virtual attribute from to define an endPoint
                    "Custom position in which shape end (by default position of junction from)", 
                    "");
                myAllowedAttributes[tag][GNE_ATTR_BIDIR] = AttributeValues(
                    ACPROPERTY_BOOL, // virtual attribute to check of this edge is part of a bidirectional railway
            ...
            case SUMO_TAG_JUNCTION:
                ...
                myAllowedAttributes[tag][SUMO_ATTR_RADIUS] = AttributeValues(
                    ...
                    "1.5");
                myAllowedAttributes[tag][SUMO_ATTR_KEEP_CLEAR] = AttributeValues(
                    ACPROPERTY_BOOL, 
                    "Whether the junction-blocking-heuristic should be activated at this node", 
                    "1");
                myAllowedAttributes[tag][SUMO_ATTR_TLTYPE] = AttributeValues(
                    ACPROPERTY_STRING, 
            ...
            case SUMO_TAG_LANE:
                ...
                myAllowedAttributes[tag][SUMO_ATTR_ENDOFFSET] = AttributeValues(
                    ...
                    "Move the stop line back from the intersection by the given amount", 
                    "0");
                myAllowedAttributes[tag][SUMO_ATTR_ACCELERATION] = AttributeValues(
                    ACPROPERTY_BOOL, 
            ...
            case SUMO_TAG_POI:
                ...
                myAllowedAttributes[tag][SUMO_ATTR_TYPE] = AttributeValues(
                    ...
                    "");
                myAllowedAttributes[tag][SUMO_ATTR_LAYER] = AttributeValues(
                    ACPROPERTY_INT, 
                ...
                myAllowedAttributes[tag][SUMO_ATTR_WIDTH] = AttributeValues(
                    ...
                    "0");
                myAllowedAttributes[tag][SUMO_ATTR_HEIGHT] = AttributeValues(
                    ACPROPERTY_FLOAT | ACPROPERTY_POSITIVE, 
                    "Height of rendered image in meters", 
                    "0");
                myAllowedAttributes[tag][SUMO_ATTR_IMGFILE] = AttributeValues(
                    ACPROPERTY_STRING | ACPROPERTY_FILENAME, 
                    "A bitmap to use for rendering this poi", 
                    "");
                myAllowedAttributes[tag][SUMO_ATTR_RELATIVEPATH] = AttributeValues(
                    ACPROPERTY_BOOL, 
                    "Enable or disbale use image file as a relative path", 
                    "0");
                myAllowedAttributes[tag][SUMO_ATTR_ANGLE] = AttributeValues(
                    ACPROPERTY_FLOAT, 
            ...
            case SUMO_TAG_POLY:
                ...
                myAllowedAttributes[tag][SUMO_ATTR_COLOR] = AttributeValues(
                    ...
                    "green");
                myAllowedAttributes[tag][SUMO_ATTR_FILL] = AttributeValues(
                    ACPROPERTY_BOOL, 
            ...
            case SUMO_TAG_CROSSING:
                ...
                myAllowedAttributes[tag][SUMO_ATTR_TLLINKINDEX] = AttributeValues(
                    ACPROPERTY_INT, 
                    "sets the tls-index for this crossing", 
                    "-1");
                myAllowedAttributes[tag][SUMO_ATTR_TLLINKINDEX2] = AttributeValues(
                    ACPROPERTY_INT, 
            ...
            case SUMO_TAG_CONNECTION:
                ...
                myAllowedAttributes[tag][SUMO_ATTR_KEEP_CLEAR] = AttributeValues(
                    ...
                    "0");
                myAllowedAttributes[tag][SUMO_ATTR_CONTPOS] = AttributeValues(
                    ACPROPERTY_FLOAT | ACPROPERTY_POSITIVE, 
                ...
                myAllowedAttributes[tag][SUMO_ATTR_UNCONTROLLED] = AttributeValues(
                    ACPROPERTY_BOOL, 
                    "If set to true, This connection will not be TLS-controlled despite its node being controlled", 
                    "0");
                myAllowedAttributes[tag][SUMO_ATTR_VISIBILITY_DISTANCE] = AttributeValues(
                    ACPROPERTY_FLOAT | ACPROPERTY_POSITIVE, 
                    "", 
            ...
            case SUMO_TAG_CHARGING_STATION:
                ...
                myAllowedAttributes[tag][SUMO_ATTR_FRIENDLY_POS] = AttributeValues(
                    ...
                    "If set, no error will be reported if element is placed behind the lane. Instead,it will be placed 0.1 meters from the lanes end or at position 0.1, if the position was negative and larger than the lanes length after multiplication with - 1", 
                    "0");
                myAllowedAttributes[tag][SUMO_ATTR_CHARGINGPOWER] = AttributeValues(
                    ACPROPERTY_FLOAT | ACPROPERTY_POSITIVE, 
                    "Charging power in W", 
                    "22000.00");
                myAllowedAttributes[tag][SUMO_ATTR_EFFICIENCY] = AttributeValues(
                    ACPROPERTY_PROBABILITY | ACPROPERTY_POSITIVE, 
                    "Charging efficiency [0,1]", 
                    "0.95");
                myAllowedAttributes[tag][SUMO_ATTR_CHARGEINTRANSIT] = AttributeValues(
                    ACPROPERTY_BOOL, 
                    "Enable or disable charge in transit, i.e. vehicle must or must not to stop for charging", 
                    "0");
                myAllowedAttributes[tag][SUMO_ATTR_CHARGEDELAY] = AttributeValues(
            ...
            case SUMO_TAG_E1DETECTOR:
                ...
                myAllowedAttributes[tag][SUMO_ATTR_FILE] = AttributeValues(
                    ...
                    "");
                myAllowedAttributes[tag][SUMO_ATTR_VTYPES] = AttributeValues(
                    ACPROPERTY_STRING, 
            ...
            case SUMO_TAG_E2DETECTOR:
                ...
                myAllowedAttributes[tag][SUMO_ATTR_FILE] = AttributeValues(
                    ...
                    "The path to the output file", 
                    "");
                myAllowedAttributes[tag][SUMO_ATTR_CONT] = AttributeValues(
                    ACPROPERTY_BOOL, 
                    ...
                    "0");
                myAllowedAttributes[tag][SUMO_ATTR_HALTING_TIME_THRESHOLD] = AttributeValues(
                    ACPROPERTY_FLOAT | ACPROPERTY_POSITIVE | ACPROPERTY_TIME, 
                    "The time-based threshold that describes how much time has to pass until a vehicle is recognized as halting)", 
                    "1.00");
                myAllowedAttributes[tag][SUMO_ATTR_HALTING_SPEED_THRESHOLD] = AttributeValues(
                    ACPROPERTY_FLOAT | ACPROPERTY_POSITIVE, 
                    "The speed-based threshold that describes how slow a vehicle has to be to be recognized as halting) in m/s", 
                    "1.39");
                myAllowedAttributes[tag][SUMO_ATTR_JAM_DIST_THRESHOLD] = AttributeValues(
                    ACPROPERTY_FLOAT | ACPROPERTY_POSITIVE, 
            ...
            case SUMO_TAG_CALIBRATOR:
                ...
                myAllowedAttributes[tag][SUMO_ATTR_FREQUENCY] = AttributeValues(
                    ...
                    "1.00");
                myAllowedAttributes[tag][SUMO_ATTR_ROUTEPROBE] = AttributeValues(
                    ACPROPERTY_STRING, 
                    "The id of the routeProbe element from which to determine the route distribution for generated vehicles", 
                    "");
                myAllowedAttributes[tag][SUMO_ATTR_OUTPUT] = AttributeValues(
                    ACPROPERTY_STRING | ACPROPERTY_FILENAME, 
            ...
            case SUMO_TAG_REROUTER:
                ...
                myAllowedAttributes[tag][SUMO_ATTR_HALTING_TIME_THRESHOLD] = AttributeValues(
                    ...
                    "0");
                myAllowedAttributes[tag][SUMO_ATTR_OFF] = AttributeValues(
                    ACPROPERTY_BOOL, 
            ...
            case SUMO_TAG_ROUTEPROBE:
                ...
                myAllowedAttributes[tag][SUMO_ATTR_FILE] = AttributeValues(
                    ...
                    "");
                myAllowedAttributes[tag][SUMO_ATTR_BEGIN] = AttributeValues(
                    ACPROPERTY_FLOAT | ACPROPERTY_POSITIVE | ACPROPERTY_TIME, 
            ...
            case SUMO_TAG_VAPORIZER:
                ...
                myAllowedAttributes[tag][SUMO_ATTR_STARTTIME] = AttributeValues(
                    ...
                    "Start Time", 
                    "0");
                myAllowedAttributes[tag][SUMO_ATTR_END] = AttributeValues(
                    ACPROPERTY_FLOAT, 
                    "End Time", 
                    "10.00");
                break;
            ...
            case SUMO_TAG_FLOW:
                ...
                myAllowedAttributes[tag][SUMO_ATTR_TYPE] = AttributeValues(
                    ...
                    "The id of the vehicle type to use for this vehicle", 
                    DEFAULT_VTYPE_ID);
                myAllowedAttributes[tag][SUMO_ATTR_ROUTE] = AttributeValues(
                    ACPROPERTY_STRING, 
                    "The id of the route the vehicle shall drive along", 
                    NODEFAULTVALUE);
                myAllowedAttributes[tag][SUMO_ATTR_VEHSPERHOUR] = AttributeValues(
                    ACPROPERTY_FLOAT | ACPROPERTY_POSITIVE, 
                ...
                myAllowedAttributes[tag][SUMO_ATTR_END] = AttributeValues(
                    ...
                    "100.00");
                myAllowedAttributes[tag][SUMO_ATTR_DEPARTLANE] = AttributeValues(
                    ACPROPERTY_STRING, 
                    "The lane on which the vehicle shall be inserted", 
                    "first");
                myAllowedAttributes[tag][SUMO_ATTR_DEPARTPOS] = AttributeValues(
                    ACPROPERTY_STRING | ACPROPERTY_POSITIVE, 
                    "The position at which the vehicle shall enter the net", 
                    "base");
                myAllowedAttributes[tag][SUMO_ATTR_DEPARTSPEED] = AttributeValues(
                    ACPROPERTY_STRING | ACPROPERTY_POSITIVE, 
                    "The speed with which the vehicle shall enter the network", 
                    "0");
                myAllowedAttributes[tag][SUMO_ATTR_ARRIVALLANE] = AttributeValues(
                    ACPROPERTY_STRING, 
                    "The lane at which the vehicle shall leave the network", 
                    "current");
                myAllowedAttributes[tag][SUMO_ATTR_ARRIVALPOS] = AttributeValues(
                    ACPROPERTY_STRING | ACPROPERTY_POSITIVE, 
                    "The position at which the vehicle shall leave the network", 
                    "max");
                myAllowedAttributes[tag][SUMO_ATTR_ARRIVALSPEED] = AttributeValues(
                    ACPROPERTY_STRING | ACPROPERTY_POSITIVE, 
                    "The speed with which the vehicle shall leave the network", 
                    "current");
                myAllowedAttributes[tag][SUMO_ATTR_LINE] = AttributeValues(
                    ACPROPERTY_STRING, 
                    "A string specifying the id of a public transport line which can be used when specifying person rides", 
                    "");
                myAllowedAttributes[tag][SUMO_ATTR_PERSON_NUMBER] = AttributeValues(
                    ACPROPERTY_INT | ACPROPERTY_POSITIVE,
                    "The number of occupied seats when the vehicle is inserted", 
                    "0");
                myAllowedAttributes[tag][SUMO_ATTR_CONTAINER_NUMBER] = AttributeValues(
                    ACPROPERTY_INT | ACPROPERTY_POSITIVE, 
                    "The number of occupied container places when the vehicle is inserted",  
                    "0");
                myAllowedAttributes[tag][SUMO_ATTR_REROUTE] = AttributeValues(
                    ACPROPERTY_BOOL, 
                    "Whether the vehicle should be equipped with a rerouting device", 
                    "0");
                myAllowedAttributes[tag][SUMO_ATTR_DEPARTPOS_LAT] = AttributeValues(
                    ACPROPERTY_STRING, 
                    "The lateral position on the departure lane at which the vehicle shall enter the net", 
                    "center");
                myAllowedAttributes[tag][SUMO_ATTR_ARRIVALPOS_LAT] = AttributeValues(
                    ACPROPERTY_STRING, 
            ...
            case SUMO_TAG_VTYPE:
                ...
                myAllowedAttributes[tag][SUMO_ATTR_ACCEL] = AttributeValues(
                    ...
                    "2.60");
                myAllowedAttributes[tag][SUMO_ATTR_DECEL] = AttributeValues(
                    ACPROPERTY_FLOAT | ACPROPERTY_POSITIVE, 
                    "The deceleration ability of vehicles of this type [m/s^2]", 
                    "4.50");
                myAllowedAttributes[tag][SUMO_ATTR_SIGMA] = AttributeValues(
                    ACPROPERTY_FLOAT | ACPROPERTY_POSITIVE, 
                    "Car-following model parameter", 
                    "0.50");
                myAllowedAttributes[tag][SUMO_ATTR_TAU] = AttributeValues(
                    ACPROPERTY_FLOAT | ACPROPERTY_POSITIVE, 
                    "Car-following model parameter", 
                    "1.00");
                myAllowedAttributes[tag][SUMO_ATTR_LENGTH] = AttributeValues(
                    ...
                    "5.00");
                myAllowedAttributes[tag][SUMO_ATTR_MINGAP] = AttributeValues(
                    ACPROPERTY_FLOAT | ACPROPERTY_POSITIVE, 
                    "Empty space after leader [m]", 
                    "2.50");
                myAllowedAttributes[tag][SUMO_ATTR_MAXSPEED] = AttributeValues(
                    ACPROPERTY_FLOAT | ACPROPERTY_POSITIVE, 
                    "The vehicle's maximum velocity [m/s]", 
                    "70.00");
                myAllowedAttributes[tag][SUMO_ATTR_SPEEDFACTOR] = AttributeValues(
                    ACPROPERTY_FLOAT | ACPROPERTY_POSITIVE, 
                    "The vehicles expected multiplicator for lane speed limits", 
                    "1.00");
                myAllowedAttributes[tag][SUMO_ATTR_SPEEDDEV] = AttributeValues(
                    ACPROPERTY_STRING, 
                ...
                myAllowedAttributes[tag][SUMO_ATTR_COLOR] = AttributeValues(
                    ...
                    "1,1,0");
                myAllowedAttributes[tag][SUMO_ATTR_VCLASS] = AttributeValues(
                    ACPROPERTY_STRING, 
                    "An abstract vehicle class", 
                    "passenger");
                myAllowedAttributes[tag][SUMO_ATTR_EMISSIONCLASS] = AttributeValues(
                    ACPROPERTY_STRING, 
                    "An abstract emission class", 
                    "P_7_7");
                myAllowedAttributes[tag][SUMO_ATTR_GUISHAPE] = AttributeValues(
                    ACPROPERTY_STRING, 
                ...
                myAllowedAttributes[tag][SUMO_ATTR_IMGFILE] = AttributeValues(
                    ...
                    "");
                myAllowedAttributes[tag][SUMO_ATTR_IMPATIENCE] = AttributeValues(
                    ACPROPERTY_STRING, 
                    "Willingess of drivers to impede vehicles with higher priority", 
                    "0.00");
                myAllowedAttributes[tag][SUMO_ATTR_LANE_CHANGE_MODEL] = AttributeValues(
                    ACPROPERTY_STRING, 
                    "The model used for changing lanes", 
                    "LC2013");
                myAllowedAttributes[tag][SUMO_ATTR_CAR_FOLLOW_MODEL] = AttributeValues(
                    ACPROPERTY_STRING, 
                    "The model used for car following", 
                    "Krauss");
                myAllowedAttributes[tag][SUMO_ATTR_PERSON_CAPACITY] = AttributeValues(
                    ACPROPERTY_INT, 
                    "The number of persons (excluding an autonomous driver) the vehicle can transport", 
                    "4");
                myAllowedAttributes[tag][SUMO_ATTR_CONTAINER_CAPACITY] = AttributeValues(
                    ACPROPERTY_INT | ACPROPERTY_POSITIVE,
                    "The number of containers the vehicle can transport", 
                    "0");
                myAllowedAttributes[tag][SUMO_ATTR_BOARDING_DURATION] = AttributeValues(
                    ACPROPERTY_FLOAT | ACPROPERTY_POSITIVE | ACPROPERTY_TIME, 
                    "The time required by a person to board the vehicle", 
                    "0.50");
                myAllowedAttributes[tag][SUMO_ATTR_LOADING_DURATION] = AttributeValues(
                    ACPROPERTY_FLOAT | ACPROPERTY_POSITIVE | ACPROPERTY_TIME, 
                    "The time required to load a container onto the vehicle", 
                    "90.00");
                myAllowedAttributes[tag][SUMO_ATTR_LATALIGNMENT] = AttributeValues(
                    ACPROPERTY_FLOAT, 
                    "The preferred lateral alignment when using the sublane-model", 
                    "center");
                myAllowedAttributes[tag][SUMO_ATTR_MINGAP_LAT] = AttributeValues(
                    ACPROPERTY_FLOAT | ACPROPERTY_POSITIVE, 
                    "The minimum lateral gap at a speed difference of 50km/h when using the sublane-model", 
                    "0.12");
                myAllowedAttributes[tag][SUMO_ATTR_MAXSPEED_LAT] = AttributeValues(
                    ACPROPERTY_FLOAT | ACPROPERTY_POSITIVE, 
                    "The maximum lateral speed when using the sublane-model", 
                    "1.00");
                break;
            case SUMO_TAG_STEP:
                myAllowedAttributes[tag][SUMO_ATTR_TIME] = AttributeValues(
                    ACPROPERTY_FLOAT | ACPROPERTY_POSITIVE | ACPROPERTY_TIME, 
                    "Time", 
                    NODEFAULTVALUE);
                myAllowedAttributes[tag][SUMO_ATTR_SPEED] = AttributeValues(
