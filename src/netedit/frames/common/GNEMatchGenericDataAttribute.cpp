...
GNEMatchGenericDataAttribute::onCmdHelp(FXObject*, FXSelector, void*) {
    ...
    GUIDesigns::buildFXButton(myHorizontalFrameOKButton, (TL("OK"), "", TL("close")).c_str(), GUIIconSubSys::getIcon(GUIIcon::ACCEPT), additionalNeteditAttributesHelpDialog, FXDialogBox::ID_ACCEPT, GUIDesignButtonOK);
    new FXHorizontalFrame(myHorizontalFrameOKButton, GUIDesignAuxiliarHorizontalFrame);
