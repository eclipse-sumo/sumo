...
/****************************************************************************/
#ifndef GNEFrameHelper_h
#define GNEFrameHelper_h
...
public:
    ...
    class TagSelector : protected FXGroupBox {
        ...
        FXDECLARE(GNEFrameHelper::TagSelector)
    ...
    class DemandElementSelector : protected FXGroupBox {
        /// @brief FOX-declaration
        FXDECLARE(GNEFrameHelper::DemandElementSelector)
    ...
    class EdgePathCreator : protected FXGroupBox {
        /// @brief FOX-declaration
        FXDECLARE(GNEFrameHelper::EdgePathCreator)
    ...
    class AttributesCreatorRow : public FXHorizontalFrame {
        /// @brief FOX-declaration
        FXDECLARE(GNEFrameHelper::AttributesCreatorRow)
    ...
    class AttributesCreator : public FXGroupBox {
        /// @brief FOX-declaration
        FXDECLARE(GNEFrameHelper::AttributesCreator)
    ...
    class AttributesEditorRow : protected FXHorizontalFrame {
        /// @brief FOX-declaration
        FXDECLARE(GNEFrameHelper::AttributesEditorRow)
    ...
    class AttributesEditor : public FXGroupBox {
        /// @brief FOX-declaration
        FXDECLARE(GNEFrameHelper::AttributesEditor)
    ...
    class AttributesEditorExtended : protected FXGroupBox {
        /// @brief FOX-declaration
        FXDECLARE(GNEFrameHelper::AttributesEditorExtended)
    ...
    class AttributeCarrierHierarchy : private FXGroupBox {
        /// @brief FOX-declaration
        FXDECLARE(GNEFrameHelper::AttributeCarrierHierarchy)
    ...
    class GenericParametersEditor : private FXGroupBox {
        /// @brief FOX-declaration
        FXDECLARE(GNEFrameHelper::GenericParametersEditor)
    ...
    class DrawingShape : private FXGroupBox {
        /// @brief FOX-declaration
        FXDECLARE(GNEFrameHelper::DrawingShape)
    ...
    class NeteditAttributes : protected FXGroupBox {
        /// @brief FOX-declaration
        FXDECLARE(GNEFrameHelper::NeteditAttributes)
