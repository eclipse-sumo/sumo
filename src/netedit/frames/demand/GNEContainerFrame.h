...
private:
    ...
    GNEFrameAttributesModuls::AttributesCreator* myContainerAttributes;
    ...
    /// @brief build container and return it (note: function includes a call to begin(...), but NOT a call to p_end(...))
