...
GNEFlowEditor::GNEFlowEditor(GNEViewNet* viewNet, GNEFrame* frameParent) :
    ...
    myTerminateComboBox = new MFXComboBoxIcon(auxiliarHorizontalFrame, GUIDesignComboBoxNCol, false, false, 10, this,
    ...
    mySpacingComboBox = new MFXComboBoxIcon(mySpacingFrameComboBox, GUIDesignComboBoxNCol, false, false, 10, this,
                                            MID_GNE_SET_ATTRIBUTE, GUIDesignComboBoxAttribute);
