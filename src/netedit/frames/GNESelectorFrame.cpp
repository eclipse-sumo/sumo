...
GNESelectorFrame::MatchAttribute::onCmdSelMBAttribute(FXObject*, FXSelector, void*) {
    ...
    extraAttrProperty = GNEAttributeCarrier::AttributeProperties(GNE_ATTR_GENERIC, GNEAttributeCarrier::AttrProperty::ATTRPROPERTY_STRING, "Generic Parameters");
    ...
    if (tagValue.canBlockMovement()) {
        ...
        extraAttrProperty = GNEAttributeCarrier::AttributeProperties(GNE_ATTR_BLOCK_MOVEMENT, GNEAttributeCarrier::AttrProperty::ATTRPROPERTY_BOOL, "Block movement", "false");
        tagPropertiesCopy.addAttribute(extraAttrProperty);
    }
    ...
    if (tagValue.canBlockShape()) {
        ...
        extraAttrProperty = GNEAttributeCarrier::AttributeProperties(GNE_ATTR_BLOCK_SHAPE, GNEAttributeCarrier::AttrProperty::ATTRPROPERTY_BOOL, "Block shape", "false");
        tagPropertiesCopy.addAttribute(extraAttrProperty);
    }
    ...
    if (tagValue.canCloseShape()) {
        ...
        extraAttrProperty = GNEAttributeCarrier::AttributeProperties(GNE_ATTR_CLOSE_SHAPE, GNEAttributeCarrier::AttrProperty::ATTRPROPERTY_BOOL, "Close shape", "true");
        tagPropertiesCopy.addAttribute(extraAttrProperty);
    }
    // add extra attribute if item can have parent
    if (tagValue.hasParent()) {
        // add an extra AttributeValues to allow select ACs using as criterium "parent"
        extraAttrProperty = GNEAttributeCarrier::AttributeProperties(GNE_ATTR_PARENT, GNEAttributeCarrier::AttrProperty::ATTRPROPERTY_STRING, "Parent element");
        tagPropertiesCopy.addAttribute(extraAttrProperty);
    }
