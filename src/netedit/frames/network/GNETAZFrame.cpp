...
GNETAZFrame::TAZSaveChanges::TAZSaveChanges(GNETAZFrame* TAZFrameParent) :
    ...
    mySaveChangesButton = new FXButton(this, "Save changes", GUIIconSubSys::getIcon(GUIIcon::SAVE), this, MID_OK, GUIDesignButton);
...
GNETAZFrame::shapeDrawed() {
    ...
    if (!myTAZParameters->isCurrentParametersValid()) {
        ...
        return GNEAdditionalHandler::buildAdditional(myViewNet, true, SUMO_TAG_TAZ, SUMOSAXAttrs, nullptr);
    }
}
