...
GNEMeanDataFrame::MeanDataTypeSelector::MeanDataTypeSelector(GNEMeanDataFrame* meanDataFrameParent) :
    ...
    // add mean data types
    const auto tagPropertiesMeanDatas = myMeanDataFrameParent->getViewNet()->getTagPropertiesDatabase()->getTagPropertiesByType(GNETagProperties::MEANDATA, false);
...
GNEMeanDataFrame::GNEMeanDataFrame(GNEViewParent* viewParent, GNEViewNet* viewNet) :
    ...
    myMeanDataAttributesEditor = new GNEAttributesEditor(this, TL("Attributes"), GNEAttributesEditor::EditorOptions::BASIC_ATTRIBUTES);
}
