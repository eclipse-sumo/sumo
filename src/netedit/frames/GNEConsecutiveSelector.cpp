...
GNEConsecutiveSelector::drawTemporalConsecutiveLanePath(const GUIVisualizationSettings& s) const {
    ...
    if (myLanePath.size() > 0) {
        ...
        GUIGeometry::drawGeometryPoints(s, GUIVisualizationSettings::DetailLevel::Level1, nullptr, myFrameParent->getViewNet()->getPositionInformation(), {firstPosition, secondPosition},
