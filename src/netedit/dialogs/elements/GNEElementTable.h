...
/****************************************************************************/
#ifndef GNEElementTable_h
#define GNEElementTable_h
#include <config.h>
...
class GNEElementTable : public FXHorizontalFrame {
    /// @brief fox declaration
    FXDECLARE(GNEElementTable)

public:
    /// @brief constructor (Exactly like the FXButton constructor)
    GNEElementTable(GNETLSEditorFrame::TLSPhases* TLSPhasesParent);
...
protected:
    ...
    public:
        ...
        Cell(GNEElementTable* TLSTable, MFXTextFieldTooltip* textField, int col, int row);

        /// @brief constructor for index label
        Cell(GNEElementTable* TLSTable, FXLabel* indexLabel, FXLabel* indexLabelBold, int col, int row);

        /// @brief constructor for buttons
        Cell(GNEElementTable* TLSTable, MFXButtonTooltip* button, int col, int row);

        /// @brief constructor for menu buttons
        Cell(GNEElementTable* TLSTable, int col, int row);
    ...
    private:
        ...
        GNEElementTable* myTLSTable = nullptr;
    ...
    public:
        /// @brief constructor
        Column(GNEElementTable* table, const int index, const char type);
