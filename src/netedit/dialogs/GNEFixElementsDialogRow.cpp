...
FXDEFMAP(GNEFixElementsDialogRow) GNEFixElementsDialogRowMap[] = {
    FXMAPFUNC(SEL_COMMAND,  MID_CHOOSEN_OPERATION,  GNEFixElementsDialogRow::onCmdSelectOption),
    FXMAPFUNC(SEL_COMMAND,  MID_GNE_BUTTON_ACCEPT,  GNEFixElementsDialogRow::onCmdAccept),
    FXMAPFUNC(SEL_COMMAND,  MID_GNE_BUTTON_CANCEL,  GNEFixElementsDialogRow::onCmdCancel),
};

// Object implementation
FXIMPLEMENT(GNEFixElementsDialogRow, FXDialogBox, GNEFixElementsDialogRowMap, ARRAYNUMBER(GNEFixElementsDialogRowMap))

// ===========================================================================
// member method definitions
// ===========================================================================

GNEFixElementsDialogRow::GNEFixElementsDialogRow(GNEViewNet* viewNet, const std::vector<GNEAdditional*>& invalidSingleLaneAdditionals, const std::vector<GNEAdditional*>& invalidMultiLaneAdditionals) :
...
long
GNEFixElementsDialogRow::onCmdSelectOption(FXObject* obj, FXSelector, void*) {
...
long
GNEFixElementsDialogRow::onCmdAccept(FXObject*, FXSelector, void*) {
...
long
GNEFixElementsDialogRow::onCmdCancel(FXObject*, FXSelector, void*) {
...
GNEFixElementsDialogRow::AdditionalList::AdditionalList(GNEFixElementsDialogRow* fixAdditionalPositions, const std::vector<GNEAdditional*>& invalidSingleLaneAdditionals, const std::vector<GNEAdditional*>& invalidMultiLaneAdditionals) :
...
// ---------------------------------------------------------------------------
// GNEFixElementsDialogRow::PositionOptions - methods
// ---------------------------------------------------------------------------

GNEFixElementsDialogRow::PositionOptions::PositionOptions(GNEFixElementsDialogRow* fixAdditionalPositions) :
...
void
GNEFixElementsDialogRow::PositionOptions::selectOption(FXObject* option) {
...
void
GNEFixElementsDialogRow::PositionOptions::enablePositionOptions() {
...
void
GNEFixElementsDialogRow::PositionOptions::disablePositionOptions() {
...
// ---------------------------------------------------------------------------
// GNEFixElementsDialogRow::ConsecutiveLaneOptions - methods
// ---------------------------------------------------------------------------

GNEFixElementsDialogRow::ConsecutiveLaneOptions::ConsecutiveLaneOptions(GNEFixElementsDialogRow* fixAdditionalPositions) :
...
void
GNEFixElementsDialogRow::ConsecutiveLaneOptions::selectOption(FXObject* option) {
    // set top buttons
...
void
GNEFixElementsDialogRow::ConsecutiveLaneOptions::enableConsecutiveLaneOptions() {
...
void
GNEFixElementsDialogRow::ConsecutiveLaneOptions::disableConsecutiveLaneOptions() {
