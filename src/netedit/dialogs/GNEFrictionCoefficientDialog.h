...
/****************************************************************************/
/// @file    GNEFrictionCoefficientDialog.h
/// @author  Pablo Alvarez Lopez
/// @date    April 2016
///
// A class for edit phases of Variable Friction Signals
/****************************************************************************/
#pragma once
#include <config.h>
 ...
 */
class GNEFrictionCoefficientDialog : public GNEAdditionalDialog {
    /// @brief FOX-declaration
    FXDECLARE(GNEFrictionCoefficientDialog)

public:
    /// @brief constructor
    GNEFrictionCoefficientDialog(GNEFrictionCoefficient* editedFrictionCoefficient);

    /// @brief destructor
    ~GNEFrictionCoefficientDialog();
...
protected:
    FOX_CONSTRUCTOR(GNEFrictionCoefficientDialog)
...
private:
    ...
    GNEFrictionCoefficientDialog(const GNEFrictionCoefficientDialog&) = delete;

    /// @brief Invalidated assignment operator.
    GNEFrictionCoefficientDialog& operator=(const GNEFrictionCoefficientDialog&) = delete;
};
