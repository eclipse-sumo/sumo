...
GNETagPropertiesDatabase::fillNetworkElements() {
    ...
    SumoXMLTag currentTag = SUMO_TAG_JUNCTION;
    {
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_POSITION,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_TYPE,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_SHAPE,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_RADIUS,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_KEEP_CLEAR,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_RIGHT_OF_WAY,
                GNEAttributeProperties::STRING | GNEAttributeProperties::DISCRETE | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_FRINGE,
                GNEAttributeProperties::STRING | GNEAttributeProperties::DISCRETE | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_TLTYPE,
                GNEAttributeProperties::STRING | GNEAttributeProperties::DISCRETE | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("An optional type for the traffic light algorithm"));
        attrProperty->setDiscreteValues(TLTypes);

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_TLLAYOUT,
                GNEAttributeProperties::STRING | GNEAttributeProperties::DISCRETE | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_TLID,
                GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("An optional id for the traffic light program"));

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], GNE_ATTR_IS_ROUNDABOUT,
                GNEAttributeProperties::BOOL | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
    ...
    currentTag = SUMO_TAG_TYPE;
    {
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_NUMLANES,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_ALLOW,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_DISALLOW,
                GNEAttributeProperties::VCLASS | GNEAttributeProperties::LIST | GNEAttributeProperties::DEFAULTVALUE | GNEAttributeProperties::COPYABLE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("Explicitly disallows the given vehicle classes (not given will be allowed)"));

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_SPREADTYPE,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_PRIORITY,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_SIDEWALKWIDTH,
                GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE | GNEAttributeProperties::COPYABLE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("The width of the sidewalk that should be added as an additional lane"),
                "default");

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_BIKELANEWIDTH,
                GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE | GNEAttributeProperties::COPYABLE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
    ...
    currentTag = SUMO_TAG_EDGE;
    {
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_FROM,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_TO,
                GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE | GNEAttributeProperties::UPDATEGEOMETRY,
                GNEAttributeProperties::EDITMODE,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_LENGTH,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_NAME,
                GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE | GNEAttributeProperties::COPYABLE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_ENDOFFSET,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE | GNEAttributeProperties::UPDATEGEOMETRY,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("Move the stop line back from the intersection by the given amount"),
                "0.00");

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], GNE_ATTR_SHAPE_START,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], GNE_ATTR_SHAPE_END,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], GNE_ATTR_BIDIR,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_DISTANCE,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::DEFAULTVALUE | GNEAttributeProperties::UNIQUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("Distance"),
                "0.00");

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], GNE_ATTR_STOPOFFSET,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE | GNEAttributeProperties::UPDATEGEOMETRY,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("The stop offset as positive value in meters"),
                "0.00");

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], GNE_ATTR_STOPOEXCEPTION,
    ...
    currentTag = SUMO_TAG_LANE;
    {
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_INDEX,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_ACCELERATION,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_CUSTOMSHAPE,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], GNE_ATTR_OPPOSITE,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_CHANGE_LEFT,
                GNEAttributeProperties::VCLASS | GNEAttributeProperties::LIST | GNEAttributeProperties::DEFAULTVALUE | GNEAttributeProperties::COPYABLE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("Permit changing left only for to the given vehicle classes"),
                "all");

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_CHANGE_RIGHT,
                GNEAttributeProperties::VCLASS | GNEAttributeProperties::LIST | GNEAttributeProperties::DEFAULTVALUE | GNEAttributeProperties::COPYABLE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
    ...
    currentTag = SUMO_TAG_CROSSING;
    {
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_EDGES,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_TLLINKINDEX,
                GNEAttributeProperties::INT | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("sets the tls-index for this crossing"),
                "-1");

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_TLLINKINDEX2,
                GNEAttributeProperties::INT | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
    ...
    currentTag = SUMO_TAG_CONNECTION;
    {
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_FROM_LANE,
                GNEAttributeProperties::INT | GNEAttributeProperties::UNIQUE | GNEAttributeProperties::UPDATEGEOMETRY,
                GNEAttributeProperties::EDITMODE,
                TL("the lane index of the incoming lane (numbers starting with 0)"));

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_TO_LANE,
                GNEAttributeProperties::INT | GNEAttributeProperties::UNIQUE | GNEAttributeProperties::UPDATEGEOMETRY,
                GNEAttributeProperties::EDITMODE,
                TL("the lane index of the outgoing lane (numbers starting with 0)"));

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_PASS,
                GNEAttributeProperties::BOOL | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_CONTPOS,
                ...
                "default", toString(NBEdge::UNSPECIFIED_CONTPOS));

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_UNCONTROLLED,
                GNEAttributeProperties::BOOL | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("If set to true, This connection will not be TLS-controlled despite its node being controlled"),
                GNEAttributeCarrier::False);

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_VISIBILITY_DISTANCE,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("Vision distance between vehicles"),
                "default", toString(NBEdge::UNSPECIFIED_VISIBILITY_DISTANCE));
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_SPEED,
                ...
                "default", toString(NBEdge::UNSPECIFIED_SPEED));

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_LENGTH,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("sets custom length for the connection"),
                "default", toString(NBEdge::UNSPECIFIED_LOADED_LENGTH));
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_INDIRECT,
                GNEAttributeProperties::BOOL | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_DIR,
                GNEAttributeProperties::STRING,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("turning direction for this connection (computed)"));

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_STATE,
                GNEAttributeProperties::STRING,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
...
GNETagPropertiesDatabase::fillAdditionalElements() {
    ...
    SumoXMLTag currentTag = SUMO_TAG_BUS_STOP;
    {
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_LINES,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_PERSON_CAPACITY,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_PARKING_LENGTH,
    ...
    currentTag = SUMO_TAG_CONTAINER_STOP;
    {
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_CONTAINER_CAPACITY,
                GNEAttributeProperties::INT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
    ...
    currentTag = SUMO_TAG_CHARGING_STATION;
    {
        ...
        // set specific attributes
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_CHARGINGPOWER,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("Charging power in W"),
                "22000.00");

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_EFFICIENCY,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_CHARGEINTRANSIT,
                GNEAttributeProperties::BOOL | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("Enable or disable charge in transit, i.e. vehicle must or must not to stop for charging"),
                GNEAttributeCarrier::False);

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_CHARGEDELAY,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_CHARGETYPE,
                GNEAttributeProperties::STRING | GNEAttributeProperties::DISCRETE | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_WAITINGTIME,
                GNEAttributeProperties::SUMOTIME | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("Waiting time before start charging"),
                "900.00");

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_PARKING_AREA,
    ...
    currentTag = SUMO_TAG_PARKING_AREA;
    {
        ...
        // set specific attributes
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_DEPARTPOS,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_ACCEPTED_BADGES,
                GNEAttributeProperties::STRING | GNEAttributeProperties::LIST | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("Accepted badges to access this parkingArea"));

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_ROADSIDE_CAPACITY,
                GNEAttributeProperties::INT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL(" The number of parking spaces for road-side parking"),
                "0");

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_ONROAD,
                GNEAttributeProperties::BOOL | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_WIDTH,
                ...
                "default", toString(SUMO_const_laneWidth));
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_ANGLE,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_LEFTHAND,
                GNEAttributeProperties::BOOL | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
    ...
    currentTag = SUMO_TAG_PARKING_SPACE;
    {
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_SLOPE,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::ANGLE | GNEAttributeProperties::DEFAULTVALUE | GNEAttributeProperties::UPDATEGEOMETRY,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
    ...
    currentTag = SUMO_TAG_INDUCTION_LOOP;
    {
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_PERIOD,
                GNEAttributeProperties::SUMOTIME | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_NEXT_EDGES,
                GNEAttributeProperties::STRING | GNEAttributeProperties::LIST | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("List of edge ids that must all be part of the future route of the vehicle to qualify for detection"));

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_DETECT_PERSONS,
                GNEAttributeProperties::STRING | GNEAttributeProperties::DISCRETE | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
    ...
    currentTag = SUMO_TAG_LANE_AREA_DETECTOR;
    {
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_HALTING_TIME_THRESHOLD,
                GNEAttributeProperties::SUMOTIME | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("The time-based threshold that describes how much time has to pass until a vehicle is recognized as halting)"),
                "1.00");

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_HALTING_SPEED_THRESHOLD,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("The speed-based threshold that describes how slow a vehicle has to be to be recognized as halting) in m/s"),
                "1.39");

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_JAM_DIST_THRESHOLD,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_SHOW_DETECTOR,
                GNEAttributeProperties::BOOL | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
    ...
    currentTag = GNE_TAG_MULTI_LANE_AREA_DETECTOR;
    {
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_LANES,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_ENDPOS,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::UNIQUE | GNEAttributeProperties::UPDATEGEOMETRY,
                GNEAttributeProperties::EDITMODE,
    ...
    currentTag = SUMO_TAG_ENTRY_EXIT_DETECTOR;
    {
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_OPEN_ENTRY,
                GNEAttributeProperties::BOOL | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_EXPECT_ARRIVAL,
                GNEAttributeProperties::BOOL | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
    ...
    currentTag = SUMO_TAG_ROUTEPROBE;
    {
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_EDGE,
                GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE | GNEAttributeProperties::UPDATEGEOMETRY,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_BEGIN,
                GNEAttributeProperties::SUMOTIME | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
    ...
    currentTag = SUMO_TAG_STEP;
    {
        ...
        {SUMO_TAG_VSS}, FXRGBA(210, 233, 255, 255));
        // set values of attributes
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_TIME,
    ...
    currentTag = SUMO_TAG_CALIBRATOR;
    {
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_ROUTEPROBE,
                GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("The id of the routeProbe element from which to determine the route distribution for generated vehicles"));

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_OUTPUT,
    ...
    currentTag = GNE_TAG_CALIBRATOR_FLOW;
    {
        ...
        // set values of attributes
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_ROUTE,
                GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE | GNEAttributeProperties::UPDATEGEOMETRY,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_END,
                GNEAttributeProperties::SUMOTIME | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
    ...
    currentTag = SUMO_TAG_REROUTER;
    {
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_OFF,
                GNEAttributeProperties::BOOL | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("Whether the router should be inactive initially (and switched on in the gui)"),
                GNEAttributeCarrier::False);

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_OPTIONAL,
                GNEAttributeProperties::BOOL | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
    ...
    currentTag = SUMO_TAG_PARKING_AREA_REROUTE;
    {
        ...
        {SUMO_TAG_INTERVAL}, FXRGBA(255, 213, 213, 255));
        // set values of attributes
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_PARKING,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_VISIBLE,
                GNEAttributeProperties::BOOL | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
...
GNETagPropertiesDatabase::fillShapeElements() {
    ...
    SumoXMLTag currentTag = SUMO_TAG_POLY;
    {
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_COLOR,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_FILL,
                GNEAttributeProperties::BOOL | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("An information whether the polygon shall be filled"),
                GNEAttributeCarrier::False);

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_LINEWIDTH,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("The default line width for drawing an unfilled polygon"),
                "default", "1");

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_LAYER,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("The layer in which the polygon lies"),
                "default", toString(Shape::DEFAULT_LAYER));

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_TYPE,
                GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("A typename for the polygon"),
                "default", toString(Shape::DEFAULT_TYPE));
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_ANGLE,
                ...
                "default", toString(Shape::DEFAULT_ANGLE));

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_GEO,
                GNEAttributeProperties::BOOL | GNEAttributeProperties::DEFAULTVALUE,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_GEOSHAPE,
                GNEAttributeProperties::STRING | GNEAttributeProperties::POSITION | GNEAttributeProperties::LIST | GNEAttributeProperties::UNIQUE | GNEAttributeProperties::DEFAULTVALUE | GNEAttributeProperties::UPDATEGEOMETRY,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE | GNEAttributeProperties::GEOEDITOR,
                TL("A custom geo shape for this polygon"));

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], GNE_ATTR_CLOSE_SHAPE,
    ...
    currentTag = GNE_TAG_POILANE;
    {
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_POSITION_LAT,
    ...
    currentTag = GNE_TAG_POIGEO;
    {
        ...
        // set values of attributes
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_LON,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::UNIQUE | GNEAttributeProperties::UPDATEGEOMETRY,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE | GNEAttributeProperties::GEOEDITOR,
                TL("The longitude position of the parking vehicle on the view"));

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_LAT,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::UNIQUE | GNEAttributeProperties::UPDATEGEOMETRY,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE | GNEAttributeProperties::GEOEDITOR,
...
GNETagPropertiesDatabase::fillTAZElements() {
    ...
    SumoXMLTag currentTag = SUMO_TAG_TAZ;
    {
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_CENTER,
    ...
    currentTag = SUMO_TAG_TAZSOURCE;
    {
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_WEIGHT,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
...
GNETagPropertiesDatabase::fillWireElements() {
    ...
    SumoXMLTag currentTag = SUMO_TAG_TRACTION_SUBSTATION;
    {
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_VOLTAGE,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("Voltage of at connection point for the overhead wire"),
                "600.00");

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_CURRENTLIMIT,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
    ...
    currentTag = SUMO_TAG_OVERHEAD_WIRE_SECTION;
    {
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_SUBSTATIONID,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_STARTPOS,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_OVERHEAD_WIRE_FORBIDDEN,
    ...
    currentTag = SUMO_TAG_OVERHEAD_WIRE_CLAMP;
    {
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_OVERHEAD_WIRECLAMP_START,
                GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("ID of the overhead wire segment, to the start of which the overhead wire clamp is connected"));

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_OVERHEAD_WIRECLAMP_LANESTART,
                GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("ID of the overhead wire segment lane of overheadWireIDStartClamp"));

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_OVERHEAD_WIRECLAMP_END,
                GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("ID of the overhead wire segment, to the end of which the overhead wire clamp is connected"));

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_OVERHEAD_WIRECLAMP_LANEEND,
                GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
...
GNETagPropertiesDatabase::fillDemandElements() {
    ...
    SumoXMLTag currentTag = SUMO_TAG_ROUTE;
    {
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], GNE_ATTR_ROUTE_DISTRIBUTION,
                GNEAttributeProperties::STRING,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_REPEAT,
                GNEAttributeProperties::INT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("The number of times that the edges of this route shall be repeated"),
                "0");

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_CYCLETIME,
                GNEAttributeProperties::SUMOTIME | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
    ...
    currentTag = SUMO_TAG_VTYPE;
    {
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], GNE_ATTR_VTYPE_DISTRIBUTION,
                GNEAttributeProperties::STRING,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("Type distribution"));

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_VCLASS,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_MINGAP,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::ALWAYSENABLED,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("Empty space after leader [m]"));

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_MAXSPEED,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::ALWAYSENABLED,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("The vehicle's maximum velocity [m/s]"));

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_SPEEDFACTOR,
                GNEAttributeProperties::STRING,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_DESIRED_MAXSPEED,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::ALWAYSENABLED,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_EMISSIONCLASS,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_GUISHAPE,
                GNEAttributeProperties::STRING | GNEAttributeProperties::DISCRETE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE | GNEAttributeProperties::EXTENDEDEDITOR,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_HEIGHT,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE | GNEAttributeProperties::EXTENDEDEDITOR,
                TL("The vehicle's height [m] (only used for drawing)"),
                "1.5");

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_PARKING_BADGES,
                GNEAttributeProperties::STRING | GNEAttributeProperties::LIST | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_LANE_CHANGE_MODEL,
                GNEAttributeProperties::STRING | GNEAttributeProperties::DISCRETE | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE | GNEAttributeProperties::EXTENDEDEDITOR,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_CAR_FOLLOW_MODEL,
                GNEAttributeProperties::STRING | GNEAttributeProperties::DISCRETE | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE | GNEAttributeProperties::EXTENDEDEDITOR,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_BOARDING_DURATION,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE | GNEAttributeProperties::EXTENDEDEDITOR,
                TL("The time required by a person to board the vehicle"),
                "0.50");

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_LOADING_DURATION,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE | GNEAttributeProperties::EXTENDEDEDITOR,
                TL("The time required to load a container onto the vehicle"),
                "90.00");

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_LATALIGNMENT,
                GNEAttributeProperties::STRING | GNEAttributeProperties::DISCRETE | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE | GNEAttributeProperties::EXTENDEDEDITOR,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_MINGAP_LAT,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE | GNEAttributeProperties::EXTENDEDEDITOR,
                TL("The minimum lateral gap at a speed difference of 50km/h when using the sublane-model"),
                "0.12");

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_MAXSPEED_LAT,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE | GNEAttributeProperties::EXTENDEDEDITOR,
                TL("The maximum lateral speed when using the sublane-model"),
                "1.00");

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_ACTIONSTEPLENGTH,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE | GNEAttributeProperties::EXTENDEDEDITOR,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_OSGFILE,
                GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE | GNEAttributeProperties::EXTENDEDEDITOR,
                TL("3D model file for this class"));

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_CARRIAGE_LENGTH,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE | GNEAttributeProperties::EXTENDEDEDITOR,
                TL("Carriage lengths"));

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_LOCOMOTIVE_LENGTH,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE | GNEAttributeProperties::EXTENDEDEDITOR,
                TL("Locomotive lengths"));

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_CARRIAGE_GAP,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE | GNEAttributeProperties::EXTENDEDEDITOR,
...
GNETagPropertiesDatabase::fillVehicleElements() {
    ...
    SumoXMLTag currentTag = SUMO_TAG_TRIP;
    {
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_VIA,
    ...
    currentTag = GNE_TAG_TRIP_JUNCTIONS;
    {
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_FROM_JUNCTION,
                GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE | GNEAttributeProperties::UPDATEGEOMETRY,
                GNEAttributeProperties::EDITMODE,
                TL("The name of the junction the trip starts at"));

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_TO_JUNCTION,
                GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE | GNEAttributeProperties::UPDATEGEOMETRY,
                GNEAttributeProperties::EDITMODE,
    ...
    currentTag = GNE_TAG_TRIP_TAZS;
    {
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_FROM_TAZ,
                GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE | GNEAttributeProperties::UPDATEGEOMETRY,
                GNEAttributeProperties::EDITMODE,
                TL("The name of the TAZ the trip starts at"));

        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_TO_TAZ,
                GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE | GNEAttributeProperties::UPDATEGEOMETRY,
                GNEAttributeProperties::EDITMODE,
    ...
    currentTag = SUMO_TAG_VEHICLE;
    {
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_DEPARTEDGE,
        ...
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_ARRIVALEDGE,
                GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE | GNEAttributeProperties::UPDATEGEOMETRY | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::EDITMODE,
...
GNETagPropertiesDatabase::fillStopElements() {
    ...
    SumoXMLTag currentTag = GNE_TAG_STOP_LANE;
    {
        ...
        /*
            // netedit attributes
            attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], GNE_ATTR_SIZE,
            ...
            attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], GNE_ATTR_FORCESIZE,
            ...
            attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], GNE_ATTR_REFERENCE,
    ...
    currentTag = GNE_TAG_STOP_BUSSTOP;
    {
        ...
        {SUMO_TAG_ROUTE, SUMO_TAG_TRIP, SUMO_TAG_FLOW}, FXRGBA(255, 213, 213, 255));
        // set values of attributes
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_BUS_STOP,
                GNEAttributeProperties::STRING | GNEAttributeProperties::LIST | GNEAttributeProperties::UNIQUE | GNEAttributeProperties::UPDATEGEOMETRY,
                GNEAttributeProperties::EDITMODE,
    ...
    currentTag = GNE_TAG_STOP_TRAINSTOP;
    {
        ...
        {SUMO_TAG_ROUTE, SUMO_TAG_TRIP, SUMO_TAG_FLOW}, FXRGBA(255, 213, 213, 255));
        // set values of attributes
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_TRAIN_STOP,
                GNEAttributeProperties::STRING | GNEAttributeProperties::LIST | GNEAttributeProperties::UNIQUE | GNEAttributeProperties::UPDATEGEOMETRY,
                GNEAttributeProperties::EDITMODE,
    ...
    currentTag = GNE_TAG_STOP_CONTAINERSTOP;
    {
        ...
        {SUMO_TAG_ROUTE, SUMO_TAG_TRIP, SUMO_TAG_FLOW}, FXRGBA(255, 213, 213, 255));
        // set values of attributes
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_CONTAINER_STOP,
                GNEAttributeProperties::STRING | GNEAttributeProperties::LIST | GNEAttributeProperties::UNIQUE | GNEAttributeProperties::UPDATEGEOMETRY,
                GNEAttributeProperties::EDITMODE,
    ...
    currentTag = GNE_TAG_STOP_CHARGINGSTATION;
    {
        ...
        {SUMO_TAG_ROUTE, SUMO_TAG_TRIP, SUMO_TAG_FLOW}, FXRGBA(255, 213, 213, 255));
        // set values of attributes
        attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], SUMO_ATTR_CHARGING_STATION,
                GNEAttributeProperties::STRING | GNEAttributeProperties::LIST | GNEAttributeProperties::UNIQUE | GNEAttributeProperties::UPDATEGEOMETRY,
                GNEAttributeProperties::EDITMODE,
...
GNETagPropertiesDatabase::fillCommonAttributes(GNETagProperties* tagProperties) {
    ...
    /*
    attrProperty = new GNEAttributeProperties(myTagProperties[currentTag], relativePath,
            GNEAttributeProperties::BOOL | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
...
GNETagPropertiesDatabase::fillCommonStoppingPlaceAttributes(GNETagProperties* tagProperties, const bool includeColor) {
    ...
    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_STARTPOS,
            GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE | GNEAttributeProperties::DEFAULTVALUE | GNEAttributeProperties::UPDATEGEOMETRY,
            GNEAttributeProperties::EDITMODE,
            TL("The begin position on the lane (the lower position on the lane) in meters"));

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_ENDPOS,
            GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE | GNEAttributeProperties::DEFAULTVALUE | GNEAttributeProperties::UPDATEGEOMETRY,
            GNEAttributeProperties::EDITMODE,
            TL("The end position on the lane (the higher position on the lane) in meters, must be larger than startPos by more than 0.1m"));
    ...
    if (includeColor) {
        attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_COLOR,
                GNEAttributeProperties::STRING | GNEAttributeProperties::COLOR | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
    ...
    // netedit attributes
    attrProperty = new GNEAttributeProperties(tagProperties, GNE_ATTR_SIZE,
    ...
    attrProperty = new GNEAttributeProperties(tagProperties, GNE_ATTR_FORCESIZE,
            GNEAttributeProperties::BOOL | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE | GNEAttributeProperties::NETEDITEDITOR,
            TL("Force size during creation"),
            GNEAttributeCarrier::False);

    attrProperty = new GNEAttributeProperties(tagProperties, GNE_ATTR_REFERENCE,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DISCRETE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE | GNEAttributeProperties::NETEDITEDITOR,
...
GNETagPropertiesDatabase::fillCommonPOIAttributes(GNETagProperties* tagProperties) {
    ...
    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_TYPE,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("A typename for the POI"),
            "default", toString(Shape::DEFAULT_TYPE));

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_ICON,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DISCRETE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("POI Icon"),
    ...
    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_LAYER,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("The layer of the POI for drawing and selecting"),
            "default", toString(Shape::DEFAULT_LAYER_POI));

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_WIDTH,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("Width of rendered image in meters"),
            "default", toString(Shape::DEFAULT_IMG_WIDTH));

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_HEIGHT,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("Height of rendered image in meters"),
            "default", toString(Shape::DEFAULT_IMG_HEIGHT));

    fillImgFileAttribute(tagProperties);

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_ANGLE,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::ANGLE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("Angle of rendered image in degree"),
            "default", toString(Shape::DEFAULT_ANGLE));
...
GNETagPropertiesDatabase::fillCommonVehicleAttributes(GNETagProperties* tagProperties) {
    ...
    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_DEPARTLANE,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE |  GNEAttributeProperties::UPDATEGEOMETRY,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("The lane on which the vehicle shall be inserted"),
            "first");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_DEPARTPOS,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE |  GNEAttributeProperties::UPDATEGEOMETRY,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("The position at which the vehicle shall enter the net"),
            "base");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_DEPARTSPEED,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("The speed with which the vehicle shall enter the network"),
            "0.00");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_ARRIVALLANE,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE |  GNEAttributeProperties::UPDATEGEOMETRY,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("The lane at which the vehicle shall leave the network"),
            "current");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_ARRIVALPOS,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE |  GNEAttributeProperties::UPDATEGEOMETRY,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("The position at which the vehicle shall leave the network"),
            "max");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_ARRIVALSPEED,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("The speed with which the vehicle shall leave the network"),
            "current");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_LINE,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("A string specifying the id of a public transport line which can be used when specifying person rides"));

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_PERSON_NUMBER,
            GNEAttributeProperties::INT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("The number of occupied seats when the vehicle is inserted"),
            "0");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CONTAINER_NUMBER,
            GNEAttributeProperties::INT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("The number of occupied container places when the vehicle is inserted"),
            "0");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_DEPARTPOS_LAT,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE |  GNEAttributeProperties::UPDATEGEOMETRY,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("The lateral position on the departure lane at which the vehicle shall enter the net"),
            "center");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_ARRIVALPOS_LAT,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE |  GNEAttributeProperties::UPDATEGEOMETRY,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("The lateral position on the arrival lane at which the vehicle shall arrive"),
            "center");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_INSERTIONCHECKS,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("Insertion checks"),
...
GNETagPropertiesDatabase::fillCommonFlowAttributes(GNETagProperties* tagProperties, SumoXMLAttr perHour) {
    ...
    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_BEGIN,
            GNEAttributeProperties::SUMOTIME | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("First flow departure time"),
            "0");

    attrProperty = new GNEAttributeProperties(tagProperties, GNE_ATTR_FLOW_TERMINATE,
    ...
    attrProperty = new GNEAttributeProperties(tagProperties, GNE_ATTR_FLOW_SPACING,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DISCRETE | GNEAttributeProperties::DEFAULTVALUE | GNEAttributeProperties::FLOW,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE | GNEAttributeProperties::FLOWEDITOR,
    ...
    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_END,
            GNEAttributeProperties::SUMOTIME | GNEAttributeProperties::DEFAULTVALUE | GNEAttributeProperties::FLOW,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE | GNEAttributeProperties::FLOWEDITOR,
            TL("End of departure interval"),
            "3600");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_NUMBER,
...
GNETagPropertiesDatabase::fillCarFollowingModelAttributes(GNETagProperties* tagProperties) {
    GNEAttributeProperties* attrProperty = nullptr;
    // fill CFM attributes
    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_ACCEL,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("The acceleration ability of vehicles of this type [m/s^2]"),
            toString(SUMOVTypeParameter::getDefaultAccel()));

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_DECEL,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("The deceleration ability of vehicles of this type [m/s^2]"),
            toString(SUMOVTypeParameter::getDefaultDecel()));

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_APPARENTDECEL,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("The apparent deceleration of the vehicle as used by the standard model [m/s^2]"),
            toString(SUMOVTypeParameter::getDefaultDecel()));

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_EMERGENCYDECEL,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE | GNEAttributeProperties::EXTENDEDEDITOR,
    ...
    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_SIGMA,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::RANGE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
    ...
    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_TAU,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("Car-following model parameter"),
            "1.00");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_TMP1,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("SKRAUSSX parameter 1"));

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_TMP2,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("SKRAUSSX parameter 2"));

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_TMP3,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("SKRAUSSX parameter 3"));

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_TMP4,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("SKRAUSSX parameter 4"));

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_TMP5,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("SKRAUSSX parameter 5"));

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_EIDM_T_LOOK_AHEAD,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("EIDM Look ahead / preview parameter [s]"),
            "4.00");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_EIDM_T_REACTION,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("EIDM AP Reaction Time parameter [s]"),
            "0.50");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_EIDM_T_PERSISTENCE_DRIVE,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("EIDM Wiener Process parameter for the Driving Error [s]"),
            "3.00");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_EIDM_T_PERSISTENCE_ESTIMATE,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("EIDM Wiener Process parameter for the Estimation Error [s]"),
            "10.00");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_EIDM_C_COOLNESS,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::RANGE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
    ...
    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_EIDM_SIG_LEADER,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("EIDM leader speed estimation error parameter [-]"),
            "0.02");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_EIDM_SIG_GAP,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("EIDM gap estimation error parameter [-]"),
            "0.10");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_EIDM_SIG_ERROR,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("EIDM driving error parameter [-]"),
            "0.04");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_EIDM_JERK_MAX,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("EIDM maximal jerk parameter [m/s^3]"),
            "3.00");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_EIDM_EPSILON_ACC,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("EIDM maximal negative acceleration between two Action Points (threshold) [m/s^2]"),
            "1.00");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_EIDM_T_ACC_MAX,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("EIDM Time parameter until vehicle reaches amax after startup/driveoff [s]"),
            "1.20");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_EIDM_M_FLATNESS,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("EIDM Flatness parameter of startup/driveoff curve [-]"),
            "2.00");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_EIDM_M_BEGIN,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("EIDM Shift parameter of startup/driveoff curve [-]"),
            "0.70");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_EIDM_USEVEHDYNAMICS,
            GNEAttributeProperties::BOOL | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("EIDM parameter if model shall include vehicle dynamics into the acceleration calculation [0/1]"),
            "0");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_EIDM_MAX_VEH_PREVIEW,
            GNEAttributeProperties::INT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("EIDM parameter how many vehicles are taken into the preview calculation of the driver (at least always 1!) [-]"),
            "0");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_PWAGNER2009_TAULAST,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("Peter Wagner 2009 parameter"),
            "0");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_PWAGNER2009_APPROB,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("Peter Wagner 2009 parameter"),
            "0");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_IDMM_ADAPT_FACTOR,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("IDMM parameter"),
            "0");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_IDMM_ADAPT_TIME,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("IDMM parameter"),
            "0");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_W99_CC1,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("W99 parameter"),
            "1.3");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_W99_CC2,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("W99 parameter"),
            "8.0");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_W99_CC3,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("W99 parameter"),
            "-12.0");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_W99_CC4,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("W99 parameter"),
            "-0.25");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_W99_CC5,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("W99 parameter"),
            "0.35");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_W99_CC6,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("W99 parameter"),
            "6.0");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_W99_CC7,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("W99 parameter"),
            "0.25");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_W99_CC8,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("W99 parameter"),
            "2.0");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_W99_CC9,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("W99 parameter"),
            "1.5");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_WIEDEMANN_SECURITY,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("Wiedemann parameter"));

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_WIEDEMANN_ESTIMATION,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("Wiedemann parameter"));

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_COLLISION_MINGAP_FACTOR,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("MinGap factor parameter"));

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_K,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("K parameter"));

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_KERNER_PHI,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("Kerner Phi parameter"));

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_IDM_DELTA,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("IDM Delta parameter"));

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CF_IDM_STEPPING,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("IDM Stepping parameter"));

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_TRAIN_TYPE,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DISCRETE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("Train Types"),
...
GNETagPropertiesDatabase::fillJunctionModelAttributes(GNETagProperties* tagProperties) {
    ...
    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_JM_CROSSING_GAP,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("Minimum distance to pedestrians that are walking towards the conflict point with the ego vehicle."),
            "10.00");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_JM_IGNORE_KEEPCLEAR_TIME,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
    ...
    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_JM_DRIVE_AFTER_YELLOW_TIME,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
    ...
    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_JM_DRIVE_AFTER_RED_TIME,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
    ...
    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_JM_IGNORE_FOE_PROB,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("This value causes vehicles to ignore foe vehicles that have right-of-way with the given probability."),
            "0.0");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_JM_IGNORE_FOE_SPEED,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
    ...
    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_JM_TIMEGAP_MINOR,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("This value defines the minimum time gap when passing ahead of a prioritized vehicle. "),
            "1.00");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_IMPATIENCE,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
...
GNETagPropertiesDatabase::fillLaneChangingModelAttributes(GNETagProperties* tagProperties) {
    ...
    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_LCA_STRATEGIC_PARAM,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("The eagerness for performing strategic lane changing. Higher values result in earlier lane-changing."),
            "1.0");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_LCA_COOPERATIVE_PARAM,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("The willingness for performing cooperative lane changing. Lower values result in reduced cooperation."),
            "1.0");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_LCA_SPEEDGAIN_PARAM,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("The eagerness for performing lane changing to gain speed. Higher values result in more lane-changing."),
            "1.0");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_LCA_KEEPRIGHT_PARAM,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("The eagerness for following the obligation to keep right. Higher values result in earlier lane-changing."),
            "1.0");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_LCA_SUBLANE_PARAM,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
    ...
    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_LCA_OPPOSITE_PARAM,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("The eagerness for overtaking through the opposite-direction lane. Higher values result in more lane-changing."),
            "1.0");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_LCA_PUSHY,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("Willingness to encroach laterally on other drivers."),
            "0.00");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_LCA_PUSHYGAP,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("Minimum lateral gap when encroaching laterally on other drives (alternative way to define lcPushy)"),
            "0.00");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_LCA_ASSERTIVE,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("Willingness to accept lower front and rear gaps on the target lane."),
            "1.0");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_LCA_IMPATIENCE,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("Dynamic factor for modifying lcAssertive and lcPushy."),
            "0.00");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_LCA_TIME_TO_IMPATIENCE,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("Time to reach maximum impatience (of 1). Impatience grows whenever a lane-change manoeuvre is blocked."),
            "infinity");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_LCA_ACCEL_LAT,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("Maximum lateral acceleration per second."),
            "1.0");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_LCA_LOOKAHEADLEFT,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
    ...
    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_LCA_SPEEDGAINRIGHT,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
    ...
    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_LCA_MAXSPEEDLATFACTOR,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("Upper bound on lateral speed while moving computed as lcMaxSpeedLatStanding + lcMaxSpeedLatFactor * getSpeed()"),
            "1.00");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_LCA_TURN_ALIGNMENT_DISTANCE,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
    ...
    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_LCA_OVERTAKE_RIGHT,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("The probability for violating rules gainst overtaking on the right."),
            "0.00");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_LCA_KEEPRIGHT_ACCEPTANCE_TIME,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
            TL("Time threshold for the willingness to change right."),
            "-1.00");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_LCA_OVERTAKE_DELTASPEED_FACTOR,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::RANGE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE  | GNEAttributeProperties::EXTENDEDEDITOR,
...
GNETagPropertiesDatabase::fillCommonStopAttributes(GNETagProperties* tagProperties, const bool waypoint) {
    GNEAttributeProperties* attrProperty = nullptr;
    // fill common stop attributes
    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_DURATION,
    ...
    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_UNTIL,
            GNEAttributeProperties::SUMOTIME | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::ACTIVATABLE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("The time step at which the route continues"),
            "0.00");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_EXTENSION,
    ...
    if (!waypoint) {
        attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_TRIGGERED,
                GNEAttributeProperties::STRING | GNEAttributeProperties::DISCRETE | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
        ...
        attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_EXPECTED,
                GNEAttributeProperties::STRING | GNEAttributeProperties::LIST | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("List of elements that must board the vehicle before it may continue"));

        attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_JOIN,
                GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("Joins this train to another upon reaching the stop"));
    }

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_PERMITTED,
            GNEAttributeProperties::STRING | GNEAttributeProperties::LIST | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("List of elements that can board the vehicle before it may continue"));

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_PARKING,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DISCRETE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
    ...
    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_ACTTYPE,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("Activity displayed for stopped person in GUI and output files"));

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_TRIP_ID,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
    ...
    if (waypoint) {
        attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_SPEED,
                GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
                TL("Speed to be kept while driving between startPos and endPos"),
                "0.00");
    } else {
        attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_ONDEMAND,
                GNEAttributeProperties::BOOL | GNEAttributeProperties::DEFAULTVALUE,
                GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
    ...
    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_JUMP,
            GNEAttributeProperties::SUMOTIME | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("transfer time if there shall be a jump from this stop to the next route edge"),
            "-1");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_SPLIT,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
...
GNETagPropertiesDatabase::fillPlanParentAttributes(GNETagProperties* tagProperties) {
    ...
    if (tagProperties->planConsecutiveEdges()) {
        attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_EDGES,
                GNEAttributeProperties::STRING | GNEAttributeProperties::LIST | GNEAttributeProperties::UNIQUE | GNEAttributeProperties::UPDATEGEOMETRY,
                GNEAttributeProperties::EDITMODE,
    ...
    if (tagProperties->planRoute()) {
        attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_ROUTE,
                GNEAttributeProperties::STRING | GNEAttributeProperties::LIST | GNEAttributeProperties::UNIQUE | GNEAttributeProperties::UPDATEGEOMETRY,
                GNEAttributeProperties::EDITMODE,
                TL("Route ID"));
    ...
    if (tagProperties->planEdge()) {
        ...
        attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_EDGE,
                GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE,
                GNEAttributeProperties::EDITMODE,
                TL("Edge ID"));
    ...
    if (tagProperties->planBusStop()) {
        attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_BUS_STOP,
                GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE,
                GNEAttributeProperties::EDITMODE,
                TL("Bus stop ID"));
    }
    if (tagProperties->planTrainStop()) {
        attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_TRAIN_STOP,
                GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE,
                GNEAttributeProperties::EDITMODE,
                TL("Train stop ID"));
    }
    if (tagProperties->planContainerStop()) {
        attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CONTAINER_STOP,
                GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE,
                GNEAttributeProperties::EDITMODE,
                TL("Container stop ID"));
    }
    if (tagProperties->planChargingStation()) {
        attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_CHARGING_STATION,
                GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE,
                GNEAttributeProperties::EDITMODE,
                TL("Charging station ID"));
    }
    if (tagProperties->planParkingArea()) {
        attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_PARKING_AREA,
                GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE,
                GNEAttributeProperties::EDITMODE,
                TL("Parking area ID"));
    }
    ...
    if (tagProperties->planFromEdge()) {
        attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_FROM,
                GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE,
                GNEAttributeProperties::EDITMODE,
                TL("Edge start ID"));
    }
    if (tagProperties->planFromTAZ()) {
        attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_FROM_TAZ,
                GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE,
                GNEAttributeProperties::EDITMODE,
                TL("TAZ start ID"));
    }
    if (tagProperties->planFromJunction()) {
        attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_FROM_JUNCTION,
                GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE,
                GNEAttributeProperties::EDITMODE,
                TL("Junction start ID"));
    }
    if (tagProperties->planFromBusStop()) {
        attrProperty = new GNEAttributeProperties(tagProperties, GNE_ATTR_FROM_BUSSTOP,
                GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE,
                GNEAttributeProperties::EDITMODE,
                TL("BusStop start ID"));
    }
    if (tagProperties->planFromTrainStop()) {
        attrProperty = new GNEAttributeProperties(tagProperties, GNE_ATTR_FROM_TRAINSTOP,
                GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE,
                GNEAttributeProperties::EDITMODE,
                TL("TrainStop start ID"));
    }
    if (tagProperties->planFromContainerStop()) {
        attrProperty = new GNEAttributeProperties(tagProperties, GNE_ATTR_FROM_CONTAINERSTOP,
                GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE,
                GNEAttributeProperties::EDITMODE,
                TL("ContainerStop start ID"));
    }
    if (tagProperties->planFromChargingStation()) {
        attrProperty = new GNEAttributeProperties(tagProperties, GNE_ATTR_FROM_CHARGINGSTATION,
                GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE,
                GNEAttributeProperties::EDITMODE,
    ...
    if (tagProperties->planToEdge()) {
        attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_TO,
                GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE,
                GNEAttributeProperties::EDITMODE,
                TL("Edge end ID"));
    ...
    if (tagProperties->planToTAZ()) {
        attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_TO_TAZ,
                GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE,
                GNEAttributeProperties::EDITMODE,
                TL("TAZ end ID"));
    }
    if (tagProperties->planToJunction()) {
        attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_TO_JUNCTION,
                GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE,
                GNEAttributeProperties::EDITMODE,
                TL("Junction end ID"));
    }
...
GNETagPropertiesDatabase::fillPersonTripCommonAttributes(GNETagProperties* tagProperties) {
    ...
    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_MODES,
            GNEAttributeProperties::STRING | GNEAttributeProperties::LIST | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("List of possible traffic modes. Walking is always possible regardless of this value"));

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_LINES,
            GNEAttributeProperties::STRING | GNEAttributeProperties::LIST | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("list of vehicle alternatives to take for the person trip"));

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_WALKFACTOR,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::POSITIVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("Walk factor"),
            "0.00");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_GROUP,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
...
GNETagPropertiesDatabase::fillCommonMeanDataAttributes(GNETagProperties* tagProperties) {
    ...
    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_EXCLUDE_EMPTY,
            GNEAttributeProperties::STRING | GNEAttributeProperties::DISCRETE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
    ...
    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_WITH_INTERNAL,
            GNEAttributeProperties::BOOL | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("If set, junction internal edges/lanes will be written as well"),
            GNEAttributeCarrier::False);

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_MAX_TRAVELTIME,
            GNEAttributeProperties::SUMOTIME | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("The maximum travel time in seconds to write if only very small movements occur"),
            toString(100000));

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_MIN_SAMPLES,
            GNEAttributeProperties::SUMOTIME | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("Consider an edge/lane unused if it has at most this many sampled seconds"),
            "0");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_HALTING_SPEED_THRESHOLD,
            GNEAttributeProperties::FLOAT | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("The maximum speed to consider a vehicle halting;"),
            "0.1");

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_VTYPES,
            GNEAttributeProperties::STRING | GNEAttributeProperties::LIST | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("space separated list of vehicle type ids to consider"));

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_TRACK_VEHICLES,
            GNEAttributeProperties::BOOL | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("whether aggregation should be performed over all vehicles that entered the edge/lane in the aggregation interval"),
            GNEAttributeCarrier::False);

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_DETECT_PERSONS,
            GNEAttributeProperties::STRING | GNEAttributeProperties::LIST | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("Whether pedestrians shall be recorded instead of vehicles. Allowed value is walk"));

    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_WRITE_ATTRIBUTES,
            GNEAttributeProperties::STRING | GNEAttributeProperties::LIST | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
    ...
    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_EDGESFILE,
    ...
    attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_AGGREGATE,
            GNEAttributeProperties::BOOL | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
...
GNETagPropertiesDatabase::fillLaneAttribute(GNETagProperties* tagProperties, const bool synonymID) {
    if (synonymID) {
        auto attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_LANE,
                GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE | GNEAttributeProperties::SYNONYM | GNEAttributeProperties::UPDATEGEOMETRY,
                GNEAttributeProperties::EDITMODE,
...
GNETagPropertiesDatabase::fillFileAttribute(GNETagProperties* tagProperties) {
    auto attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_FILE,
            GNEAttributeProperties::STRING | GNEAttributeProperties::FILESAVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
...
GNETagPropertiesDatabase::fillOutputAttribute(GNETagProperties* tagProperties) {
    auto attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_OUTPUT,
            GNEAttributeProperties::STRING | GNEAttributeProperties::FILESAVE | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
            TL("The path to the output file"));
    attrProperty->setFilenameExtensions(SUMOXMLDefinitions::OutputFileExtensions.getMultilineString());
...
GNETagPropertiesDatabase::fillImgFileAttribute(GNETagProperties* tagProperties) {
    auto attrProperty = new GNEAttributeProperties(tagProperties, SUMO_ATTR_IMGFILE,
            GNEAttributeProperties::STRING | GNEAttributeProperties::FILEOPEN | GNEAttributeProperties::DEFAULTVALUE,
            GNEAttributeProperties::CREATEMODE | GNEAttributeProperties::EDITMODE,
