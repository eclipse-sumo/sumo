...
GNETagPropertiesDatabase::getTagProperty(SumoXMLTag tag) const {
    ...
    } else if (mySetTmp.count(tag) > 0) {
        return mySetTmp.at(tag);
    } else {
...
GNETagPropertiesDatabase::fillHierarchy() {
    ...
    mySupermodeTagProperties[Supermode::DATA] = new GNETagProperties(GNE_TAG_SUPERMODE_DATA,
            ...
            TL("Supermode data"));
    // additionals
    mySetTmp[SUMO_TAG_VIEWSETTINGS_ADDITIONALS] = new GNETagProperties(SUMO_TAG_VIEWSETTINGS_ADDITIONALS,
            mySupermodeTagProperties.at(Supermode::NETWORK),
            GUIIcon::MODEADDITIONAL,
            TL("Additional elements"));
    mySetTmp[GNE_TAG_STOPPINGPLACES] = new GNETagProperties(GNE_TAG_STOPPINGPLACES,
            mySetTmp[SUMO_TAG_VIEWSETTINGS_ADDITIONALS],
            GUIIcon::BUSSTOP,
            TL("Stopping places"));
    mySetTmp[GNE_TAG_DETECTORS] = new GNETagProperties(GNE_TAG_DETECTORS,
            mySetTmp[SUMO_TAG_VIEWSETTINGS_ADDITIONALS],
            GUIIcon::E1,
            TL("Detectors"));
    mySetTmp[GNE_TAG_WIRES] = new GNETagProperties(GNE_TAG_WIRES,
            mySetTmp[SUMO_TAG_VIEWSETTINGS_ADDITIONALS],
            GUIIcon::MODEWIRE,
            TL("Wires"));
    // shapes
    mySetTmp[GNE_TAG_SHAPES] = new GNETagProperties(GNE_TAG_SHAPES,
            mySupermodeTagProperties.at(Supermode::NETWORK),
            GUIIcon::MODESHAPE,
            TL("Shapes"));
    mySetTmp[GNE_TAG_JUPEDSIM] = new GNETagProperties(GNE_TAG_JUPEDSIM,
            mySetTmp[GNE_TAG_SHAPES],
            GUIIcon::E1,
            TL("JuPedSim elements"));
    // TAZs
    mySetTmp[GNE_TAG_TAZS] = new GNETagProperties(GNE_TAG_TAZS,
            mySupermodeTagProperties.at(Supermode::NETWORK),
            GUIIcon::MODEADDITIONAL,
            TL("TAZ elements"));
    // vehicles
    mySetTmp[SUMO_TAG_VIEWSETTINGS_VEHICLES] = new GNETagProperties(SUMO_TAG_VIEWSETTINGS_VEHICLES,
            mySupermodeTagProperties[Supermode::DEMAND],
            GUIIcon::MODEVEHICLE,
            TL("Vehicles"));
     mySetTmp[GNE_TAG_STOPS] = new GNETagProperties(GNE_TAG_STOPS,
            mySetTmp[SUMO_TAG_VIEWSETTINGS_VEHICLES],
            GUIIcon::MODEWIRE,
            TL("Stops"));
    // persons
    mySetTmp[SUMO_TAG_VIEWSETTINGS_PERSONS] = new GNETagProperties(SUMO_TAG_VIEWSETTINGS_PERSONS,
            mySupermodeTagProperties[Supermode::DEMAND],
            GUIIcon::MODEPERSON,
            TL("Persons"));
    mySetTmp[GNE_TAG_PERSONPLANS] = new GNETagProperties(GNE_TAG_STOPS,
            mySetTmp[SUMO_TAG_VIEWSETTINGS_PERSONS],
            GUIIcon::MODEWIRE,
            TL("Person plans"));
    mySetTmp[GNE_TAG_PERSONTRIPS] = new GNETagProperties(GNE_TAG_PERSONTRIPS,
            mySetTmp[GNE_TAG_PERSONPLANS],
            GUIIcon::PERSONTRIP_BUSSTOP,
            TL("Person trips"));
    mySetTmp[GNE_TAG_RIDES] = new GNETagProperties(GNE_TAG_RIDES,
            mySetTmp[GNE_TAG_PERSONPLANS],
            GUIIcon::RIDE_BUSSTOP,
            TL("Rides"));
    mySetTmp[GNE_TAG_WALKS] = new GNETagProperties(GNE_TAG_WALKS,
            mySetTmp[GNE_TAG_PERSONPLANS],
            GUIIcon::WALK_BUSSTOP,
            TL("Walks trips"));
    mySetTmp[GNE_TAG_PERSONSTOPS] = new GNETagProperties(GNE_TAG_PERSONSTOPS,
            mySetTmp[GNE_TAG_PERSONPLANS],
            GUIIcon::STOP,
            TL("Person stop"));
    // containers
    mySetTmp[SUMO_TAG_VIEWSETTINGS_CONTAINERS] = new GNETagProperties(SUMO_TAG_VIEWSETTINGS_CONTAINERS,
            mySupermodeTagProperties[Supermode::DEMAND],
            GUIIcon::MODEVEHICLE,
            TL("Containers"));
    mySetTmp[GNE_TAG_CONTAINERPLANS] = new GNETagProperties(GNE_TAG_CONTAINERPLANS,
            mySetTmp[SUMO_TAG_VIEWSETTINGS_CONTAINERS],
            GUIIcon::MODEWIRE,
            TL("Container plans"));
    mySetTmp[GNE_TAG_TRANSPORTS] = new GNETagProperties(GNE_TAG_TRANSPORTS,
            mySetTmp[GNE_TAG_CONTAINERPLANS],
            GUIIcon::TRANSPORT_BUSSTOP,
            TL("Transports"));
    mySetTmp[GNE_TAG_TRANSHIPS] = new GNETagProperties(GNE_TAG_TRANSHIPS,
            mySetTmp[GNE_TAG_CONTAINERPLANS],
            GUIIcon::TRANSHIP_BUSSTOP,
            TL("Tranships"));
    mySetTmp[GNE_TAG_CONTAINERSTOPS] = new GNETagProperties(GNE_TAG_CONTAINERSTOPS,
            mySetTmp[GNE_TAG_CONTAINERPLANS],
            GUIIcon::STOP,
            TL("Container stop"));
}
...
GNETagPropertiesDatabase::fillAdditionalElements() {
    ...
    {
        // set values of tag
        myTagProperties[currentTag] = new GNETagProperties(currentTag, mySetTmp.at(GNE_TAG_STOPPINGPLACES),
    ...
    {
        // set values of tag
        myTagProperties[currentTag] = new GNETagProperties(currentTag, mySetTmp.at(GNE_TAG_DETECTORS),
    ...
    {
        // set values of tag
        myTagProperties[currentTag] = new GNETagProperties(currentTag, mySetTmp.at(SUMO_TAG_VIEWSETTINGS_ADDITIONALS),
                GNETagProperties::TagType::ADDITIONALELEMENT,
...
GNETagPropertiesDatabase::fillShapeElements() {
    ...
    {
        // set values of tag
        myTagProperties[currentTag] = new GNETagProperties(currentTag, mySetTmp.at(GNE_TAG_SHAPES),
...
GNETagPropertiesDatabase::fillTAZElements() {
    ...
    {
        // set values of tag
        myTagProperties[currentTag] = new GNETagProperties(currentTag, mySetTmp.at(GNE_TAG_TAZS),
...
GNETagPropertiesDatabase::fillWireElements() {
    ...
    {
        // set tag properties
        myTagProperties[currentTag] = new GNETagProperties(currentTag, mySetTmp.at(GNE_TAG_WIRES),
...
GNETagPropertiesDatabase::fillJuPedSimElements() {
    ...
    {
        // set values of tag
        myTagProperties[currentTag] = new GNETagProperties(currentTag, mySetTmp.at(GNE_TAG_JUPEDSIM),
...
GNETagPropertiesDatabase::fillVehicleElements() {
    ...
    {
        // set values of tag
        myTagProperties[currentTag] = new GNETagProperties(currentTag, mySetTmp.at(SUMO_TAG_VIEWSETTINGS_VEHICLES),
...
GNETagPropertiesDatabase::fillStopElements() {
    ...
    {
        // set values of tag
        myTagProperties[currentTag] = new GNETagProperties(currentTag, mySetTmp.at(GNE_TAG_STOPS),
...
GNETagPropertiesDatabase::fillPersonElements() {
    ...
    {
        // set values of tag
        myTagProperties[currentTag] = new GNETagProperties(currentTag, mySetTmp.at(SUMO_TAG_VIEWSETTINGS_PERSONS),
...
GNETagPropertiesDatabase::fillContainerElements() {
    ...
    {
        // set values of tag
        myTagProperties[currentTag] = new GNETagProperties(currentTag, mySetTmp.at(SUMO_TAG_VIEWSETTINGS_CONTAINERS),
...
GNETagPropertiesDatabase::fillContainerTransportElements() {
    ...
    {
        // set values of tag
        myTagProperties[currentTag] = new GNETagProperties(currentTag, mySetTmp.at(GNE_TAG_TRANSPORTS), tagType, tagProperty,
    ...
    {
        // set values of tag
        myTagProperties[currentTag] = new GNETagProperties(currentTag, mySetTmp.at(GNE_TAG_TRANSPORTS), tagType, tagPropertyTAZ,
...
GNETagPropertiesDatabase::fillContainerTranshipElements() {
    ...
    {
        // set values of tag
        myTagProperties[currentTag] = new GNETagProperties(currentTag, mySetTmp.at(GNE_TAG_TRANSHIPS), tagType, tagProperty,
    ...
    {
        // set values of tag
        myTagProperties[currentTag] = new GNETagProperties(currentTag, mySetTmp.at(GNE_TAG_TRANSHIPS), tagType, tagPropertyTAZ,
                GNETagProperties::TagParents::PLAN_FROM_EDGE | GNETagProperties::TagParents::PLAN_TO_TAZ,
...
GNETagPropertiesDatabase::fillContainerStopElements() {
    ...
    {
        // set values of tag
        myTagProperties[currentTag] = new GNETagProperties(currentTag, mySetTmp.at(GNE_TAG_CONTAINERSTOPS), tagType, tagProperty,
...
GNETagPropertiesDatabase::fillPersonPlanTrips() {
    ...
    {
        // set values of tag
        myTagProperties[currentTag] = new GNETagProperties(currentTag, mySetTmp.at(GNE_TAG_PERSONTRIPS), tagType, tagProperty,
                GNETagProperties::TagParents::PLAN_FROM_EDGE | GNETagProperties::TagParents::PLAN_TO_EDGE,
    ...
    {
        // set values of tag
        myTagProperties[currentTag] = new GNETagProperties(currentTag, mySetTmp.at(GNE_TAG_PERSONTRIPS), tagType, tagPropertyTAZ,
                GNETagProperties::TagParents::PLAN_FROM_EDGE | GNETagProperties::TagParents::PLAN_TO_TAZ,
...
GNETagPropertiesDatabase::fillPersonPlanWalks() {
    ...
    {
        // set values of tag
        myTagProperties[currentTag] = new GNETagProperties(currentTag, mySetTmp.at(GNE_TAG_WALKS), tagType, tagProperty,
                GNETagProperties::TagParents::PLAN_CONSECUTIVE_EDGES,
    ...
    {
        // set values of tag
        myTagProperties[currentTag] = new GNETagProperties(currentTag, mySetTmp.at(GNE_TAG_WALKS), tagType, tagPropertyTAZ,
                GNETagProperties::TagParents::PLAN_FROM_EDGE | GNETagProperties::TagParents::PLAN_TO_TAZ,
...
GNETagPropertiesDatabase::fillPersonPlanRides() {
    ...
    {
        // set values of tag
        myTagProperties[currentTag] = new GNETagProperties(currentTag, mySetTmp.at(GNE_TAG_RIDES), tagType, tagProperty,
                GNETagProperties::TagParents::PLAN_FROM_EDGE | GNETagProperties::TagParents::PLAN_TO_EDGE,
    ...
    {
        // set values of tag
        myTagProperties[currentTag] = new GNETagProperties(currentTag, mySetTmp.at(GNE_TAG_RIDES), tagType, tagPropertyTAZ,
                GNETagProperties::TagParents::PLAN_FROM_EDGE | GNETagProperties::TagParents::PLAN_TO_TAZ,
...
GNETagPropertiesDatabase::fillPersonStopElements() {
    ...
    {
        // set values of tag
        myTagProperties[currentTag] = new GNETagProperties(currentTag, mySetTmp.at(GNE_TAG_PERSONSTOPS), tagType, tagProperty,
                GNETagProperties::TagParents::PLAN_EDGE,
