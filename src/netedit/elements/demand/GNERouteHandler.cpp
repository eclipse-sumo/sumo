...
bool
GNERouteHandler::buildPersonPlan(SumoXMLTag tag, GNEDemandElement* personParent, GNEFrameAttributesModules::AttributesCreator* personPlanAttributes, 
...
bool
GNERouteHandler::buildContainerPlan(SumoXMLTag tag, GNEDemandElement* containerParent, GNEFrameAttributesModules::AttributesCreator* containerPlanAttributes, GNEFrameModules::PathCreator* pathCreator) {
