...
public:
    ...
    bool buildPersonPlan(SumoXMLTag tag, GNEDemandElement* personParent, GNEFrameAttributesModules::AttributesCreator* personPlanAttributes,
                         GNEFrameModules::PathCreator* pathCreator, const bool centerAfterCreation);

    /// @brief build container plan
    bool buildContainerPlan(SumoXMLTag tag, GNEDemandElement* containerParent, GNEFrameAttributesModules::AttributesCreator* containerPlanAttributes, GNEFrameModules::PathCreator* pathCreator);
