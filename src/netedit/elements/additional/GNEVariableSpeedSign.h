...
public:
    ...
    /// @brief methods to retrieve the elements linked to this variableSpeedSign
    /// @{

    /// @brief get GNEMoveElement associated with this variableSpeedSign
    GNEMoveElement* getMoveElement() const override;

    /// @brief get parameters associated with this variableSpeedSign
    Parameterised* getParameters() override;

    /// @brief get parameters associated with this variableSpeedSign (constant)
