...
public:
     ...
     * @param[in] shapeBlocked enable or disable shape blocking
     */
    GNEPoly(GNENet* net, const std::string& id, const std::string& type, const PositionVector& shape, bool geo, bool fill, 
            ...
            const std::string &name, const std::map<std::string, std::string> &parameters, bool movementBlocked, bool shapeBlocked);
