...
void
GNEAdditionalHandlerBeta::myStartElement(int element, const SUMOSAXAttributes& attrs) {
...
void
GNEAdditionalHandlerBeta::myEndElement(int element) {
    // Obtain tag of element
    SumoXMLTag tag = static_cast<SumoXMLTag>(element);
    switch (tag) {
        case SUMO_TAG_TAZ: {
...
Position
GNEAdditionalHandlerBeta::getLanePos(const std::string& poiID, const std::string& laneID, double lanePos, double lanePosLat) {
    std::string edgeID;
    int laneIndex;
...
bool
GNEAdditionalHandlerBeta::buildAdditional(GNENet* net, bool allowUndoRedo, SumoXMLTag tag, const SUMOSAXAttributes& attrs, LastInsertedElement* insertedAdditionals) {
    // Call parse and build depending of tag
    switch (tag) {
...
GNEAdditional*
GNEAdditionalHandlerBeta::buildBusStop(GNENet* net, bool allowUndoRedo, const std::string& id, GNELane* lane,
...
GNEAdditional*
GNEAdditionalHandlerBeta::buildAccess(GNENet* net, bool allowUndoRedo, GNEAdditional* busStop, GNELane* lane, double pos, const std::string& length, bool friendlyPos, bool blockMovement) {
...
GNEAdditional*
GNEAdditionalHandlerBeta::buildContainerStop(GNENet* net, bool allowUndoRedo, const std::string& id, GNELane* lane, const double startPos, const double endPos, const int parametersSet,
...
GNEAdditional*
GNEAdditionalHandlerBeta::buildChargingStation(GNENet* net, bool allowUndoRedo, const std::string& id, GNELane* lane, const double startPos, const double endPos, const int parametersSet,
...
GNEAdditional*
GNEAdditionalHandlerBeta::buildParkingArea(GNENet* net, bool allowUndoRedo, const std::string& id, GNELane* lane, const double startPos, const double endPos, const int parametersSet,
...
GNEAdditional*
GNEAdditionalHandlerBeta::buildParkingSpace(GNENet* net, bool allowUndoRedo, GNEAdditional* parkingAreaParent, Position pos, double width, double length, double angle, double slope, bool blockMovement) {
...
GNEAdditional*
GNEAdditionalHandlerBeta::buildDetectorE1(GNENet* net, bool allowUndoRedo, const std::string& id, GNELane* lane, double pos, SUMOTime freq, const std::string& filename, const std::string& vehicleTypes, const std::string& name, bool friendlyPos, bool blockMovement) {
...
GNEAdditional*
GNEAdditionalHandlerBeta::buildSingleLaneDetectorE2(GNENet* net, bool allowUndoRedo, const std::string& id, GNELane* lane, double pos, double length, const std::string& freq, const std::string& trafficLight,
...
GNEAdditional*
GNEAdditionalHandlerBeta::buildMultiLaneDetectorE2(GNENet* net, bool allowUndoRedo, const std::string& id, const std::vector<GNELane*>& lanes, double pos, double endPos, const std::string& freq, const std::string& trafficLight,
        const std::string& filename, const std::string& vehicleTypes, const std::string& name, SUMOTime timeThreshold, double speedThreshold, double jamThreshold, bool friendlyPos, bool blockMovement) {
...
GNEAdditional*
GNEAdditionalHandlerBeta::buildDetectorE3(GNENet* net, bool allowUndoRedo, const std::string& id, Position pos, SUMOTime freq, const std::string& filename, const std::string& vehicleTypes,
...
GNEAdditional*
GNEAdditionalHandlerBeta::buildDetectorEntry(GNENet* net, bool allowUndoRedo, GNEAdditional* E3Parent, GNELane* lane, double pos, bool friendlyPos, bool blockMovement) {
...
GNEAdditional*
GNEAdditionalHandlerBeta::buildDetectorExit(GNENet* net, bool allowUndoRedo, GNEAdditional* E3Parent, GNELane* lane, double pos, bool friendlyPos, bool blockMovement) {
    // Check if Detector E3 parent and lane is correct
    if (lane == nullptr) {
...
GNEAdditional*
GNEAdditionalHandlerBeta::buildDetectorE1Instant(GNENet* net, bool allowUndoRedo, const std::string& id, GNELane* lane, double pos, const std::string& filename, const std::string& vehicleTypes, const std::string& name, bool friendlyPos, bool blockMovement) {
...
GNEAdditional*
GNEAdditionalHandlerBeta::buildCalibrator(GNENet* net, bool allowUndoRedo, const std::string& id, GNELane* lane, double pos, const std::string& name, const std::string& outfile, const SUMOTime freq, const std::string& routeprobe, bool centerAfterCreation) {
...
GNEAdditional*
GNEAdditionalHandlerBeta::buildCalibrator(GNENet* net, bool allowUndoRedo, const std::string& id, GNEEdge* edge, double pos, const std::string& name, const std::string& outfile, const SUMOTime freq, const std::string& routeprobe, bool centerAfterCreation) {
    if (net->retrieveAdditional(SUMO_TAG_CALIBRATOR, id, false) == nullptr) {
...
GNEAdditional*
GNEAdditionalHandlerBeta::buildCalibratorFlow(GNENet* net, bool allowUndoRedo, GNEAdditional* calibratorParent, GNEDemandElement* route, GNEDemandElement* vType,
...
GNEAdditional*
GNEAdditionalHandlerBeta::buildRerouter(GNENet* net, bool allowUndoRedo, const std::string& id, Position pos, const std::vector<GNEEdge*>& edges, double prob, const std::string& name, const std::string& file, bool off, SUMOTime timeThreshold, const std::string& vTypes, bool blockMovement) {
    if (net->retrieveAdditional(SUMO_TAG_REROUTER, id, false) == nullptr) {
        ...
        if (!file.empty()) {
            ...
            GNEAdditionalHandlerBeta rerouterValuesHandler(currentAdditionalFilename + file, net, rerouter);
...
GNEAdditional*
GNEAdditionalHandlerBeta::buildRerouterInterval(GNENet* net, bool allowUndoRedo, GNEAdditional* rerouterParent, SUMOTime begin, SUMOTime end) {
...
GNEAdditional*
GNEAdditionalHandlerBeta::buildClosingLaneReroute(GNENet* net, bool allowUndoRedo, GNEAdditional* rerouterIntervalParent, GNELane* closedLane, SVCPermissions permissions) {
...
GNEAdditional*
GNEAdditionalHandlerBeta::buildClosingReroute(GNENet* net, bool allowUndoRedo, GNEAdditional* rerouterIntervalParent, GNEEdge* closedEdge, SVCPermissions permissions) {
...
GNEAdditional*
GNEAdditionalHandlerBeta::builDestProbReroute(GNENet* net, bool allowUndoRedo, GNEAdditional* rerouterIntervalParent, GNEEdge* newEdgeDestination, double probability) {
...
GNEAdditional*
GNEAdditionalHandlerBeta::builParkingAreaReroute(GNENet* net, bool allowUndoRedo, GNEAdditional* rerouterIntervalParent, GNEAdditional* newParkingArea, double probability, bool visible) {
    // create dest probability reroute
...
GNEAdditional*
GNEAdditionalHandlerBeta::buildRouteProbReroute(GNENet* net, bool allowUndoRedo, GNEAdditional* rerouterIntervalParent, const std::string& newRouteId, double probability) {
...
GNEAdditional*
GNEAdditionalHandlerBeta::buildRouteProbe(GNENet* net, bool allowUndoRedo, const std::string& id, GNEEdge* edge, const std::string& freq, const std::string& name, const std::string& file, SUMOTime begin, bool centerAfterCreation) {
...
GNEAdditional*
GNEAdditionalHandlerBeta::buildVariableSpeedSign(GNENet* net, bool allowUndoRedo, const std::string& id, Position pos, const std::vector<GNELane*>& lanes, const std::string& name, bool blockMovement) {
...
GNEAdditional*
GNEAdditionalHandlerBeta::buildVariableSpeedSignStep(GNENet* net, bool allowUndoRedo, GNEAdditional* VSSParent, double time, double speed) {
...
GNEAdditional*
GNEAdditionalHandlerBeta::buildVaporizer(GNENet* net, bool allowUndoRedo, GNEEdge* edge, SUMOTime startTime, SUMOTime endTime, const std::string& name, bool centerAfterCreation) {
...
GNETAZElement*
GNEAdditionalHandlerBeta::buildTAZ(GNENet* net, bool allowUndoRedo, const std::string& id, const PositionVector& shape, const RGBColor& color, const std::vector<GNEEdge*>& edges, bool blockMovement) {
...
GNETAZElement*
GNEAdditionalHandlerBeta::buildTAZSource(GNENet* net, bool allowUndoRedo, GNETAZElement* TAZ, GNEEdge* edge, double departWeight) {
...
GNETAZElement*
GNEAdditionalHandlerBeta::buildTAZSink(GNENet* net, bool allowUndoRedo, GNETAZElement* TAZ, GNEEdge* edge, double arrivalWeight) {
    GNETAZElement* TAZSource = nullptr;
    // first check if a TAZSink in the same edge for the same TAZ
    for (const auto& TAZElement : TAZ->getChildTAZElements()) {
        if ((TAZElement->getTagProperty().getTag() == SUMO_TAG_TAZSOURCE) && (TAZElement->getAttribute(SUMO_ATTR_EDGE) == edge->getID())) {
...
double
GNEAdditionalHandlerBeta::getPosition(double pos, GNELane& lane, bool friendlyPos, const std::string& additionalID) {
    if (pos < 0) {
...
bool GNEAdditionalHandlerBeta::checkAndFixDetectorPosition(double& pos, const double laneLength, const bool friendlyPos) {
...
bool GNEAdditionalHandlerBeta::fixE2DetectorPosition(double& pos, double& length, const double laneLength, const bool friendlyPos) {
...
bool
GNEAdditionalHandlerBeta::parseAndBuildVaporizer(GNENet* net, bool allowUndoRedo, const SUMOSAXAttributes& attrs, LastInsertedElement* insertedAdditionals) {
    bool abort = false;
...
bool
GNEAdditionalHandlerBeta::parseAndBuildTAZ(GNENet* net, bool allowUndoRedo, const SUMOSAXAttributes& attrs, LastInsertedElement* insertedAdditionals) {
    bool abort = false;
    // parse attributes of Vaporizer
...
bool
GNEAdditionalHandlerBeta::parseAndBuildTAZSource(GNENet* net, bool allowUndoRedo, const SUMOSAXAttributes& attrs, LastInsertedElement* insertedAdditionals) {
    bool abort = false;
    // parse attributes of Vaporizer
...
bool
GNEAdditionalHandlerBeta::parseAndBuildTAZSink(GNENet* net, bool allowUndoRedo, const SUMOSAXAttributes& attrs, LastInsertedElement* insertedAdditionals) {
    bool abort = false;
    // parse attributes of Vaporizer
...
bool
GNEAdditionalHandlerBeta::parseAndBuildRouteProbe(GNENet* net, bool allowUndoRedo, const SUMOSAXAttributes& attrs, LastInsertedElement* insertedAdditionals) {
    bool abort = false;
...
bool
GNEAdditionalHandlerBeta::parseAndBuildCalibratorFlow(GNENet* net, bool allowUndoRedo, const SUMOSAXAttributes& attrs, LastInsertedElement* insertedAdditionals) {
    bool abort = false;
...
bool
GNEAdditionalHandlerBeta::parseAndBuildVariableSpeedSign(GNENet* net, bool allowUndoRedo, const SUMOSAXAttributes& attrs, LastInsertedElement* insertedAdditionals) {
    bool abort = false;
...
bool
GNEAdditionalHandlerBeta::parseAndBuildVariableSpeedSignStep(GNENet* net, bool allowUndoRedo, const SUMOSAXAttributes& attrs, LastInsertedElement* insertedAdditionals) {
    bool abort = false;
    // Load step values
...
bool
GNEAdditionalHandlerBeta::parseAndBuildRerouter(GNENet* net, bool allowUndoRedo, const SUMOSAXAttributes& attrs, LastInsertedElement* insertedAdditionals) {
    bool abort = false;
...
bool
GNEAdditionalHandlerBeta::parseAndBuildRerouterInterval(GNENet* net, bool allowUndoRedo, const SUMOSAXAttributes& attrs, LastInsertedElement* insertedAdditionals) {
    bool abort = false;
    // parse attributes of Rerouter
...
bool
GNEAdditionalHandlerBeta::parseAndBuildRerouterClosingLaneReroute(GNENet* net, bool allowUndoRedo, const SUMOSAXAttributes& attrs, LastInsertedElement* insertedAdditionals) {
    bool abort = false;
    // parse attributes of Rerouter
...
bool
GNEAdditionalHandlerBeta::parseAndBuildRerouterClosingReroute(GNENet* net, bool allowUndoRedo, const SUMOSAXAttributes& attrs, LastInsertedElement* insertedAdditionals) {
    bool abort = false;
    // parse attributes of Rerouter
...
bool
GNEAdditionalHandlerBeta::parseAndBuildRerouterDestProbReroute(GNENet* net, bool allowUndoRedo, const SUMOSAXAttributes& attrs, LastInsertedElement* insertedAdditionals) {
    bool abort = false;
    // parse attributes of Rerouter
...
bool
GNEAdditionalHandlerBeta::parseAndBuildRerouterParkingAreaReroute(GNENet* net, bool allowUndoRedo, const SUMOSAXAttributes& attrs, LastInsertedElement* insertedAdditionals) {
    bool abort = false;
    // parse attributes of Rerouter
...
bool
GNEAdditionalHandlerBeta::parseAndBuildRerouterRouteProbReroute(GNENet* net, bool allowUndoRedo, const SUMOSAXAttributes& attrs, LastInsertedElement* insertedAdditionals) {
    bool abort = false;
    // parse attributes of Rerouter
...
bool
GNEAdditionalHandlerBeta::parseAndBuildBusStop(GNENet* net, bool allowUndoRedo, const SUMOSAXAttributes& attrs, LastInsertedElement* insertedAdditionals) {
    bool abort = false;
...
bool
GNEAdditionalHandlerBeta::parseAndBuildContainerStop(GNENet* net, bool allowUndoRedo, const SUMOSAXAttributes& attrs, LastInsertedElement* insertedAdditionals) {
    bool abort = false;
...
bool
GNEAdditionalHandlerBeta::parseAndBuildAccess(GNENet* net, bool allowUndoRedo, const SUMOSAXAttributes& attrs, LastInsertedElement* insertedAdditionals) {
    bool abort = false;
...
bool
GNEAdditionalHandlerBeta::parseAndBuildChargingStation(GNENet* net, bool allowUndoRedo, const SUMOSAXAttributes& attrs, LastInsertedElement* insertedAdditionals) {
    bool abort = false;
...
bool
GNEAdditionalHandlerBeta::parseAndBuildParkingArea(GNENet* net, bool allowUndoRedo, const SUMOSAXAttributes& attrs, LastInsertedElement* insertedAdditionals) {
    bool abort = false;
    // parse attributes of charging station
...
bool
GNEAdditionalHandlerBeta::parseAndBuildParkingSpace(GNENet* net, bool allowUndoRedo, const SUMOSAXAttributes& attrs, LastInsertedElement* insertedAdditionals) {
    bool abort = false;
...
bool
GNEAdditionalHandlerBeta::parseAndBuildCalibrator(GNENet* net, bool allowUndoRedo, const SUMOSAXAttributes& attrs, LastInsertedElement* insertedAdditionals) {
    bool abort = false;
...
bool
GNEAdditionalHandlerBeta::parseAndBuildDetectorE1(GNENet* net, bool allowUndoRedo, const SUMOSAXAttributes& attrs, LastInsertedElement* insertedAdditionals) {
    bool abort = false;
...
bool
GNEAdditionalHandlerBeta::parseAndBuildDetectorE2(GNENet* net, bool allowUndoRedo, const SUMOSAXAttributes& attrs, LastInsertedElement* insertedAdditionals) {
...
bool
GNEAdditionalHandlerBeta::parseAndBuildDetectorE3(GNENet* net, bool allowUndoRedo, const SUMOSAXAttributes& attrs, LastInsertedElement* insertedAdditionals) {
    bool abort = false;
...
bool
GNEAdditionalHandlerBeta::parseAndBuildDetectorEntry(GNENet* net, bool allowUndoRedo, const SUMOSAXAttributes& attrs, LastInsertedElement* insertedAdditionals) {
    bool abort = false;
    // parse attributes of Entry
...
bool
GNEAdditionalHandlerBeta::parseAndBuildDetectorExit(GNENet* net, bool allowUndoRedo, const SUMOSAXAttributes& attrs, LastInsertedElement* insertedAdditionals) {
    bool abort = false;
...
bool
GNEAdditionalHandlerBeta::parseAndBuildDetectorE1Instant(GNENet* net, bool allowUndoRedo, const SUMOSAXAttributes& attrs, LastInsertedElement* insertedAdditionals) {
    bool abort = false;
...
void
GNEAdditionalHandlerBeta::parseAndBuildPoly(const SUMOSAXAttributes& attrs) {
    bool abort = false;
...
void
GNEAdditionalHandlerBeta::parseAndBuildPOI(const SUMOSAXAttributes& attrs) {
    bool abort = false;
...
void
GNEAdditionalHandlerBeta::parseParameter(const SUMOSAXAttributes& attrs) {
...
// ===========================================================================
// GNEAdditionalHandlerBeta::LastInsertedElement method definitions
// ===========================================================================

void
GNEAdditionalHandlerBeta::LastInsertedElement::insertElement(SumoXMLTag tag) {
    myInsertedElements.push_back(StackElement(tag));
}


void
GNEAdditionalHandlerBeta::LastInsertedElement::commitAdditionalInsertion(GNEAdditional* additional) {
    myInsertedElements.back().additional = additional;
}


void
GNEAdditionalHandlerBeta::LastInsertedElement::commitShapeInsertion(GNEShape* shapeCreated) {
    myInsertedElements.back().shape = shapeCreated;
}


void
GNEAdditionalHandlerBeta::LastInsertedElement::commitTAZElementInsertion(GNETAZElement* TAZElementCreated) {
    myInsertedElements.back().TAZElement = TAZElementCreated;
}


void
GNEAdditionalHandlerBeta::LastInsertedElement::popElement() {
...
GNEAdditional*
GNEAdditionalHandlerBeta::LastInsertedElement::getAdditionalParent(GNENet* net, SumoXMLTag expectedTag) const {
...
GNEShape*
GNEAdditionalHandlerBeta::LastInsertedElement::getShapeParent(GNENet* net, SumoXMLTag expectedTag) const {
    if (myInsertedElements.size() < 2) {
...
GNETAZElement*
GNEAdditionalHandlerBeta::LastInsertedElement::getTAZElementParent(GNENet* net, SumoXMLTag expectedTag) const {
    if (myInsertedElements.size() < 2) {
...
GNEAdditional*
GNEAdditionalHandlerBeta::LastInsertedElement::getLastInsertedAdditional() const {
...
GNEShape*
GNEAdditionalHandlerBeta::LastInsertedElement::getLastInsertedShape() const {
...
GNETAZElement*
GNEAdditionalHandlerBeta::LastInsertedElement::getLastInsertedTAZElement() const {
...
GNEAdditionalHandlerBeta::LastInsertedElement::StackElement::StackElement(SumoXMLTag _tag) :
    tag(_tag),
    additional(nullptr),
    shape(nullptr),
    TAZElement(nullptr) {
