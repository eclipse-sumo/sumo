...
GNEMoveOperation* GNERouteProbReroute::getMoveOperation(const double shapeOffset)
{
    return nullptr;
}

void GNERouteProbReroute::removeGeometryPoint(const Position clickedPosition, GNEUndoList* undoList)
{
}
