...
GNEContainerStop::drawGL(const GUIVisualizationSettings& s) const {
    ...
    if (myNet->getViewNet()->getDataViewOptions().showAdditionals()) {
        ...
        if (s.drawAdditionals(containerStopExaggeration)) {
            ...
            GNEGeometry::drawGeometry(s, myNet->getViewNet()->getPositionInformation(), myAdditionalGeometry, s.stoppingPlaceSettings.containerStopWidth * containerStopExaggeration);
            // draw detail
