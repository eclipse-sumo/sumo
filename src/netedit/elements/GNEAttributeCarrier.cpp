...
GNEAttributeCarrier::fillNetworkElements() {
    ...
    currentTag = SUMO_TAG_CROSSING;
    {
        ...
        myTagProperties[currentTag] = GNETagProperties(currentTag,
            GNETagProperties::NETWORKELEMENT,
            GNETagProperties::DRAWABLE | GNETagProperties::SELECTABLE,
            GUIIcon::CROSSING, SUMO_TAG_JUNCTION);
        // set values of attributes
        attrProperty = GNEAttributeProperties(SUMO_ATTR_ID,
            GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE,
            "The ID of Crossing");
    ...
    currentTag = SUMO_TAG_CONNECTION;
    {
        ...
        myTagProperties[currentTag] = GNETagProperties(currentTag,
            GNETagProperties::NETWORKELEMENT,
            GNETagProperties::DRAWABLE | GNETagProperties::SELECTABLE,
            GUIIcon::CONNECTION, SUMO_TAG_EDGE);
        // set values of attributes
        attrProperty = GNEAttributeProperties(SUMO_ATTR_FROM,
            GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE | GNEAttributeProperties::UPDATEGEOMETRY,
...
GNEAttributeCarrier::fillAdditionals() {
    ...
    SumoXMLTag currentTag = SUMO_TAG_BUS_STOP;
    {
        ...
        myTagProperties[currentTag] = GNETagProperties(currentTag,
            ...
            GUIIcon::CONTAINERSTOP, SUMO_TAG_LANE);
        // set values of attributes
        attrProperty = GNEAttributeProperties(SUMO_ATTR_ID,
            GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE,
            "The id of bus stop");
    ...
    currentTag = SUMO_TAG_ACCESS;
    {
        ...
        myTagProperties[currentTag] = GNETagProperties(currentTag,
            ...
            GNETagProperties::DRAWABLE | GNETagProperties::SELECTABLE | GNETagProperties::PARENT | GNETagProperties::BLOCKMOVEMENT,
    ...
    currentTag = SUMO_TAG_CHARGING_STATION;
    {
        ...
        myTagProperties[currentTag] = GNETagProperties(currentTag,
            GNETagProperties::ADDITIONALELEMENT | GNETagProperties::STOPPINGPLACE,
            GNETagProperties::DRAWABLE | GNETagProperties::SELECTABLE | GNETagProperties::BLOCKMOVEMENT | GNETagProperties::MASKSTARTENDPOS,
            GUIIcon::CHARGINGSTATION, SUMO_TAG_LANE);
        // set values of attributes
        attrProperty = GNEAttributeProperties(SUMO_ATTR_ID,
            GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE,
    ...
    currentTag = SUMO_TAG_PARKING_AREA;
    {
        ...
        myTagProperties[currentTag] = GNETagProperties(currentTag,
            ...
            GUIIcon::PARKINGAREA, SUMO_TAG_LANE);
        // set values of attributes
        attrProperty = GNEAttributeProperties(SUMO_ATTR_ID,
            GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE,
    ...
    currentTag = SUMO_TAG_PARKING_SPACE;
    {
        ...
        myTagProperties[currentTag] = GNETagProperties(currentTag,
            GNETagProperties::ADDITIONALELEMENT,
            GNETagProperties::DRAWABLE | GNETagProperties::RTREE | GNETagProperties::MASKXYZPOSITION | GNETagProperties::SELECTABLE | GNETagProperties::PARENT | GNETagProperties::REPARENT | GNETagProperties::BLOCKMOVEMENT,
    ...
    currentTag = SUMO_TAG_E2DETECTOR_MULTILANE;
    {
        ...
        myTagProperties[currentTag] = GNETagProperties(currentTag,
            GNETagProperties::ADDITIONALELEMENT | GNETagProperties::DETECTOR,
            GNETagProperties::DRAWABLE | GNETagProperties::SELECTABLE | GNETagProperties::PARENT | GNETagProperties::SYNONYM | GNETagProperties::BLOCKMOVEMENT,
            GUIIcon::E2, SUMO_TAG_LANE, SUMO_TAG_E2DETECTOR);
        // set "file" as deprecated attribute
        myTagProperties[currentTag].addDeprecatedAttribute(SUMO_ATTR_CONT);
        // set values of attributes
        attrProperty = GNEAttributeProperties(SUMO_ATTR_ID,
    ...
    currentTag = SUMO_TAG_E3DETECTOR;
    {
        ...
        myTagProperties[currentTag] = GNETagProperties(currentTag,
            GNETagProperties::ADDITIONALELEMENT | GNETagProperties::DETECTOR,
            GNETagProperties::DRAWABLE | GNETagProperties::RTREE | GNETagProperties::SELECTABLE | GNETagProperties::BLOCKMOVEMENT | GNETagProperties::MINIMUMCHILDREN | GNETagProperties::AUTOMATICSORTING,
            GUIIcon::E3);
        // set values of attributes
        attrProperty = GNEAttributeProperties(SUMO_ATTR_ID,
            GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE,
    ...
    currentTag = SUMO_TAG_DET_ENTRY;
    {
        ...
        myTagProperties[currentTag] = GNETagProperties(currentTag,
            GNETagProperties::ADDITIONALELEMENT | GNETagProperties::DETECTOR,
            GNETagProperties::DRAWABLE | GNETagProperties::SELECTABLE | GNETagProperties::PARENT | GNETagProperties::REPARENT | GNETagProperties::BLOCKMOVEMENT,
    ...
    currentTag = SUMO_TAG_LANECALIBRATOR;
    {
        ...
        myTagProperties[currentTag] = GNETagProperties(currentTag,
            ...
            GUIIcon::CALIBRATOR, SUMO_TAG_NOTHING, SUMO_TAG_CALIBRATOR);
        // set values of attributes
        attrProperty = GNEAttributeProperties(SUMO_ATTR_ID,
            GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE,
            "The id of Calibrator");
...
GNEAttributeCarrier::fillTAZElements() {
    ...
    SumoXMLTag currentTag = SUMO_TAG_TAZ;
    {
        ...
        myTagProperties[currentTag] = GNETagProperties(currentTag,
            ...
            GNETagProperties::DRAWABLE | GNETagProperties::RTREE | GNETagProperties::SELECTABLE | GNETagProperties::BLOCKMOVEMENT | GNETagProperties::BLOCKSHAPE | GNETagProperties::AUTOMATICSORTING,
            GUIIcon::TAZ);
        // set values of attributes
        attrProperty = GNEAttributeProperties(SUMO_ATTR_ID,
            GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE,
...
GNEAttributeCarrier::fillDemandElements() {
    ...
    SumoXMLTag currentTag = SUMO_TAG_ROUTE;
    {
        ...
        myTagProperties[currentTag] = GNETagProperties(currentTag,
            ...
            GNETagProperties::DRAWABLE | GNETagProperties::SELECTABLE | GNETagProperties::PARENT,
            GUIIcon::ROUTE);
    ...
    currentTag = SUMO_TAG_PTYPE;
    {
        ...
        myTagProperties[currentTag] = GNETagProperties(currentTag,
            ...
            GUIIcon::PTYPE, SUMO_TAG_NOTHING, SUMO_TAG_VTYPE);
...
GNEAttributeCarrier::fillVehicleElements() {
    ...
    currentTag = GNE_TAG_VEHICLE_WITHROUTE;
    {
        ...
        myTagProperties[currentTag] = GNETagProperties(currentTag,
            ...
            GUIIcon::VEHICLE, SUMO_TAG_NOTHING, SUMO_TAG_VEHICLE);
        // set values of attributes
        attrProperty = GNEAttributeProperties(SUMO_ATTR_ID,
            GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE,
...
GNEAttributeCarrier::fillStopElements() {
    ...
    SumoXMLTag currentTag = SUMO_TAG_STOP_LANE;
    {
        ...
        myTagProperties[currentTag] = GNETagProperties(currentTag,
            ...
            GNETagProperties::DRAWABLE | GNETagProperties::SELECTABLE | GNETagProperties::MASKSTARTENDPOS | GNETagProperties::NOPARAMETERS,
            GUIIcon::STOPELEMENT);
        // set values of attributes
        attrProperty = GNEAttributeProperties(SUMO_ATTR_LANE,
            GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE | GNEAttributeProperties::UPDATEGEOMETRY,
    ...
    currentTag = SUMO_TAG_STOP_BUSSTOP;
    {
        ...
        myTagProperties[currentTag] = GNETagProperties(currentTag,
            GNETagProperties::DEMANDELEMENT | GNETagProperties::STOP,
            GNETagProperties::DRAWABLE | GNETagProperties::SELECTABLE | GNETagProperties::NOPARAMETERS,
            GUIIcon::STOPELEMENT);
        // set values of attributes
...
GNEAttributeCarrier::fillPersonPlanTrips() {
    ...
    SumoXMLTag currentTag = GNE_TAG_PERSONTRIP_EDGE_EDGE;
    {
        ...
        myTagProperties[currentTag] = GNETagProperties(currentTag,
            ...
            GNETagProperties::DRAWABLE | GNETagProperties::SELECTABLE | GNETagProperties::PARENT | GNETagProperties::SORTINGCHILDREN | GNETagProperties::PERSONPLAN_START_EDGE | GNETagProperties::PERSONPLAN_END_EDGE,
            GUIIcon::PERSONTRIP_FROMTO);
        // set values of attributes
        attrProperty = GNEAttributeProperties(SUMO_ATTR_FROM,
            GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE | GNEAttributeProperties::UPDATEGEOMETRY,
            "The name of the edge the " + toString(currentTag) + " starts at");
    ...
    currentTag = GNE_TAG_PERSONTRIP_EDGE_BUSSTOP;
    {
        ...
        myTagProperties[currentTag] = GNETagProperties(currentTag,
            GNETagProperties::DEMANDELEMENT | GNETagProperties::PERSONPLAN | GNETagProperties::PERSONTRIP,
            GNETagProperties::DRAWABLE | GNETagProperties::SELECTABLE | GNETagProperties::PARENT | GNETagProperties::SORTINGCHILDREN | GNETagProperties::PERSONPLAN_START_EDGE | GNETagProperties::PERSONPLAN_END_BUSSTOP,
    ...
    currentTag = GNE_TAG_PERSONTRIP_BUSSTOP_EDGE;
    {
        ...
        myTagProperties[currentTag] = GNETagProperties(currentTag,
            GNETagProperties::DEMANDELEMENT | GNETagProperties::PERSONPLAN | GNETagProperties::PERSONTRIP,
            GNETagProperties::DRAWABLE | GNETagProperties::SELECTABLE | GNETagProperties::PARENT | GNETagProperties::SORTINGCHILDREN | GNETagProperties::PERSONPLAN_START_BUSSTOP | GNETagProperties::PERSONPLAN_END_EDGE,
            GUIIcon::PERSONTRIP_BUSSTOP);
        // set values of attributes
    ...
    currentTag = GNE_TAG_PERSONTRIP_BUSSTOP_BUSSTOP;
    {
        ...
        myTagProperties[currentTag] = GNETagProperties(currentTag,
            GNETagProperties::DEMANDELEMENT | GNETagProperties::PERSONPLAN | GNETagProperties::PERSONTRIP,
            GNETagProperties::DRAWABLE | GNETagProperties::SELECTABLE | GNETagProperties::PARENT | GNETagProperties::SORTINGCHILDREN | GNETagProperties::PERSONPLAN_START_BUSSTOP | GNETagProperties::PERSONPLAN_END_BUSSTOP,
            GUIIcon::PERSONTRIP_BUSSTOP);
        // set values of attributes
        attrProperty = GNEAttributeProperties(GNE_ATTR_FROM_BUSSTOP,
            GNEAttributeProperties::STRING | GNEAttributeProperties::UNIQUE | GNEAttributeProperties::UPDATEGEOMETRY,
...
GNEAttributeCarrier::fillDataElements() {
    ...
    SumoXMLTag currentTag = SUMO_TAG_DATASET;
    {
        ...
        myTagProperties[currentTag] = GNETagProperties(currentTag,
            ...
            GNETagProperties::AUTOMATICSORTING | GNETagProperties::NOPARAMETERS,
            GUIIcon::DATASET);
    ...
    currentTag = SUMO_TAG_DATAINTERVAL;
    {
        ...
        myTagProperties[currentTag] = GNETagProperties(currentTag,
            GNETagProperties::DATAELEMENT,
            GNETagProperties::PARENT | GNETagProperties::NOPARAMETERS,
    ...
    currentTag = SUMO_TAG_MEANDATA_EDGE;
    {
        ...
        myTagProperties[currentTag] = GNETagProperties(currentTag,
            ...
            GNETagProperties::DRAWABLE | GNETagProperties::PARAMETERSDOUBLE | GNETagProperties::SELECTABLE,
