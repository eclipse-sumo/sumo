...
public:
    ...
    void startMoveShape(const PositionVector &shapeBevoreMoving, const double offsetMovingShape, const double sensibility);

    /// @brief get shape before moving
    const PositionVector& getShapeBevoreMoving() const;

    /// @brief get position over shape before moving
    const Position &getPosOverShapeBevoreMoving() const;
...
private:
    ...
    PositionVector myShapeBevoreMoving;
