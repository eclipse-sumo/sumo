...
/****************************************************************************/
/// @file    TraCIServerAPI_ParkingArea.h
...
// ===========================================================================
/**
 * @class TraCIServerAPI_ParkingArea
 * @brief APIs for getting/setting busstop values via TraCI
 */
class TraCIServerAPI_ParkingArea {
public:
    /** @brief Processes a get value command (Command 0xa6: Get ParkingArea Variable)
     *
    ...
    /** @brief Processes a set value command (Command 0xc6: Change ParkingArea State)
     *
     * @param[in] server The TraCI-server-instance which schedules this request
     * @param[in] inputStorage The storage to read the command from
     * @param[out] outputStorage The storage to write the result to
