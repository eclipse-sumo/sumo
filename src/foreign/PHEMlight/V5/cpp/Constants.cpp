...
const std::string Constants::strLKW = "RT";
const std::string Constants::strLSZ = "TT";
const std::string Constants::strRB = "CO";
const std::string Constants::strLB = "CB";
const std::string Constants::strMR2 = "MC_2S";
const std::string Constants::strMR4 = "MC_4S";
const std::string Constants::strMR = "MC";
...
const std::string Constants::strMidi = "Midi";
const std::string Constants::strHeavy = "Heavy";
const std::string Constants::strSU = "SU";
