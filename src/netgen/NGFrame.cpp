...
NGFrame::fillOptions() {
    ...
    oc.addDescription("type-files", TL("Input"), TL("Read edge-type defs from FILE"));

    oc.doRegister("alphanumerical-ids", new Option_Bool(true));
    oc.addDescription("alphanumerical-ids", TL("Output"), TL("The Ids of generated nodes use an alphanumerical code for easier readability when possible"));

    // register processing options
    oc.doRegister("turn-lanes", new Option_Integer(0));
    oc.addDescription("turn-lanes", TL("Processing"), TL("Generate INT left-turn lanes"));
    oc.doRegister("turn-lanes.length", new Option_Float(20));
    oc.addDescription("turn-lanes.length", TL("Processing"), TL("Set the length of generated turning lanes to FLOAT"));

    oc.doRegister("perturb-x", new Option_String("0"));
    oc.addDescription("perturb-x", TL("Processing"), TL("Apply random spatial perturbation in x direction according the the given distribution"));
    oc.doRegister("perturb-y", new Option_String("0"));
    oc.addDescription("perturb-y", TL("Processing"), TL("Apply random spatial perturbation in y direction according the the given distribution"));
    oc.doRegister("perturb-z", new Option_String("0"));
    oc.addDescription("perturb-z", TL("Processing"), TL("Apply random spatial perturbation in z direction according the the given distribution"));


    //  register grid-net options
    oc.doRegister("grid", 'g', new Option_Bool(false));
    oc.addSynonyme("grid", "grid-net", true);
    oc.addDescription("grid", TL("Grid Network"), TL("Forces NETGEN to build a grid-like network"));
    ...
    oc.addDescription("grid.number", TL("Grid Network"), TL("The number of junctions in both dirs"));
    ...
    oc.addDescription("grid.length", TL("Grid Network"), TL("The length of streets in both dirs"));
    ...
    oc.addDescription("grid.x-number", TL("Grid Network"), TL("The number of junctions in x-dir; Overrides --grid-number"));
    ...
    oc.addDescription("grid.y-number", TL("Grid Network"), TL("The number of junctions in y-dir; Overrides --grid-number"));
    ...
    oc.addDescription("grid.x-length", TL("Grid Network"), TL("The length of horizontal streets; Overrides --grid-length"));
    ...
    oc.addDescription("grid.y-length", TL("Grid Network"), TL("The length of vertical streets; Overrides --grid-length"));

    oc.doRegister("grid.attach-length", new Option_Float(0));
    oc.addSynonyme("grid.attach-length", "attach-length", true);
    oc.addDescription("grid.attach-length", TL("Grid Network"), TL("The length of streets attached at the boundary; 0 means no streets are attached"));

    oc.doRegister("grid.x-attach-length", new Option_Float(0));
    oc.addDescription("grid.x-attach-length", TL("Grid Network"), TL("The length of streets attached at the boundary in x direction; 0 means no streets are attached"));
    oc.doRegister("grid.y-attach-length", new Option_Float(0));
    oc.addDescription("grid.y-attach-length", TL("Grid Network"), TL("The length of streets attached at the boundary in y direction; 0 means no streets are attached"));

    //  register spider-net options
    oc.doRegister("spider", 's', new Option_Bool(false));
    oc.addSynonyme("spider", "spider-net", true);
    oc.addDescription("spider", TL("Spider Network"), TL("Forces NETGEN to build a spider-net-like network"));
    ...
    oc.addDescription("spider.arm-number", TL("Spider Network"), TL("The number of axes within the net"));
    ...
    oc.addDescription("spider.circle-number", TL("Spider Network"), TL("The number of circles of the net"));
    ...
    oc.addDescription("spider.space-radius", TL("Spider Network"), TL("The distances between the circles"));
    ...
    oc.addDescription("spider.omit-center", TL("Spider Network"), TL("Omit the central node of the network"));


    //  register random-net options
    oc.doRegister("rand", 'r', new Option_Bool(false));
    oc.addSynonyme("rand", "random-net", true);
    oc.addDescription("rand", TL("Random Network"), TL("Forces NETGEN to build a random network"));
    ...
    oc.addDescription("rand.iterations", TL("Random Network"), TL("Describes how many times an edge shall be added to the net"));
    ...
    oc.addDescription("bidi-probability", TL("Random Network"), TL("Defines the probability to build a reverse edge"));
    ...
    oc.addDescription("rand.max-distance", TL("Random Network"), TL("The maximum distance for each edge"));
    ...
    oc.addDescription("rand.min-distance", TL("Random Network"), TL("The minimum distance for each edge"));
    ...
    oc.addDescription("rand.min-angle", TL("Random Network"), TL("The minimum angle for each pair of (bidirectional) roads in DEGREES"));
    ...
    oc.addDescription("rand.num-tries", TL("Random Network"), TL("The number of tries for creating each node"));
    ...
    oc.addDescription("rand.connectivity", TL("Random Network"), TL("Probability for roads to continue at each node"));
    ...
    oc.addDescription("rand.neighbor-dist1", TL("Random Network"), TL("Probability for a node having exactly 1 neighbor"));
    ...
    oc.addDescription("rand.neighbor-dist2", TL("Random Network"), TL("Probability for a node having exactly 2 neighbors"));
    ...
    oc.addDescription("rand.neighbor-dist3", TL("Random Network"), TL("Probability for a node having exactly 3 neighbors"));
    ...
    oc.addDescription("rand.neighbor-dist4", TL("Random Network"), TL("Probability for a node having exactly 4 neighbors"));
    ...
    oc.addDescription("rand.neighbor-dist5", TL("Random Network"), TL("Probability for a node having exactly 5 neighbors"));
    ...
    oc.addDescription("rand.neighbor-dist6", TL("Random Network"), TL("Probability for a node having exactly 6 neighbors"));

    oc.doRegister("random-lanenumber", new Option_Bool(false));
    oc.addSynonyme("random-lanenumber", "rand.random-lanenumber", false);
    oc.addDescription("random-lanenumber", TL("Random Network"), TL("Draw lane numbers randomly from [1,default.lanenumber]"));

    oc.doRegister("random-priority", new Option_Bool(false));
    oc.addSynonyme("random-priority", "rand.random-priority", false);
    oc.addDescription("random-priority", TL("Random Network"), TL("Draw edge priority randomly from [1,default.priority]"));

    oc.doRegister("random-type", new Option_Bool(false));
    oc.addDescription("random-type", TL("Random Network"), TL("Draw edge type randomly from all loaded types"));

    oc.doRegister("rand.grid", new Option_Bool(false));
    oc.addDescription("rand.grid", TL("Random Network"), TL("Place nodes on a regular grid with spacing rand.min-distance"));
}
