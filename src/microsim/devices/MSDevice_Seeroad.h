 ...
 * @see MSDevice
 */
class MSDevice_Seeroad : public MSVehicleDevice {
public:
    /** @brief Inserts MSDevice_Seeroad-options
...
public:
	...
	/// @brief Parameter loader Helper -> options
	static double getStdev(const SUMOVehicle& v);
	static double getOffset(const SUMOVehicle& v);

	/// @brief Apply Measurement Model (Noise etc)
	double applyModel(const double raw);
...
private:
     ...
     */
    MSDevice_Seeroad(SUMOVehicle& holder, const std::string& id, double frictionCoefficient,
                     double stdev, double offset); //check stdev/offset



private:
    // private state members of the Seeroad device
...
private:
    ...
    MSDevice_Seeroad(const MSDevice_Seeroad&);

    /// @brief Invalidated assignment operator.
    MSDevice_Seeroad& operator=(const MSDevice_Seeroad&);
