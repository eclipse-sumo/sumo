...
public:
    ...
    */
    int getModelID() const {
        return SUMO_TAG_CF_ACC_FRICTION;
    }
    /// @}
...
private:
    ...
    MSCFModel_ACCFric& operator=(const MSCFModel_ACCFric& s);
};
