 ...
 * 
 */
@WebService(name = "Service_Impl", targetNamespace = "http://ws.tudresden.de/")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface ServiceImpl {
    ...
    @Action(input = "start service", output = "http://ws.tudresden.de/Service_Impl/startResponse")
    public String start(
    ...
    @Action(input = "stop service", output = "http://ws.tudresden.de/Service_Impl/stopResponse")
    public String stop(
        @WebParam(name = "user", targetNamespace = "")
        String user);
    ...
    @Action(input = "set the sumo binary", output = "http://ws.tudresden.de/Service_Impl/setSumoBinaryResponse")
    ...
    @Action(input = "set the configuration file", output = "http://ws.tudresden.de/Service_Impl/setConfigResponse")
    ...
    @Action(input = "add Options to sumo binary", output = "http://ws.tudresden.de/Service_Impl/addOptionResponse")
    ...
    @Action(input = "do timestep", output = "http://ws.tudresden.de/Service_Impl/doTimestepResponse")
    ...
    @Action(input = "version info", output = "http://ws.tudresden.de/Service_Impl/versionResponse")
    ...
    @Action(input = "status", output = "http://ws.tudresden.de/Service_Impl/get_StatusResponse")
    ...
    @Action(input = "activate text output. only for debugging purposes.", output = "http://ws.tudresden.de/Service_Impl/TXT_outputResponse")
    ...
    @Action(input = "last action time", output = "http://ws.tudresden.de/Service_Impl/LastActionTimeResponse")
    ...
    @Action(input = "Trafficlights: setCompleteRedYellowGreenDefinition", output = "http://ws.tudresden.de/Service_Impl/Trafficlights_setCompleteRedYellowGreenDefinitionResponse")
     ...
     * @param tlsID
     * @return
     *     returns de.tudresden.ws.SumoTLSLogic
     */
    ...
    @Action(input = "Trafficlights: getCompleteRedYellowGreenDefinition", output = "http://ws.tudresden.de/Service_Impl/Trafficlights_getCompleteRedYellowGreenDefinitionResponse")
    public SumoTLSLogic trafficlightsGetCompleteRedYellowGreenDefinition(
        @WebParam(name = "tlsID", targetNamespace = "")
        String tlsID);
    ...
    @Action(input = "Edge: adapt the Traveltime", output = "http://ws.tudresden.de/Service_Impl/Edge_adaptTraveltimeResponse")
    ...
    @Action(input = "Edge: setEffort", output = "http://ws.tudresden.de/Service_Impl/Edge_setEffortResponse")
    ...
    @Action(input = "Edge: Set a new maximum speed (in m/s) for all lanes of the edge..", output = "http://ws.tudresden.de/Service_Impl/Edge_setMaxSpeedResponse")
    ...
    @Action(input = "Vehicle: changeLane", output = "http://ws.tudresden.de/Service_Impl/Vehicle_changeLaneResponse")
    ...
    @Action(input = "Vehicle: add", output = "http://ws.tudresden.de/Service_Impl/Vehicle_addResponse")
    ...
    @Action(input = "Polygon: add", output = "http://ws.tudresden.de/Service_Impl/Polygon_addResponse")
    ...
    @Action(input = "Poi: remove", output = "http://ws.tudresden.de/Service_Impl/Poi_removeResponse")
    ...
    @Action(input = "Poi: setColor", output = "http://ws.tudresden.de/Service_Impl/Poi_setColorResponse")
    ...
    @Action(input = "Poi: setType", output = "http://ws.tudresden.de/Service_Impl/Poi_setTypeResponse")
    ...
    @Action(input = "Gui: Set the current offset for the given view.", output = "http://ws.tudresden.de/Service_Impl/GUI_setOffsetResponse")
    ...
    @Action(input = "Gui: Set the current coloring scheme for the given view.", output = "http://ws.tudresden.de/Service_Impl/GUI_setSchemaResponse")
    ...
    @Action(input = "Gui: Set the current zoom factor for the given view.", output = "http://ws.tudresden.de/Service_Impl/GUI_setZoomResponse")
    ...
    @Action(input = "Route: add", output = "http://ws.tudresden.de/Service_Impl/Route_addResponse")
    ...
    @Action(input = "Simulation: getStartingTeleportIDList", output = "http://ws.tudresden.de/Service_Impl/Simulation_getStartingTeleportIDListResponse")
    ...
    @Action(input = "Simulation: getStartingTeleportNumber", output = "http://ws.tudresden.de/Service_Impl/Simulation_getStartingTeleportNumberResponse")
    ...
    @Action(input = "Trafficlights: getControlledLanes", output = "http://ws.tudresden.de/Service_Impl/Trafficlights_getControlledLanesResponse")
    ...
    @Action(input = "Trafficlights: getControlledLinks", output = "http://ws.tudresden.de/Service_Impl/Trafficlights_getControlledLinksResponse")
    ...
    @Action(input = "Trafficlights: Returns the phase duration", output = "http://ws.tudresden.de/Service_Impl/Trafficlights_getPhaseDurationResponse")
    ...
    @Action(input = "Trafficlights: getRedYellowGreenState", output = "http://ws.tudresden.de/Service_Impl/Trafficlights_getRedYellowGreenStateResponse")
    ...
    @Action(input = "Inductionloop: getLastStepMeanLength", output = "http://ws.tudresden.de/Service_Impl/Inductionloop_getLastStepMeanLengthResponse")
    ...
    @Action(input = "Inductionloop: getLastStepMeanSpeed", output = "http://ws.tudresden.de/Service_Impl/Inductionloop_getLastStepMeanSpeedResponse")
    ...
    @Action(input = "Inductionloop: getLastStepOccupancy", output = "http://ws.tudresden.de/Service_Impl/Inductionloop_getLastStepOccupancyResponse")
    ...
    @Action(input = "Inductionloop: getLastStepVehicleIDs", output = "http://ws.tudresden.de/Service_Impl/Inductionloop_getLastStepVehicleIDsResponse")
    ...
    @Action(input = "Inductionloop: getLastStepVehicleNumber", output = "http://ws.tudresden.de/Service_Impl/Inductionloop_getLastStepVehicleNumberResponse")
    ...
    @Action(input = "Inductionloop: getTimeSinceDetection", output = "http://ws.tudresden.de/Service_Impl/Inductionloop_getTimeSinceDetectionResponse")
    ...
    @Action(input = "Lane: getAllowed", output = "http://ws.tudresden.de/Service_Impl/Lane_getAllowedResponse")
    ...
    @Action(input = "Lane: Returns the CO2 emission in mg for the last time step on the given lane.", output = "http://ws.tudresden.de/Service_Impl/Lane_getCO2EmissionResponse")
    ...
    @Action(input = "Lane: Returns the CO emission in mg for the last time step on the given lane.", output = "http://ws.tudresden.de/Service_Impl/Lane_getCOEmissionResponse")
    ...
    @Action(input = "Lane: getDisallowed", output = "http://ws.tudresden.de/Service_Impl/Lane_getDisallowedResponse")
    ...
    @Action(input = "Lane: getEdgeID", output = "http://ws.tudresden.de/Service_Impl/Lane_getEdgeIDResponse")
    ...
    @Action(input = "Lane: Returns the fuel consumption in ml for the last time step on the given lane.", output = "http://ws.tudresden.de/Service_Impl/Lane_getFuelConsumptionResponse")
    ...
    @Action(input = "Lane: Returns the HC emission in mg for the last time step on the given lane.", output = "http://ws.tudresden.de/Service_Impl/Lane_getHCEmissionResponse")
    ...
    @Action(input = "Lane: Returns a list of all lanes in the network.", output = "http://ws.tudresden.de/Service_Impl/Lane_getIDListResponse")
    ...
    @Action(input = "Lane: Returns the number of all lanes in the network.", output = "http://ws.tudresden.de/Service_Impl/Lane_getIDCountResponse")
    ...
    @Action(input = "Lane: Returns the total number of halting vehicles for the last time step on the given lane.", output = "http://ws.tudresden.de/Service_Impl/Lane_getLastStepHaltingNumberResponse")
    ...
    @Action(input = "Lane: Returns the total vehicle length in m for the last time step on the given lane.", output = "http://ws.tudresden.de/Service_Impl/Lane_getLastStepLengthResponse")
    ...
    @Action(input = "Lane: Returns the average speed in m/s for the last time step on the given lane.", output = "http://ws.tudresden.de/Service_Impl/Lane_getLastStepMeanSpeedResponse")
    ...
    @Action(input = "Lane: Returns the occupancy in % for the last time step on the given lane.", output = "http://ws.tudresden.de/Service_Impl/Lane_getLastStepOccupancyResponse")
    ...
    @Action(input = "Lane: Returns the subscription results for the last time step and the given lane.", output = "http://ws.tudresden.de/Service_Impl/Lane_getLastStepVehicleIDsResponse")
    ...
    @Action(input = "Lane: Returns the total number of vehicles for the last time step on the given lane.", output = "http://ws.tudresden.de/Service_Impl/Lane_getLastStepVehicleNumberResponse")
    ...
    @Action(input = "Lane: getLength", output = "http://ws.tudresden.de/Service_Impl/Lane_getLengthResponse")
    ...
    @Action(input = "Lane: getLinkNumber", output = "http://ws.tudresden.de/Service_Impl/Lane_getLinkNumberResponse")
    public int laneGetLinkNumber(
        @WebParam(name = "laneID", targetNamespace = "")
        String laneID);
    ...
    @Action(input = "Lane: getMaxSpeed", output = "http://ws.tudresden.de/Service_Impl/Lane_getMaxSpeedResponse")
    ...
    @Action(input = "Lane: getWaitingTime", output = "http://ws.tudresden.de/Service_Impl/Lane_getWaitingTimeResponse")
    ...
    @Action(input = "Lane: Returns the NOx emission in mg for the last time step on the given lane.", output = "http://ws.tudresden.de/Service_Impl/Lane_getNOxEmissionResponse")
    ...
    @Action(input = "Lane: Returns the noise emission in db for the last time step on the given lane.", output = "http://ws.tudresden.de/Service_Impl/Lane_getNoiseEmissionResponse")
    ...
    @Action(input = "Lane: Returns the particular matter emission in mg for the last time step on the given lane.", output = "http://ws.tudresden.de/Service_Impl/Lane_getPMxEmissionResponse")
    ...
    @Action(input = "Lane: Returns the estimated travel time in s for the last time step on the given lane.", output = "http://ws.tudresden.de/Service_Impl/Lane_getTraveltimeResponse")
    ...
    @Action(input = "Polygon: Returns the subscription results for the last time step and the given poi.", output = "http://ws.tudresden.de/Service_Impl/Polygon_getColorResponse")
    ...
    @Action(input = "Polygon: Returns a list of all polygons in the network.", output = "http://ws.tudresden.de/Service_Impl/Polygon_getIDListResponse")
    ...
    @Action(input = "Polygon: Returns the number of all polygons in the network.", output = "http://ws.tudresden.de/Service_Impl/Polygon_getIDCountResponse")
    ...
    @Action(input = "Polygon: getShape", output = "http://ws.tudresden.de/Service_Impl/Polygon_getShapeResponse")
    ...
    @Action(input = "Polygon: getType", output = "http://ws.tudresden.de/Service_Impl/Polygon_getTypeResponse")
    ...
    @Action(input = "Poi: Returns the number of all pois in the network.", output = "http://ws.tudresden.de/Service_Impl/Poi_getIDCountResponse")
    ...
    @Action(input = "Poi: getPosition", output = "http://ws.tudresden.de/Service_Impl/Poi_getPositionResponse")
    ...
    @Action(input = "Junction: Returns a list of all junctions in the network.", output = "http://ws.tudresden.de/Service_Impl/Junction_getIDListResponse")
    ...
    @Action(input = "Junction: getShape", output = "http://ws.tudresden.de/Service_Impl/Junction_getShapeResponse")
    ...
    @Action(input = "Junction: Returns the number of all junctions in the network.", output = "http://ws.tudresden.de/Service_Impl/Junction_getIDCountResponse")
    ...
    @Action(input = "Junction: Returns the subscription results for the last time step and the given junction.", output = "http://ws.tudresden.de/Service_Impl/Junction_getPositionResponse")
    ...
    @Action(input = "Gui: Returns the subscription results for the last time step and the given view.", output = "http://ws.tudresden.de/Service_Impl/GUI_getBoundaryResponse")
    ...
    @Action(input = "Route: Returns the subscription results for the last time step and the given route.", output = "http://ws.tudresden.de/Service_Impl/Route_getEdgesResponse")
    ...
    @Action(input = "Route: Returns a list of all routes in the network.", output = "http://ws.tudresden.de/Service_Impl/Route_getIDListResponse")
    ...
    @Action(input = "Route: Returns the number of all routes in the network.", output = "http://ws.tudresden.de/Service_Impl/Route_getIDCountResponse")
    ...
    @Action(input = "Inductionloop: Returns a list of all induction loops in the network.", output = "http://ws.tudresden.de/Service_Impl/Inductionloop_getIDListResponse")
    ...
    @Action(input = "Inductionloop: Returns the number of induction loops in the network.", output = "http://ws.tudresden.de/Service_Impl/Inductionloop_getIDCountResponse")
    ...
    @Action(input = "Inductionloop: Returns the id of the lane the loop is on.", output = "http://ws.tudresden.de/Service_Impl/Inductionloop_getLaneIDResponse")
    ...
    @Action(input = "Inductionloop: Returns the position measured from the beginning of the lane.", output = "http://ws.tudresden.de/Service_Impl/Inductionloop_getPositionResponse")
    ...
    @Action(input = "Inductionloop: Returns the subscription results for the last time step and the given loop.", output = "http://ws.tudresden.de/Service_Impl/Inductionloop_getVehicleDataResponse")
    public int inductionloopGetVehicleData(
        @WebParam(name = "loopID", targetNamespace = "")
        List<String> loopID);
    ...
    @Action(input = "Trafficlights: setPhaseDuration", output = "http://ws.tudresden.de/Service_Impl/Trafficlights_setPhaseDurationResponse")
    ...
    @Action(input = "Trafficlights: setRedYellowGreenState", output = "http://ws.tudresden.de/Service_Impl/Trafficlights_setRedYellowGreenStateResponse")
    ...
    @Action(input = "Multientryexit: Returns the subscription results for the last time step and the given detector.", output = "http://ws.tudresden.de/Service_Impl/Multientryexit_getLastStepHaltingNumberResponse")
    ...
    @Action(input = "Multientryexit: getLastStepMeanSpeed", output = "http://ws.tudresden.de/Service_Impl/Multientryexit_getLastStepMeanSpeedResponse")
    ...
    @Action(input = "Multientryexit: getLastStepVehicleIDs", output = "http://ws.tudresden.de/Service_Impl/Multientryexit_getLastStepVehicleIDsResponse")
    ...
    @Action(input = "Multientryexit: getLastStepVehicleNumber", output = "http://ws.tudresden.de/Service_Impl/Multientryexit_getLastStepVehicleNumberResponse")
    ...
    @Action(input = "ArealDetector: getJamLengthVehicle", output = "http://ws.tudresden.de/Service_Impl/ArealDetector_getJamLengthVehicleResponse")
    ...
    @Action(input = "ArealDetector: getJamLengthMeters", output = "http://ws.tudresden.de/Service_Impl/ArealDetector_getJamLengthMetersResponse")
    ...
    @Action(input = "Simulation: getParkingEndingVehiclesIDList", output = "http://ws.tudresden.de/Service_Impl/Simulation_getParkingEndingVehiclesIDListResponse")
    ...
    @Action(input = "Simulation: getParkingEndingVehiclesNumber", output = "http://ws.tudresden.de/Service_Impl/Simulation_getParkingEndingVehiclesNumberResponse")
    ...
    @Action(input = "Simulation: getParkingStartingVehiclesIDList", output = "http://ws.tudresden.de/Service_Impl/Simulation_getParkingStartingVehiclesIDListResponse")
    ...
    @Action(input = "Simulation: getParkingStartingVehiclesNumber", output = "http://ws.tudresden.de/Service_Impl/Simulation_getParkingStartingVehiclesNumberResponse")
    ...
    @Action(input = "Simulation: getStopEndingVehiclesIDList", output = "http://ws.tudresden.de/Service_Impl/Simulation_getStopEndingVehiclesIDListResponse")
    ...
    @Action(input = "Simulation: getStopEndingVehiclesNumber", output = "http://ws.tudresden.de/Service_Impl/Simulation_getStopEndingVehiclesNumberResponse")
    ...
    @Action(input = "Simulation: getStopStartingVehiclesIDList", output = "http://ws.tudresden.de/Service_Impl/Simulation_getStopStartingVehiclesIDListResponse")
    ...
    @Action(input = "Simulation: getStopStartingVehiclesNumber", output = "http://ws.tudresden.de/Service_Impl/Simulation_getStopStartingVehiclesNumberResponse")
    ...
    @Action(input = "Simulation: getEndingTeleportIDList", output = "http://ws.tudresden.de/Service_Impl/Simulation_getEndingTeleportIDListResponse")
    ...
    @Action(input = "Simulation: getEndingTeleportNumber", output = "http://ws.tudresden.de/Service_Impl/Simulation_getEndingTeleportNumberResponse")
    ...
    @Action(input = "Simulation: getMinExpectedNumber", output = "http://ws.tudresden.de/Service_Impl/Simulation_getMinExpectedNumberResponse")
    ...
    @Action(input = "Vehicle: changeTarget", output = "http://ws.tudresden.de/Service_Impl/Vehicle_changeTargetResponse")
    ...
    @Action(input = "Vehicle: moveTo", output = "http://ws.tudresden.de/Service_Impl/Vehicle_moveToResponse")
     ...
     * @param lane
     */
    @WebMethod(operationName = "Vehicle_moveToVTD", action = "Vehicle: moveToVTD")
    @RequestWrapper(localName = "Vehicle_moveToVTD", targetNamespace = "http://ws.tudresden.de/", className = "de.tudresden.ws.VehicleMoveToVTD")
    @ResponseWrapper(localName = "Vehicle_moveToVTDResponse", targetNamespace = "http://ws.tudresden.de/", className = "de.tudresden.ws.VehicleMoveToVTDResponse")
    @Action(input = "Vehicle: moveToVTD", output = "http://ws.tudresden.de/Service_Impl/Vehicle_moveToVTDResponse")
    public void vehicleMoveToVTD(
        @WebParam(name = "vehID", targetNamespace = "")
        String vehID,
        @WebParam(name = "edgeID", targetNamespace = "")
        String edgeID,
    ...
    @Action(input = "Vehicle: Remove vehicle with the given ID for the give reason.  Reasons are defined in module constants and start with REMOVE_", output = "http://ws.tudresden.de/Service_Impl/Vehicle_removeResponse")
    ...
    @Action(input = "Vehicle: rerouteEffort", output = "http://ws.tudresden.de/Service_Impl/Vehicle_rerouteEffortResponse")
    ...
    @Action(input = "Vehicle: rerouteTraveltime", output = "http://ws.tudresden.de/Service_Impl/Vehicle_rerouteTraveltimeResponse")
    ...
    @Action(input = "Vehicle: setAccel", output = "http://ws.tudresden.de/Service_Impl/Vehicle_setAccelResponse")
    ...
    @Action(input = "Vehicle: setAdaptedTraveltime", output = "http://ws.tudresden.de/Service_Impl/Vehicle_setAdaptedTraveltimeResponse")
    ...
    @Action(input = "Vehicle: setColor", output = "http://ws.tudresden.de/Service_Impl/Vehicle_setColorResponse")
    ...
    @Action(input = "Vehicle: setDecel", output = "http://ws.tudresden.de/Service_Impl/Vehicle_setDecelResponse")
    ...
    @Action(input = "Vehicle: setEffort", output = "http://ws.tudresden.de/Service_Impl/Vehicle_setEffortResponse")
    ...
    @Action(input = "Vehicle: setEmissionClass", output = "http://ws.tudresden.de/Service_Impl/Vehicle_setEmissionClassResponse")
    ...
    @Action(input = "Vehicle: setImperfection", output = "http://ws.tudresden.de/Service_Impl/Vehicle_setImperfectionResponse")
    ...
    @Action(input = "Vehicle: setLength", output = "http://ws.tudresden.de/Service_Impl/Vehicle_setLengthResponse")
    ...
    @Action(input = "Vehicle: setMaxSpeed", output = "http://ws.tudresden.de/Service_Impl/Vehicle_setMaxSpeedResponse")
    ...
    @Action(input = "Vehicle: setMinGap", output = "http://ws.tudresden.de/Service_Impl/Vehicle_setMinGapResponse")
    ...
    @Action(input = "Vehicle: setRouteID", output = "http://ws.tudresden.de/Service_Impl/Vehicle_setRouteIDResponse")
    ...
    @Action(input = "Vehicle: setShapeClass", output = "http://ws.tudresden.de/Service_Impl/Vehicle_setShapeClassResponse")
    ...
    @Action(input = "Vehicle: setSignals", output = "http://ws.tudresden.de/Service_Impl/Vehicle_setSignalsResponse")
    ...
    @Action(input = "Vehicle: setSpeed", output = "http://ws.tudresden.de/Service_Impl/Vehicle_setSpeedResponse")
    ...
    @Action(input = "Vehicle: setSpeedDeviation", output = "http://ws.tudresden.de/Service_Impl/Vehicle_setSpeedDeviationResponse")
    ...
    @Action(input = "Vehicle: setSpeedFactor", output = "http://ws.tudresden.de/Service_Impl/Vehicle_setSpeedFactorResponse")
    ...
    @Action(input = "Vehicle: setStop", output = "http://ws.tudresden.de/Service_Impl/Vehicle_setStopResponse")
    ...
    @Action(input = "Vehicle: setTau", output = "http://ws.tudresden.de/Service_Impl/Vehicle_setTauResponse")
    ...
    @Action(input = "Vehicle: setVehicleClass", output = "http://ws.tudresden.de/Service_Impl/Vehicle_setVehicleClassResponse")
    ...
    @Action(input = "Vehicle: setWidth", output = "http://ws.tudresden.de/Service_Impl/Vehicle_setWidthResponse")
    ...
    @Action(input = "Trafficlights: setPhase", output = "http://ws.tudresden.de/Service_Impl/Trafficlights_setPhaseResponse")
    ...
    @Action(input = "Trafficlights: setProgram", output = "http://ws.tudresden.de/Service_Impl/Trafficlights_setProgramResponse")
    ...
    @Action(input = "Vehicletype: setAccel", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_setAccelResponse")
    ...
    @Action(input = "Vehicletype: setColor", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_setColorResponse")
    ...
    @Action(input = "Vehicletype: setDecel", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_setDecelResponse")
    ...
    @Action(input = "Vehicletype: setEmissionClass", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_setEmissionClassResponse")
    ...
    @Action(input = "Vehicletype: setImperfection", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_setImperfectionResponse")
    ...
    @Action(input = "Vehicletype: setLength", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_setLengthResponse")
    ...
    @Action(input = "Vehicletype: setMaxSpeed", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_setMaxSpeedResponse")
    ...
    @Action(input = "Vehicletype: setMinGap", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_setMinGapResponse")
    ...
    @Action(input = "Vehicletype: setShapeClass", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_setShapeClassResponse")
    ...
    @Action(input = "Vehicletype: setSpeedDeviation", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_setSpeedDeviationResponse")
    ...
    @Action(input = "Vehicletype: setSpeedFactor", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_setSpeedFactorResponse")
    ...
    @Action(input = "Vehicletype: setTau", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_setTauResponse")
    ...
    @Action(input = "Vehicletype: setVehicleClass", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_setVehicleClassResponse")
    ...
    @Action(input = "Vehicletype: setWidth", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_setWidthResponse")
    ...
    @Action(input = "Lane: setAllowed", output = "http://ws.tudresden.de/Service_Impl/Lane_setAllowedResponse")
    ...
    @Action(input = "Lane: setDisallowed", output = "http://ws.tudresden.de/Service_Impl/Lane_setDisallowedResponse")
    ...
    @Action(input = "Lane: setLength", output = "http://ws.tudresden.de/Service_Impl/Lane_setLengthResponse")
    ...
    @Action(input = "Lane: setMaxSpeed", output = "http://ws.tudresden.de/Service_Impl/Lane_setMaxSpeedResponse")
    ...
    @Action(input = "Polygon: remove", output = "http://ws.tudresden.de/Service_Impl/Polygon_removeResponse")
    ...
    @Action(input = "Polygon: setColor", output = "http://ws.tudresden.de/Service_Impl/Polygon_setColorResponse")
    ...
    @Action(input = "Polygon: setShape", output = "http://ws.tudresden.de/Service_Impl/Polygon_setShapeResponse")
    ...
    @Action(input = "Polygon: setType", output = "http://ws.tudresden.de/Service_Impl/Polygon_setTypeResponse")
    ...
    @Action(input = "Poi: setPosition", output = "http://ws.tudresden.de/Service_Impl/Poi_setPositionResponse")
    ...
    @Action(input = "Gui: screenshot", output = "http://ws.tudresden.de/Service_Impl/GUI_screenshotResponse")
    ...
    @Action(input = "Gui: Set the current boundary for the given view (see getBoundary()).", output = "http://ws.tudresden.de/Service_Impl/GUI_setBoundaryResponse")
    ...
    @Action(input = "Gui: trackVehicle", output = "http://ws.tudresden.de/Service_Impl/GUI_trackVehicleResponse")
    ...
    @Action(input = "Multientryexit: Returns a list of all e3 detectors in the network.", output = "http://ws.tudresden.de/Service_Impl/Multientryexit_getIDListResponse")
    ...
    @Action(input = "Multientryexit: Returns the number of all e3 detectors in the network.", output = "http://ws.tudresden.de/Service_Impl/Multientryexit_getIDCountResponse")
    ...
    @Action(input = "Edge: Returns the travel time value (in s) used for (re-)routing", output = "http://ws.tudresden.de/Service_Impl/Edge_getAdaptedTraveltimeResponse")
    ...
    @Action(input = "Edge: Returns the CO2 emission in mg for the last time step on the given edge.", output = "http://ws.tudresden.de/Service_Impl/Edge_getCO2EmissionResponse")
    ...
    @Action(input = "Edge: Returns the CO emission in mg for the last time step on the given edge.", output = "http://ws.tudresden.de/Service_Impl/Edge_getCOEmissionResponse")
    ...
    @Action(input = "Edge: Returns the effort value used for (re-)routing", output = "http://ws.tudresden.de/Service_Impl/Edge_getEffortResponse")
    ...
    @Action(input = "Edge: Returns the fuel consumption in ml for the last time step on the given edge.", output = "http://ws.tudresden.de/Service_Impl/Edge_getFuelConsumptionResponse")
    ...
    @Action(input = "Edge: Returns the HC emission in mg for the last time step on the given edge.", output = "http://ws.tudresden.de/Service_Impl/Edge_getHCEmissionResponse")
    ...
    @Action(input = "Edge: Returns the number of edges in the network.", output = "http://ws.tudresden.de/Service_Impl/Edge_getIDCountResponse")
    ...
    @Action(input = "Edge: Returns a list of all edges in the network.", output = "http://ws.tudresden.de/Service_Impl/Edge_getIDListResponse")
    ...
    @Action(input = "Edge: Returns the total number of halting vehicles for the last time step on the given edge.", output = "http://ws.tudresden.de/Service_Impl/Edge_getLastStepHaltingNumberResponse")
    ...
    @Action(input = "Edge: Returns the total vehicle length in m for the last time step on the given edge.", output = "http://ws.tudresden.de/Service_Impl/Edge_getLastStepLengthResponse")
    ...
    @Action(input = "Edge: Returns the average speed in m/s for the last time step on the given edge.", output = "http://ws.tudresden.de/Service_Impl/Edge_getLastStepMeanSpeedResponse")
    ...
    @Action(input = "Edge: Returns the occupancy in % for the last time step on the given edge.", output = "http://ws.tudresden.de/Service_Impl/Edge_getLastStepOccupancyResponse")
    ...
    @Action(input = "Edge: Returns the subscription results for the last time step and the given edge.", output = "http://ws.tudresden.de/Service_Impl/Edge_getLastStepVehicleIDsResponse")
    ...
    @Action(input = "Edge: Returns the total number of vehicles for the last time step on the given edge.", output = "http://ws.tudresden.de/Service_Impl/Edge_getLastStepVehicleNumberResponse")
    ...
    @Action(input = "Edge: Returns the NOx emission in mg for the last time step on the given edge.", output = "http://ws.tudresden.de/Service_Impl/Edge_getNOxEmissionResponse")
    ...
    @Action(input = "Edge: Returns the noise emission in db for the last time step on the given edge.", output = "http://ws.tudresden.de/Service_Impl/Edge_getNoiseEmissionResponse")
    ...
    @Action(input = "Edge: Returns the particular matter emission in mg for the last time step on the given edge.", output = "http://ws.tudresden.de/Service_Impl/Edge_getPMxEmissionResponse")
    ...
    @Action(input = "Edge: Returns the estimated travel time in s for the last time step on the given edge.", output = "http://ws.tudresden.de/Service_Impl/Edge_getTraveltimeResponse")
    ...
    @Action(input = "Edge: Returns the waiting time in s for the last time step on the given edge.", output = "http://ws.tudresden.de/Service_Impl/Edge_getWaitingTimeResponse")
    ...
    @Action(input = "ArealDetector: getIDList", output = "http://ws.tudresden.de/Service_Impl/ArealDetector_getIDListResponse")
    ...
    @Action(input = "ArealDetector: getIDCount", output = "http://ws.tudresden.de/Service_Impl/ArealDetector_getIDCountResponse")
    ...
    @Action(input = "Vehicle: getAccel", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getAccelResponse")
    ...
    @Action(input = "Vehicle: getAdaptedTraveltime", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getAdaptedTraveltimeResponse")
    ...
    @Action(input = "Vehicle: getAngle", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getAngleResponse")
    ...
    @Action(input = "Vehicle: getBestLanes", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getBestLanesResponse")
    ...
    @Action(input = "Vehicle: Returns the CO2 emission in mg for the last time step.", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getCO2EmissionResponse")
    ...
    @Action(input = "Vehicle: Returns the CO emission in mg for the last time step.", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getCOEmissionResponse")
    ...
    @Action(input = "Vehicle: getColor", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getColorResponse")
    ...
    @Action(input = "Vehicle: getDecel", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getDecelResponse")
    ...
    @Action(input = "Vehicle: getDrivingDistance", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getDrivingDistanceResponse")
    ...
    @Action(input = "Vehicle: Returns the subscription results for the last time step and the given vehicle.", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getDrivingDistance2DResponse")
    ...
    @Action(input = "Vehicle: getEffort", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getEffortResponse")
    ...
    @Action(input = "Vehicle: getEmissionClass", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getEmissionClassResponse")
    ...
    @Action(input = "Vehicle: Returns the fuel consumption in ml for the last time step.", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getFuelConsumptionResponse")
    ...
    @Action(input = "Vehicle: Returns the HC emission in mg for the last time step.", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getHCEmissionResponse")
    ...
    @Action(input = "Vehicle: Returns a list of all known vehicles.", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getIDListResponse")
    ...
    @Action(input = "Vehicle: Returns the number of all known vehicles.", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getIDCountResponse")
    ...
    @Action(input = "Vehicle: getImperfection", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getImperfectionResponse")
    ...
    @Action(input = "Vehicle: getAllowedSpeed", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getAllowedSpeedResponse")
    ...
    @Action(input = "Vehicle: getPersonNumber", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getPersonNumberResponse")
    ...
    @Action(input = "Vehicle: getDistance", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getDistanceResponse")
    ...
    @Action(input = "Vehicle: getWaitingTime", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getWaitingTimeResponse")
    ...
    @Action(input = "Vehicle: getLaneID", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getLaneIDResponse")
    ...
    @Action(input = "Vehicle: getLaneIndex", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getLaneIndexResponse")
    ...
    @Action(input = "Vehicle: getLanePosition", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getLanePositionResponse")
    ...
    @Action(input = "Vehicle: getLength", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getLengthResponse")
    ...
    @Action(input = "Vehicle: getMaxSpeed", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getMaxSpeedResponse")
    ...
    @Action(input = "Vehicle: getMinGap", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getMinGapResponse")
    ...
    @Action(input = "Vehicle: Returns the NOx emission in mg for the last time step.", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getNOxEmissionResponse")
    ...
    @Action(input = "Vehicle: Returns the noise emission in db for the last time step.", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getNoiseEmissionResponse")
    ...
    @Action(input = "Vehicle: Returns the particular matter emission in mg for the last time step.", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getPMxEmissionResponse")
    ...
    @Action(input = "Vehicle: Returns the position of the named vehicle within the last step [m,m].", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getPositionResponse")
    ...
    @Action(input = "Vehicle: getRoadID", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getRoadIDResponse")
    ...
    @Action(input = "Vehicle: getRoute", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getRouteResponse")
    ...
    @Action(input = "Vehicle: getRouteID", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getRouteIDResponse")
    ...
    @Action(input = "Vehicle: getShapeClass", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getShapeClassResponse")
    ...
    @Action(input = "Vehicle: getSignals", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getSignalsResponse")
    ...
    @Action(input = "Vehicle: getSpeed", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getSpeedResponse")
    ...
    @Action(input = "Vehicle: getSpeedDeviation", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getSpeedDeviationResponse")
    ...
    @Action(input = "Vehicle: getSpeedFactor", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getSpeedFactorResponse")
    ...
    @Action(input = "Vehicle: getSpeedWithoutTraCI", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getSpeedWithoutTraCIResponse")
    ...
    @Action(input = "Vehicle: getTau", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getTauResponse")
    ...
    @Action(input = "Vehicle: getTypeID", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getTypeIDResponse")
    ...
    @Action(input = "Vehicle: getVehicleClass", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getVehicleClassResponse")
    ...
    @Action(input = "Vehicle: getWidth", output = "http://ws.tudresden.de/Service_Impl/Vehicle_getWidthResponse")
    ...
    @Action(input = "Vehicle: isRouteValid", output = "http://ws.tudresden.de/Service_Impl/Vehicle_isRouteValidResponse")
    ...
    @Action(input = "Vehicle: setRoute", output = "http://ws.tudresden.de/Service_Impl/Vehicle_setRouteResponse")
    public int vehicleSetRoute(
        @WebParam(name = "vehID", targetNamespace = "")
        String vehID,
    ...
    @Action(input = "Vehicle: setLaneChangeMode", output = "http://ws.tudresden.de/Service_Impl/Vehicle_setLaneChangeModeResponse")
    public int vehicleSetLaneChangeMode(
        @WebParam(name = "vehID", targetNamespace = "")
        String vehID,
    ...
    @Action(input = "Vehicle: setType", output = "http://ws.tudresden.de/Service_Impl/Vehicle_setTypeResponse")
    public int vehicleSetType(
        @WebParam(name = "vehID", targetNamespace = "")
        String vehID,
        @WebParam(name = "typeID", targetNamespace = "")
        String typeID);
    ...
    @Action(input = "Vehicle: slowDown", output = "http://ws.tudresden.de/Service_Impl/Vehicle_slowDownResponse")
    public int vehicleSlowDown(
        @WebParam(name = "vehID", targetNamespace = "")
        String vehID,
        @WebParam(name = "speed", targetNamespace = "")
        double speed,
    ...
    @Action(input = "Simulation: convert2D", output = "http://ws.tudresden.de/Service_Impl/Simulation_convert2DResponse")
    ...
    @Action(input = "Simulation: convertGeo", output = "http://ws.tudresden.de/Service_Impl/Simulation_convertGeoResponse")
    ...
    @Action(input = "Simulation: convertRoad", output = "http://ws.tudresden.de/Service_Impl/Simulation_convertRoadResponse")
    ...
    @Action(input = "Simulation: getArrivedIDList", output = "http://ws.tudresden.de/Service_Impl/Simulation_getArrivedIDListResponse")
    ...
    @Action(input = "Simulation: getArrivedNumber", output = "http://ws.tudresden.de/Service_Impl/Simulation_getArrivedNumberResponse")
    ...
    @Action(input = "Simulation: getCurrentTime", output = "http://ws.tudresden.de/Service_Impl/Simulation_getCurrentTimeResponse")
    ...
    @Action(input = "Simulation: getBusStopWaiting", output = "http://ws.tudresden.de/Service_Impl/Simulation_getBusStopWaitingResponse")
    ...
    @Action(input = "Simulation: getDeltaT", output = "http://ws.tudresden.de/Service_Impl/Simulation_getDeltaTResponse")
    ...
    @Action(input = "Simulation: getDepartedIDList", output = "http://ws.tudresden.de/Service_Impl/Simulation_getDepartedIDListResponse")
    ...
    @Action(input = "Simulation: getDepartedNumber", output = "http://ws.tudresden.de/Service_Impl/Simulation_getDepartedNumberResponse")
    ...
    @Action(input = "Simulation: getDistance2D", output = "http://ws.tudresden.de/Service_Impl/Simulation_getDistance2DResponse")
    ...
    @Action(input = "Lane: getLinks", output = "http://ws.tudresden.de/Service_Impl/Lane_getLinksResponse")
    public List<String> laneGetLinks(
        @WebParam(name = "laneID", targetNamespace = "")
        String laneID);
    ...
    @Action(input = "Lane: getShape", output = "http://ws.tudresden.de/Service_Impl/Lane_getShapeResponse")
    ...
    @Action(input = "Lane: getWidth", output = "http://ws.tudresden.de/Service_Impl/Lane_getWidthResponse")
    ...
    @Action(input = "Poi: add", output = "http://ws.tudresden.de/Service_Impl/Poi_addResponse")
    public int poiAdd(
        @WebParam(name = "poiID", targetNamespace = "")
        String poiID,
        @WebParam(name = "x", targetNamespace = "")
    ...
    @Action(input = "Poi: Returns the color of the given poi.", output = "http://ws.tudresden.de/Service_Impl/Poi_getColorResponse")
    ...
    @Action(input = "Poi: Returns a list of all pois in the network.", output = "http://ws.tudresden.de/Service_Impl/Poi_getIDListResponse")
    ...
    @Action(input = "Poi: getType", output = "http://ws.tudresden.de/Service_Impl/Poi_getTypeResponse")
    ...
    @Action(input = "Gui: Returns the list of available views (open windows).", output = "http://ws.tudresden.de/Service_Impl/GUI_getIDListResponse")
    ...
    @Action(input = "Gui: Returns the x and y offset of the center of the current view.", output = "http://ws.tudresden.de/Service_Impl/GUI_getOffsetResponse")
    ...
    @Action(input = "Gui: Returns the name of the current coloring scheme.", output = "http://ws.tudresden.de/Service_Impl/GUI_getSchemaResponse")
    ...
    @Action(input = "Gui: Returns the current zoom factor.", output = "http://ws.tudresden.de/Service_Impl/GUI_getZoomResponse")
    ...
    @Action(input = "Simulation: Returns the subscription results for the last time step.", output = "http://ws.tudresden.de/Service_Impl/Simulation_getDistanceRoadResponse")
    ...
    @Action(input = "Simulation: getLoadedIDList", output = "http://ws.tudresden.de/Service_Impl/Simulation_getLoadedIDListResponse")
    ...
    @Action(input = "Simulation: getLoadedNumber", output = "http://ws.tudresden.de/Service_Impl/Simulation_getLoadedNumberResponse")
    ...
    @Action(input = "Simulation: getNetBoundary", output = "http://ws.tudresden.de/Service_Impl/Simulation_getNetBoundaryResponse")
    ...
    @Action(input = "Trafficlights: Returns a list of all traffic lights in the network.", output = "http://ws.tudresden.de/Service_Impl/Trafficlights_getIDListResponse")
    ...
    @Action(input = "Trafficlights: Returns the number of all traffic lights in the network.", output = "http://ws.tudresden.de/Service_Impl/Trafficlights_getIDCountResponse")
    ...
    @Action(input = "Trafficlights: Returns the next switch", output = "http://ws.tudresden.de/Service_Impl/Trafficlights_getNextSwitchResponse")
    ...
    @Action(input = "Trafficlights: getPhase", output = "http://ws.tudresden.de/Service_Impl/Trafficlights_getPhaseResponse")
    ...
    @Action(input = "Trafficlights: getProgram", output = "http://ws.tudresden.de/Service_Impl/Trafficlights_getProgramResponse")
    ...
    @Action(input = "Vehicletype: getAccel", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_getAccelResponse")
    ...
    @Action(input = "Vehicletype: Returns the subscription results for the last time step and the given vehicle type.", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_getColorResponse")
    ...
    @Action(input = "Vehicletype: getDecel", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_getDecelResponse")
    ...
    @Action(input = "Vehicletype: getEmissionClass", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_getEmissionClassResponse")
    ...
    @Action(input = "Vehicletype: Returns a list of all known vehicle types.", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_getIDListResponse")
    ...
    @Action(input = "Vehicletype: Returns the number of all known vehicle types.", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_getIDCountResponse")
    ...
    @Action(input = "Vehicletype: getImperfection", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_getImperfectionResponse")
    ...
    @Action(input = "Vehicletype: getLength", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_getLengthResponse")
    ...
    @Action(input = "Vehicletype: getMaxSpeed", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_getMaxSpeedResponse")
    ...
    @Action(input = "Vehicletype: getMinGap", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_getMinGapResponse")
    ...
    @Action(input = "Vehicletype: getShapeClass", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_getShapeClassResponse")
    ...
    @Action(input = "Vehicletype: getSpeedDeviation", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_getSpeedDeviationResponse")
    ...
    @Action(input = "Vehicletype: getSpeedFactor", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_getSpeedFactorResponse")
    ...
    @Action(input = "Vehicletype: getTau", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_getTauResponse")
    ...
    @Action(input = "Vehicletype: getVehicleClass", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_getVehicleClassResponse")
    ...
    @Action(input = "Vehicletype: getWidth", output = "http://ws.tudresden.de/Service_Impl/Vehicletype_getWidthResponse")
