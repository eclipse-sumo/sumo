...
# center->Right
dragDrop(match.getTarget().offset(100, 405),
         match.getTarget().offset(300, 405))
dragDrop(match.getTarget().offset(300, 405),
         match.getTarget().offset(100, 405))

# center->Left top
dragDrop(match.getTarget().offset(100, 405),
         match.getTarget().offset(-100, 300))
dragDrop(match.getTarget().offset(-100, 405),
         match.getTarget().offset(100, 300))

# center->Right top
dragDrop(match.getTarget().offset(100, 405),
         match.getTarget().offset(300, 300))
dragDrop(match.getTarget().offset(300, 405),
         match.getTarget().offset(100, 300))

# center->Left bot
dragDrop(match.getTarget().offset(100, 405),
         match.getTarget().offset(-100, 450))
dragDrop(match.getTarget().offset(-100, 405),
         match.getTarget().offset(100, 450))

# center->Right bot
dragDrop(match.getTarget().offset(100, 405),
         match.getTarget().offset(300, 450))
dragDrop(match.getTarget().offset(300, 405),
         match.getTarget().offset(100, 450))
...
dragDrop(match.getTarget().offset(100, 405),
         match.getTarget().offset(-300, 405))
dragDrop(match.getTarget().offset(-120, 405),
         match.getTarget().offset(100, 405))

# center->Right corner
dragDrop(match.getTarget().offset(100, 405),
         match.getTarget().offset(390, 405))
dragDrop(match.getTarget().offset(320, 405),
         match.getTarget().offset(100, 405))
