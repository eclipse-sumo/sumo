...
netedit.modifyAdditionalDefaultValue(3, "routeProbe")

# create calibrator with a different routeProbe in other lane
netedit.leftClick(match, 200, 90)
...
netedit.modifyAdditionalDefaultValue(4, "myOwnOtuput")

# create calibrator with a valid parameter in other lane
netedit.leftClick(match, 200, 140)
