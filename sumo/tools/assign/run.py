...
os.system("sumo --no-step-log -n %s -e 90000 -r %s/trips_19.rou.xml --vehroute-output vehroutes_dua.xml %s -l sumo_dua.log" % (netFile, duaDir, sumoAdds))
os.system("networkStatistics.py -n %s -d ../input/districts.xml -x vehroutes_dua.xml -o networkStatistics_%s.txt" % (netFile, os.path.basename(duaDir)))
