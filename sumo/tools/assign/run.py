...
os.system("SUE_assignsumo.py -c ../input/districts.xml -m %s -n %s -p ../clogit_parameter.txt -u ../CRcurve.txt" % (mtxNamesList, netFile))
...
os.system("GlobalMOE.py -n %s -c ../input/districts.xml -x vehroutes_clogit.xml -o Global_MOE_%s.txt" % (netFile, os.path.basename(clogDir)))
os.chdir("..")
