...
class SelectToolMixin(BaseTool):
    ...
    def _init_select(self, is_show_selected = False):
        """
...
class HandleTool(SelectTool):
    ...
    def _init_select(self, is_show_selected = True, detectwidth = 0.1):
...
class StretchTool(HandleTool):
    ...
    def __init__(self,parent, mainframe=None, detectwidth = 0.1):
        """
        To be overridden by specific tool.
        """
        self.drawobj_anim, self.id_anim = (None, -1)
        ...
        self._init_select(is_show_selected = True, detectwidth = detectwidth)
...
class DrawobjMixin(am.ArrayObjman):
    ...
    def end_animation(self, is_del_last_vert = False):
        ...
        self.vertices[self._id_target] = self._drawobj_anim.vertices[self.id_anim]#.copy()
        self.del_animation()
...
class Polylines(Fancylines):
    ...
    def begin_animation(self, id_target):
        ...
        self._id_target = id_target
        self._drawobj_anim = self.parent.get_drawobj_by_ident(self._ident_drawobj_anim)
        self.id_anim = self._drawobj_anim.add_drawobj(  self.vertices[id_target], 
                                                        1.0*self.widths[id_target], 
                                                        self.color_anim.value,
                                                        beginstyle = self.beginstyles[id_target], 
                                                        endstyle = self.endstyles[id_target],
    ...
    def append_vert_to_animation(self, vert):
        ...
        self._drawobj_anim.vertices[self.id_anim].append(vert)
        ...
        return len(self._drawobj_anim.vertices[self.id_anim])-1# vertex ind of next
    ...
    def end_animation(self, is_del_last_vert = False):
        ...
        if is_del_last_vert:
            ...
            self.vertices[self._id_target] = self._drawobj_anim.vertices[self.id_anim][:-1]
        else:
            self.vertices[self._id_target] = self._drawobj_anim.vertices[self.id_anim]
