...
class Fancylines(Lines):
    ...
    def _update_vertexvbo(self):
        ...
        self._update_vertexvbo_end_fill(x1,y1,z1,x2,y2,z2,length_xy, alpha_xy,halfwidth)
        self._update_vertexvbo_begin_fill(x1,y1,z1,x2,y2,z2,length_xy, alpha_xy,halfwidth)
        self._update_vertexvbo_line_fill(x1,y1,z1,x2,y2,z2,length_xy, alpha_xy,halfwidth)
    ...
    def _update_vertexvbo_begin_fill(self,x1,y1,z1,x2,y2,z2,length_xy, alpha_xy,halfwidth):
        ...
        #print '  y2=',y2,y2.dtype
        y1_new = y2 -(length_xy-halfwidth)*np.sin(alpha_xy)
        #print '  y2_new=',y2_new,y2_new.dtype
        x = np.cos(alphas) * halfwidth + x1_new
        y = np.sin(alphas) * halfwidth + y1_new
        ...
        xcf = (np.ones((n_vert,1)) * x1_new).transpose().flatten()
        ycf = (np.ones((n_vert,1)) * y1_new).transpose().flatten()
        #print '  xcf\n',xcf
        #print '  ycf\n',ycf
    ...
    def _update_vertexvbo_end_fill(self,x1,y1,z1,x2,y2,z2,length_xy, alpha_xy,halfwidth):
        ...
        #print '  y2_new=',y2_new,y2_new.dtype
        x = np.cos(alphas) * halfwidth + x2_new
        y = np.sin(alphas) * halfwidth + y2_new
        ...
        yf = y.transpose().flatten()#+0.5
        zf = z.transpose().flatten()
        xcf = (np.ones((n_vert,1)) * x2_new).transpose().flatten()
        ycf = (np.ones((n_vert,1)) * y2_new).transpose().flatten()
        #print '  xcf\n',xcf
        #print '  ycf\n',ycf
