...
class OGLcanvas(glcanvas.GLCanvas):
    ...
    def set_drawing_anim(self, drawing):
        if self._drawing_anim != drawing:
            # TODO: tools
            del self._drawing_anim
            self._drawing_anim = drawing     
            self.draw()
    ...
    def get_drawing_anim(self):
        return self._drawing_anim
...
#-------------------------------------------------------------------------------
            if 1:
                ...
                fancylines.add_drawobjs(    vertices_fancy,
                                            ...
                                            endstyles = [TRIANGLEHEAD,BEVELHEAD],
                                            )
