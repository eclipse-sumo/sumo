...
class TestMainframe(wx.Frame):
    ...
    def __init__(self, parent=None,  id=-1, title ='mainframe', pos=wx.DefaultPosition,
        ...
        style = wx.DEFAULT_FRAME_STYLE | wx.NO_FULL_REPAINT_ON_RESIZE
        #wx.Frame.__init__(self, parent, id, title, pos, size, style, name)
        super(TestMainframe, self).__init__(parent, id, title, pos, size, style, name)
        ...
        splitter.SplitVertically(self._objbrowser,nbpanel, -100)
