...
# wx gui stuff
from mainframe import MetaMainFrame  
...
class TestMainframe(wx.Frame):
    ...
    def __init__orig(self, parent=None,  id=-1, title ='mainframe', pos=wx.DefaultPosition,
                 size=wx.DefaultSize, style=wx.DEFAULT_FRAME_STYLE,
                 name='frame'):
        ...
        self.p1 = wx.Window(self, style=sty)
        self.p1.SetBackgroundColour("pink")
        wx.StaticText(self.p1, -1, "Panel One", (50,50))
        
        self.canvas = WxGLTest_orig(self)
        
        sizer=wx.BoxSizer(wx.VERTICAL)
        sizer.Add(self.p1,0, wx.ALL | wx.ALIGN_LEFT | wx.GROW, 4)# from NaviPanelTest
        sizer.Add(self.canvas,1,wx.GROW)# from NaviPanelTest
