...
#-------------------------------------------------------------------------------
    ...
    def create_namewidget(self):
        ...
        #print 'create_namewidget',self._attrconf.get_obj().ident,self._attrconf.attrname
...
class TableGrid(AttrBase,gridlib.PyGridTableBase):
    ...
    def GetValue(self, row, col):
        ...
        try:
            ...
            #print 'GetValue',self.ids[row],attrconf.attrname,val
            if hasattr(attrconf,'choices'):
                if type(attrconf.choices) in (OrderedDict, types.DictionaryType):#(types.ListType, types.TupleType):
...
class ObjPanelMixin:
    ...
    def recreate_panel_table(self, attrconfigs=None,
        ...
        """
        #
        #print 'recreate_panel_table:',self.obj.ident, func_apply,groupnames
...
class NaviPanelMixin:
    ...
    def change_obj(self,obj,id=None, ids=None,**kwargs):
        ...
        if len(kwargs)==0:
            obj_last,id_last,ids_last,kwargs_last=self.get_hist(-1)
            if kwargs_last!= None:
                kwargs=kwargs_last
