...
class Polylines(Fancylines):
    ...
    def _make_lines(self):
        ...
        #print 'make_linevertices',len(self.get_vertices_array())
        ...
        self._vertexinds = np.array(vertexinds, np.int32)
...
class Polygons(DrawobjMixin):
    ...
    def _make_lines(self):
        #print 'make_linevertices',self.ident,len(self.get_vertices_array())
...
class OGLdrawing(am.ArrayObjman):
    ...
    def has_drawobj_with_ident(self, ident):
        return self.idents.get_value().has_key(ident)
...
class OGLnavcanvas(wx.Panel):
    ...
    def __init__(self,parent, drawing = None,
        ...
        self._canvas = OGLcanvas(self,drawing, mainframe,)
...
class OGLcanvas(glcanvas.GLCanvas):
    def __init__(self, parent, drawing = None, mainframe = None):
        if mainframe == None:
    ...
    def draw(self, *args, **kwargs):
        ...
        if self._drawing:
            for drawobj in  self._drawing.get_drawobjs(is_anim = True):
                #print '\n  draw.drawobj',drawobj.format_ident(), self._drawing.get_drawobj_by_ident(drawobj.ident).ident
...
class OGleditor(wx.Panel):
    ...
    def __init__(self,parent, drawing = None,
        ...
        # initialize GL canvas
        navcanvas = OGLnavcanvas(self, drawing, mainframe)
