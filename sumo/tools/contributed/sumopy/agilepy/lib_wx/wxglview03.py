...
class Lines:
    ...
    def draw(self):
        ...
        print '2 len(self._vertexvbo)',len(self._vertexvbo)
        print '  len(self._indexvbo)',len(self._indexvbo)
        self._vertexvbo.bind()
        self._indexvbo.bind()
        glVertexPointer(3, GL_FLOAT, 0, None)
        
        glDrawElements(GL_LINES, len(self._vertexvbo), GL_UNSIGNED_INT, None)
...
class Rectangles(Lines):
    ...
    def draw(self):
        ...
        self._indexvbo.bind()
        glVertexPointer(3, GL_FLOAT, 0, None)
        print '4 len(self._vertexvbo)',len(self._vertexvbo)
        print '  len(self._indexvbo)',len(self._indexvbo)
        glDrawElements(GL_QUADS, len(self._vertexvbo), GL_UNSIGNED_INT, None)
...
class Triangles(Lines):
    ...
    def draw(self):
        ...
        glVertexPointer(3, GL_FLOAT, 0, None)
        print 'draw triang'
        print '  self.n_vert_per_elem*len(self.vertices)',self.n_vert_per_elem*len(self.vertices)
