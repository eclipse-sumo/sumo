...
ATTRS_NOSAVE = ('value','plugin','_obj','_manager','get','set','add','del','delete','childs','parent')   
...
class BaseObjman:
    ...
    def _init_objman(self, ident='no_ident', parent=None, name= None, 
                        managertype = 'basic', info = None, logger = None, xmltag = None):
    ...
    def _init_constants(self):
        """
        init any costants that are outside the management.
        This method will be called to initialize and after loading.
        """
        pass
