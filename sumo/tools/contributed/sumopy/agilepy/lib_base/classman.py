...
ATTRS_NOSAVE = ('value','plugin','_obj','_manager','get','set','add','del','delete','childs','parent','_attrconfig_id_tab')   
...
class Attrsman:
    ...
    def add(self, attrconf):
        ...
        #print 'Attrsman.add',self.get_obj().ident,'add',attrname,self.has_attrname(attrname)
...
class TableMixin(BaseObjman):
    ...
    def write_xml(self, fd, indent, xmltag_id = 'id', ids = None, ids_xml = None,
        ...
        if self.xmltag!=None:
            ...
            for attrconfig in self.get_attrsman().get_configs(is_all=True):
                #print '  check',attrconfig.attrname,attrconfig.xmltag!= None,attrconfig.is_colattr(),attrconfig.metatype
