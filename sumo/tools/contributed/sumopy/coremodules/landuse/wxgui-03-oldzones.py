...
class ParkingDrawings(Lines):
    ...
    def get_vertices_array(self):
        ...
        return self._parking.vertices.value[self._inds_map]
...
class WxGui(ModuleGui):
    ...
    def make_menu(self):
        ...
        menubar.append_item( 'landuse/import/clean osm...',
            self.on_clean_osm, 
...
##        
    ...
    def on_clean_osm(self, event=None):
        ...
        dlg = wx.FileDialog(
            ...
            defaultFile = os.path.join(scenario.get_workdirpath(), scenario.format_ident()+'osm.xml'),
            wildcard=wildcards,
