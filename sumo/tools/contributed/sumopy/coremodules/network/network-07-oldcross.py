...
class Network(cm.BaseObjman):
        ...
        def export_sumoxml(self, filepath):
            ...
            if len(names)>=3:
                ...
                rootname = names[0]
            self.edges.export_sumoxml(os.path.join(dirname,rootname+'.edg.xml'))
            self.nodes.export_sumoxml(os.path.join(dirname,rootname+'.nod.xml'))
            self.connections.export_sumoxml(os.path.join(dirname,rootname+'.con.xml'))
