...
class Network(cm.BaseObjman):
        ...
        def import_xml(self, rootname, dirname, is_clean_nodes = False, is_remove_xmlfiles= False):
        ...
        def add_edge(self,  id_fromnode = -1,
                            id_tonode = -1, 
                            **kwargs):
            
            #print 'add_edge',id_fromnode, id_tonode
            #for key, value in kwargs.iteritems():
            #    print '  ',key,type(value),value
            
            
            id_edge = self.edges.make( id_fromnode, id_tonode, **kwargs)
            #print '  id_edge',id_edge
            
            # this adding ingoing and outgoing is moved to add_connection
            #self.nodes.add_outgoing(id_fromnode,id_edge)
            #self.nodes.add_incoming(id_tonode,id_edge)
            return id_edge
