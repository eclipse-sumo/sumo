...
class Lanes(am.ArrayObjman):
    ...
    def reshape_edgelanes(self, id_edge):
        ...
        #print 'reshape: edgeshape edge=',id_edge
...
class Edges(am.ArrayObjman):
    ...
    def __init__(self, parent, **kwargs):
            ...
            self.add_col(am.ArrayConf( 'types_spread', 1,
                                            choices = {\
                                                "right": 0,
                                                "center": 1, 
                                                },
...
class Network(cm.BaseObjman):
        ...
        def call_sumogui(self, filepath = None):
...
class SumoEdgeReader(handler.ContentHandler):
    ...
    def startElement(self, name, attrs):
        ...
        if name == 'edge':
            ...
            self.types_spread[ind] = self.spread_choices[str(attrs.get('spreadType','center'))]
