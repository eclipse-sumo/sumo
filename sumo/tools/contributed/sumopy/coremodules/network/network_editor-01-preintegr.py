...
if  __name__ == '__main__':
    ...
    #IMAGEDIR = os.path.join(APPDIR,"lib_wx","images")
            
import numpy as np  

from ogleditor import *
from mainframe import AgileMainframe   
...
class NeteditorTools(ToolsPanel):
    ...
    def __init__(self, parent):
        ...
        id_initialtool = self.add_tool(NetSelectTool(self))
...
if __name__ == '__main__':          
    ...
    import network
    net = network.Network()
    net.read_nodes(os.path.join('testnet','facsp2.nod.xml'))
    net.read_edges(os.path.join('testnet','facsp2.edg.xml'))
