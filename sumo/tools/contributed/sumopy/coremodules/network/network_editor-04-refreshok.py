...
class NodeDrawings(Circles):
    ...
    def set_nodes(self, nodes):
        ...
        #for ind_drawobj in np.arange(len(self)):
        #    #for id_drawobj in self.get_ids():
        #    print '  *' ,ind_drawobj
        #    id_drawobj = self.get_ids([ind_drawobj])[0]
        #    ind_netelem = self._inds_map[ind_drawobj]
        #    id_netelem = self._nodes.get_ids([ind_netelem])[0]
        #    
        #    ind_netelem_check = self._nodes.get_ind(id_drawobj)
        #    
        #    print '  id_drawobj,id_netelem',id_drawobj,id_netelem
        #    print '  ind_drawobj,ind_netelem,ind_netelem_check',ind_drawobj,ind_netelem,ind_netelem_check
        #    print '  coords',self._nodes.coords.value[self._inds_map[ind_drawobj]]
        #    print '  coords',self._nodes.coords[id_drawobj]
        #    
        #    
        #    #print '  id_drawobj',id_drawobj
        self.update()
