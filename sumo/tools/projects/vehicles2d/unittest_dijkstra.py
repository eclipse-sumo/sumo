...
########### dijkstra
    ...
    def test_dikstra_get_nodes_list(self):
        ...
        self.assertEqual(sorted(myD.get_open_nodes('tuples')), sorted([(3, 3), (4, 3)]))
        ...
        self.assertEqual(sorted(myD.get_closed_nodes('tuples')), sorted([(5, 5), (5, 6)]))
        # return myId = 7
    ...
    def test_dijkstra_to_do(self):
        ...
        self.assertRaises(StandardError, Dijkstra, myFlaeche, ( 1,  1), (11, 11) )
        self.assertRaises(StandardError, Dijkstra, myFlaeche, ( 1,  1), (11,  1) )
        self.assertRaises(StandardError, Dijkstra, myFlaeche, ( 1,  1), ( 1, 11) )

        self.assertRaises(StandardError, Dijkstra, myFlaeche, ( 1, 11), (11, 11) )
        self.assertRaises(StandardError, Dijkstra, myFlaeche, ( 1, 11), (11,  1) )
        self.assertRaises(StandardError, Dijkstra, myFlaeche, ( 1, 11), ( 1,  1) )
        self.assertRaises(StandardError, Dijkstra, myFlaeche, ( 1, 11), ( 1, 11) )
        
        self.assertRaises(StandardError, Dijkstra, myFlaeche, (11,  1), (11, 11) )
        self.assertRaises(StandardError, Dijkstra, myFlaeche, (11,  1), (11,  1) )
        self.assertRaises(StandardError, Dijkstra, myFlaeche, (11,  1), ( 1,  1) )
        self.assertRaises(StandardError, Dijkstra, myFlaeche, (11,  1), ( 1, 11) )
        
        self.assertRaises(StandardError, Dijkstra, myFlaeche, (11, 11), (11, 11) )
        self.assertRaises(StandardError, Dijkstra, myFlaeche, (11, 11), (11,  1) )
        self.assertRaises(StandardError, Dijkstra, myFlaeche, (11, 11), ( 1,  1) )
        self.assertRaises(StandardError, Dijkstra, myFlaeche, (11, 11), ( 1, 11) )
    ...
    def test_dijsktra_step_internals(self):  
        ...
        self.assertEqual(myD.get_open_nodes('tuples'), [( 0, 1), (1, 0), (1, 1) ])
        ...
        self.assertEqual(myD_fake_closed.get_open_nodes('tuples'), [( 0, 1), ( 1, 0)])
        ...
        myD_fake_end.open_nodes_list.append(myDN_1) # dest point in open and the shortest
    ...
    def test_dijsktra_run_and_rebuild (self): 
        ...
        visual = VISUAL
        visual = True
        myFlaeche = main.Flaeche(xdim=300,ydim=300,scale=10, output='result_hindrance_punctual')
        ...
        myD = Dijkstra(myFlaeche, (0, 0), (10, 10))
        self.assertRaisesRegexp(StandardError, "algorithm must be run first successfully", myD.rebuild_path)
