...
class testCaseFlaeche(unittest.TestCase):
    ...
    def test_flaeche_get_cell_and_cells(self):
        ...
        self.assertEqual(myFlaeche.get_cells((15, 0)), [(14, -1), (14, 0), (15, -1), (15, 0)])
        self.assertEqual(myFlaeche.get_cells((0, 15)), [(-1, 14), (-1, 15), (0, 14), (0, 15)])
        ...
        self.assertEqual(myFlaeche.get_cells((0, 0)), [(-1, -1), (-1, 0), (0, -1), (0, 0)])
    ...
    def test_convert_trajectroy_points_to_bypassed_cells(self):
        ...
        result          = myFlaeche.convert_trajectroy_points_to_bypassed_cells(trajectory) 
...
#        self.assertFalse(myFlaeche.all_nodes_in_list_are_valid(node_list))
        ...
        node_list = [( 5, 5), ( 5,  6)]
        self.assertTrue(myFlaeche.all_nodes_in_list_are_valid_and_not_blocked(node_list))

        node_list = [( 5, 5), ( 5,  6), (5, 12)]
        self.assertFalse(myFlaeche.all_nodes_in_list_are_valid_and_not_blocked(node_list))
