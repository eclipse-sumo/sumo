find tests -regex ".*\.\(xml\|complex\|dfrouter\|duarouter\|jtrrouter\|netconvert\|netgen\|od2trips\|polyconvert\|sumo\|meso\|tools\|traci\)" -print0 | xargs -0 sed -i 's/\r$//'
...
find src tools tests -regex ".*\.\(cpp\|h\|py\|pl\|java\)" -print0 | xargs -0 sed -i 's/\r$//' 
