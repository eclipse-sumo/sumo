...
if (os.environ["PATH"].lower().find("cmake") == -1):
	print ("CMake executable wasn't found. Please install the last version of Cmake from https://cmake.org/download/, or add the folder of cmake executable to PATH")
else:
	#print debug
	print ("CMake found")
	...
	if (abort):
		...
		VS15Generation = subprocess.Popen("cmake ../../../ -G \"Visual Studio 14 2015 Win64\"", cwd=os.environ["SUMO_HOME"] + "/build/tests/msvc15")
		...
		print ("Creating solution for Visual Studio 2017")
		VS17Generation = subprocess.Popen("cmake ../../../ -G \"Visual Studio 15 2017 Win64\"", cwd=os.environ["SUMO_HOME"] + "/build/tests/msvc17")
		# Wait to the end of generation
		VS17Generation.wait()
		...
		eclipseGeneration = subprocess.Popen("cmake ../../../ -G \"Eclipse CDT4\"", cwd=os.environ["SUMO_HOME"] + "/build/tests/msvc17")
		# Wait to the end of generation
