...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "$(PROJ_GDAL)\include\\" /I "$(FOX14)\include" /I "$(XERCES)\include" /I "..\..\..\src" /D "NDEBUG" /D "_LIB" /D "WIN32" /D "_MBCS" /FD /c
# SUBTRACT CPP /YX
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "$(PROJ_GDAL)\include" /I "$(FOX14)\include" /I "$(XERCES)\include" /I "..\..\..\src" /D "_DEBUG" /D "ABS_DEBUG" /D "_LIB" /D "WIN32" /D "_MBCS" /FD /GZ /c
# SUBTRACT CPP /YX
