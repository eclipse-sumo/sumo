...
<!-- Navigation bar begin -->
            ...
            <img src="./images/logo_zaik.gif" width="40" height="42"></a><br>
                        ...
                        <a href="http://sourceforge.net/projects/sumo/"><img src="http://sourceforge.net/sflogo.php?group_id=45607&type=1" width="88" height="31" border="0" alt="S
ourceForge.net Logo"></a>
                        </center>
                </div>
                </td><td width="20"></td>
<!-- Navigation bar end -->
...
<p><div align="right" class="SUMOPageInfo">last change: <!--#flastmod file="./status.php"--></div></p>
