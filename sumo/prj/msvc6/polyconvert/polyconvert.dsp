...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "$(PROJ_GDAL)\include" /I "$(XERCES)\include" /I "$(XERCES)\include\xercesc" /I "..\..\..\src" /D "HAVE_CONFIG_H" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /FD /c
# SUBTRACT CPP /YX
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "$(PROJ_GDAL)\include" /I "$(XERCES)\include" /I "$(XERCES)\include\xercesc" /I "..\..\..\src" /D "HAVE_CONFIG_H" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /FD /GZ /c
# SUBTRACT CPP /YX
...
# ADD LINK32 $(PROJ_GDAL)\lib\proj_i.lib $(XERCES)\lib\xerces-c_2D.lib /nologo /subsystem:console /debug /machine:I386 /pdbtype:sept
# Begin Special Build Tool
SOURCE="$(InputPath)"
