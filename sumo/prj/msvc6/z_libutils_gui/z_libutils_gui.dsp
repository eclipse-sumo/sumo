...
# ADD CPP /nologo /MD /W3 /GR /GX /O2 /I "$(PROJ)\src\\" /I "$(FOX14)\include" /I "..\..\..\src" /I "..\..\..\src\foreign" /I "$(GDAL)\ogr" /I "$(GDAL)\port" /D "HAVE_CONFIG_H" /D "NDEBUG" /D "WIN32" /D "_MBCS" /D "_LIB" /D "FOXDLL" /FD /c
# SUBTRACT CPP /YX
...
# ADD CPP /nologo /MDd /W3 /Gm /GR /GX /ZI /Od /I "$(PROJ)\src\\" /I "$(FOX14)\include" /I "..\..\..\src" /I "..\..\..\src\foreign" /I "$(GDAL)\ogr" /I "$(GDAL)\port" /D "HAVE_CONFIG_H" /D "_DEBUG" /D "WIN32" /D "_MBCS" /D "_LIB" /D "FOXDLL" /FD /GZ /c
# SUBTRACT CPP /YX
