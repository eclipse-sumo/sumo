...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "$(PROJ)\src\\" /I "$(XERCES)\include" /I "$(XERCES)\include\xercesc" /I "..\..\..\src" /I "$(GDAL)\ogr" /I "$(GDAL)\port" /D "HAVE_CONFIG_H" /D "WIN32" /D "NDEBUG" /D "_MBCS" /D "_LIB" /FD /c
# SUBTRACT CPP /YX
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "$(PROJ)\src\\" /I "$(XERCES)\include" /I "$(XERCES)\include\xercesc" /I "..\..\..\src" /I "$(GDAL)\ogr" /I "$(GDAL)\port" /D "HAVE_CONFIG_H" /D "WIN32" /D "_DEBUG" /D "_MBCS" /D "_LIB" /FD /GZ /c
# SUBTRACT CPP /YX
