...
# ADD LINK32 $(PROJ)\src\proj_i.lib glu32.lib opengl32.lib $(XERCES)\lib\xerces-c_2.lib $(FOX14)\lib\FOXDLL-1.4.lib shell32.lib user32.lib /nologo /subsystem:console /incremental:yes /machine:I386
...
# ADD LINK32 $(PROJ)\src\proj_i.lib glu32.lib opengl32.lib $(XERCES)\lib\xerces-c_2D.lib $(FOX14)\lib\FOXDLLD-1.4.lib shell32.lib user32.lib /nologo /subsystem:console /debug /machine:I386 /nodefaultlib:"nafxcwd.lib" /pdbtype:sept
# Begin Special Build Tool
SOURCE="$(InputPath)"
