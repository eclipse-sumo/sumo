...
char *help[] = {
    ...
    "Options:",
    " Input files:",
    "   -n, --net-file FILE             FILE is the network file",
    "   -r, --route-file FILE           FILE is the route file",
    "   -j, --junction-folder FOLDER    FOLDER should contain the junction logics",
    "                                   Default: $SUMO_DATA/junctions",
    "   -c, --configuration FILE        FILE will be used as configuration",
    "                                    1. Default: ./sumo.cfg",
    "                                    2. Default: $SUMO_DATA/config/sumo.cfg",
    " ",
    " Output files:",
