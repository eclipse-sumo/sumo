...
char *help[] = {
    ...
    "Options:",
    " Input files:",
    "   -n, --net-files FILE[;FILE]*    FILE is/are the network file(s)",
    "   -r, --route-files FILE[;FILE]*  FILE is/are the route file(s)",
    "   -r, --detectors FILE[;FILE]*    FILE is/are the detector file(s)",
