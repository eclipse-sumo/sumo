...
void
GNECalibratorLane::writeAdditional(OutputDevice& device, bool volatileOptionsEnabled) const {
    // Write parameters
...
void
GNECalibratorLane::updateGeometry() {
...
void
GNECalibratorLane::drawGL(const GUIVisualizationSettings& s) const {
    // get values
    glPushName(getGlID());
    glLineWidth(1.0);
