...
public:
     ...
     */
    GNEDetectorE1(const std::string& id, GNELane* lane, GNEViewNet* viewNet, SUMOReal pos, const SUMOReal freq, const std::string& filename, bool splitByType, bool blocked);
