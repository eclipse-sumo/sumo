...
void
GNEClosingReroute::insertAllowVehicle(std::string vehicleid) {
...
void
GNEClosingReroute::removeAllowVehicle(std::string vehicleid) {
    // find and remove
    for (std::vector<std::string>::iterator i = myAllowVehicles.begin(); i != myAllowVehicles.end(); i++) {
        if ((*i) == vehicleid) {
...
void
GNEClosingReroute::insertDisallowVehicle(std::string vehicleid) {
    // Check if was already inserted
...
void
GNEClosingReroute::removeDisallowVehicle(std::string vehicleid) {
    // find and remove
    for (std::vector<std::string>::iterator i = myDisallowVehicles.begin(); i != myDisallowVehicles.end(); i++) {
        if ((*i) == vehicleid) {
