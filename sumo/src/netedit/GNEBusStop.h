...
public:
     ...
     */
    GNEBusStop(const std::string& id, const std::string &lane, GNEViewNet* viewNet, double startPos, double endPos, const std::string &name, const std::vector<std::string>& lines, bool friendlyPosition);
