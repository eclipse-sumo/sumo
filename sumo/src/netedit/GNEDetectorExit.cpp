...
GNEDetectorExit::GNEDetectorExit(GNEViewNet* viewNet, GNEDetectorE3* parent, GNELane* lane, double pos) :
    GNEDetector(parent->generateExitID(), viewNet, SUMO_TAG_DET_EXIT, ICON_E3EXIT, lane, 0, ""),
...
void
GNEDetectorExit::moveGeometry(const Position &newPosition) {
...
void
GNEDetectorExit::commmitGeometryMoving(const Position& oldPos, GNEUndoList* undoList) {
