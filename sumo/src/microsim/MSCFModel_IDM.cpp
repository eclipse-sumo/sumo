...
SUMOReal MSCFModel_IDM::ffeV(MSVehicle *veh, SUMOReal speed, SUMOReal gap2pred, SUMOReal predSpeed) const {
    return _updateSpeed(gap2pred, speed, predSpeed, desiredSpeed(veh));
}

SUMOReal MSCFModel_IDM::ffeV(MSVehicle *veh, SUMOReal gap2pred, SUMOReal predSpeed) const {
    return _updateSpeed(gap2pred, veh->getSpeed(), predSpeed, desiredSpeed(veh));
}

SUMOReal MSCFModel_IDM::ffeV(MSVehicle *veh, MSVehicle *pred) const {
    return _updateSpeed(veh->gap2pred(*pred), veh->getSpeed(), pred->getSpeed(), desiredSpeed(veh));
}

SUMOReal MSCFModel_IDM::ffeS(MSVehicle *veh, SUMOReal gap2pred) const {
    return _updateSpeed(gap2pred, veh->getSpeed(), 0, desiredSpeed(veh));
}

SUMOReal MSCFModel_IDM::maxNextSpeed(SUMOReal speed) const {
    return MIN2(speed + (SUMOReal) ACCEL2SPEED(myType->getMaxAccel(speed)), myType->getMaxSpeed());
}


/// @todo update logic to IDM
SUMOReal MSCFModel_IDM::brakeGap(SUMOReal speed) const {
    return speed * speed * myInverseTwoDecel;
}

/// @todo update logic to IDM
SUMOReal MSCFModel_IDM::approachingBrakeGap(SUMOReal speed) const {
    return speed * speed * myInverseTwoDecel;
}

/// @todo update logic to IDM
SUMOReal MSCFModel_IDM::interactionGap(SUMOReal vF, SUMOReal laneMaxSpeed, SUMOReal vL) const {
...
/// @todo update logic to IDM
bool MSCFModel_IDM::hasSafeGap(SUMOReal speed, SUMOReal gap, SUMOReal predSpeed, SUMOReal laneMaxSpeed) const {
...
// ???
SUMOReal MSCFModel_IDM::safeEmitGap(SUMOReal speed) const {
...
SUMOReal MSCFModel_IDM::dawdle(SUMOReal speed) const {
...
SUMOReal MSCFModel_IDM::decelAbility() const {
...
SUMOReal MSCFModel_IDM::_updateSpeed(SUMOReal gap2pred, SUMOReal mySpeed, SUMOReal predSpeed, SUMOReal desSpeed) const {
...
SUMOReal MSCFModel_IDM::desiredSpeed(MSVehicle *veh) const {
