 ...
 *
 * The ToRetrieveDefinition names the attribute which the WeightsHandler shall 
 ...
 *  weight is valid at.
 *  The boolean "edgeBased" tells WeightsHandler whether the weights are supplied
 *  on edge- or on lane-basis (whether it shall parse the "edge" or the "lane" elements).
 *
 * Examples for files the WeightsHandler can handle are the edgedump and the lanedump
