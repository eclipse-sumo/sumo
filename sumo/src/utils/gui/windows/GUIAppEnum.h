...
enum {
    ...
    MID_GNE_MODE_ADDITIONALDIALOG_TABLE,
    MID_GNE_MODE_ADDITIONALDIALOG_VALUE,
    ...
    MID_GNE_REROUTEDIALOG_CLOSINGLANEREORUTE,
    MID_GNE_REROUTEDIALOG_CLOSINGREROUTE,
    MID_GNE_REROUTEDIALOG_DESTPROBREROUTE,
    MID_GNE_REROUTEDIALOG_ROUTEPROBREROUTE,
    MID_GNE_REROUTEDIALOG_CHANGESTART,
    MID_GNE_REROUTEDIALOG_CHANGEEDGE,
