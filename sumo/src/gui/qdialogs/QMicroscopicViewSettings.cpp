...
/*
 *  Constructs a QMicroscopicViewSettings which is a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  TRUE to construct a modal dialog.
 */
QMicroscopicViewSettings::QMicroscopicViewSettings( QWidget* parent,  const char* name, bool modal, WFlags fl )
    : QDialog( parent, name, modal, fl )
{
    if ( !name )
	setName( "QMicroscopicViewSettings" );
    resize( 349, 325 );
 ...
 */
QMicroscopicViewSettings::~QMicroscopicViewSettings()
{
