...
NIImporter_OpenStreetMap::load(const OptionsCont& oc, NBNetBuilder& nb) {
    ...
    //  for railways
    tc.insert("railway.rail",          1, (SUMOReal)(30. / 3.6),  15, WIDTH, SVC_RAIL_FAST);
    tc.insert("railway.tram",          1, (SUMOReal)(30. / 3.6),  15, WIDTH, SVC_CITYRAIL);
    tc.insert("railway.light_rail",    1, (SUMOReal)(30. / 3.6),  15, WIDTH, SVC_LIGHTRAIL);
    tc.insert("railway.subway",        1, (SUMOReal)(30. / 3.6),  15, WIDTH, SVC_CITYRAIL);
    tc.insert("railway.preserved",     1, (SUMOReal)(30. / 3.6),  15, WIDTH, SVC_LIGHTRAIL);
    tc.insert("railway.monorail",      1, (SUMOReal)(30. / 3.6),  15, WIDTH, SVC_LIGHTRAIL); // rail stuff has to be discussed
