...
public:
    /// Constructor
    NIVissimSingleTypeParser_Verkehrszusammensetzungsdefinition(NIVissimLoader &parent);
...
//#include "NIVissimSingleTypeParser_Verkehrszusammensetzungsdefinition.icc"
//#endif
