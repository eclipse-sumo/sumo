 ...
 * method definitions
 * ======================================================================= */
NIVissimSingleTypeParser_Gelbverhaltendefinition::NIVissimSingleTypeParser_Gelbverhaltendefinition(NIVissimLoader &parent)
...
bool
NIVissimSingleTypeParser_Gelbverhaltendefinition::parse(std::istream &from)
{
    return true;
}
