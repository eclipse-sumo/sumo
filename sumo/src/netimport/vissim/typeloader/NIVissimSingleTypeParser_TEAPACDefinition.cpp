 ...
 * method definitions
 * ======================================================================= */
NIVissimSingleTypeParser_TEAPACDefinition::NIVissimSingleTypeParser_TEAPACDefinition(NIVissimLoader &parent)
...
bool
NIVissimSingleTypeParser_TEAPACDefinition::parse(std::istream &from)
{
    return true;
}
