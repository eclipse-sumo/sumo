...
/* Undefine in order to enable memory checks. */
/* #undef CHECK_MEMORY_LEAKS */

/* Undefine in order to enable geometry checking. */
/* #undef CHECK_UNIQUE_POINTS_GEOMETRY */

/* Define to 1 in order to disable inlining. */
/* #undef DISABLE_INLINE */

/* Define to 1 in order to enable external template definitions
   (cfront-model). */
/* #undef EXTERNAL_TEMPLATE_DEFINITION */
